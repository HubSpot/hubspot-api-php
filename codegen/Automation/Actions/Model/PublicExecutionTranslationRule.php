...
class PublicExecutionTranslationRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets conditions
     *
     * @param array<string,object> $conditions Defines the conditions that must be met for the execution rule to apply.
     *
     * @return self
     */
     ...
     * Sets label_name
     *
     * @param string $label_name Specifies the name of the label associated with the execution rule.
     *
     * @return self
     */
