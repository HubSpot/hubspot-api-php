...
class PublicSingleFieldDependency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $controlling_field_name The name of the field that controls the dependency.
     *
     * @return self
     */
     ...
     *
     * @param string $dependency_type The type of dependency, with the default value being 'SINGLE_FIELD'.
     *
     * @return self
     */
