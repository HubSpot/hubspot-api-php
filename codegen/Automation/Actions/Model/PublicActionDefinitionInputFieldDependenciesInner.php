...
/**
 * PublicActionDefinitionInputFieldDependenciesInner Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Automation\Actions
 * @author   OpenAPI Generator team
 ...
 */
class PublicActionDefinitionInputFieldDependenciesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = 'dependency_type';
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicActionDefinition_inputFieldDependencies_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['dependency_type'] = static::$openAPIModelName;
    }
    ...
    */
     ...
     *
     * @param string $controlling_field_name The name of the field that determines the dependency.
     *
     * @return self
     */
     ...
     *
     * @param string $dependency_type The type of dependency, with the default value being CONDITIONAL_SINGLE_FIELD.
     *
     * @return self
     */
     ...
     *
     * @param string $controlling_field_value The value of the controlling field that triggers the dependency.
     *
     * @return self
     */
