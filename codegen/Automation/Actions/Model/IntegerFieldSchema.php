...
/**
 * IntegerFieldSchema Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Automation\Actions
 * @author   OpenAPI Generator team
 ...
 */
class IntegerFieldSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IntegerFieldSchema';
    ...
    */
     ...
     * Sets maximum
     *
     * @param int|null $maximum The maximum value allowed for the integer field.
     *
     * @return self
     */
     ...
     * Sets minimum
     *
     * @param int|null $minimum The minimum value allowed for the integer field.
     *
     * @return self
     */
