...
class PublicActionDefinitionEgg implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'input_fields' => '\HubSpot\Client\Automation\Actions\Model\PublicInputFieldDefinition[]',
    ...
    */
     ...
     * Sets action_url
     *
     * @param string $action_url The URL endpoint where the action is executed.
     *
     * @return self
     */
     ...
     * Sets archived_at
     *
     * @param int|null $archived_at The timestamp indicating when the action was archived.
     *
     * @return self
     */
     ...
     * Gets input_fields
     *
     * @return \HubSpot\Client\Automation\Actions\Model\PublicInputFieldDefinition[]
     */
     ...
     * Sets input_fields
     *
     * @param \HubSpot\Client\Automation\Actions\Model\PublicInputFieldDefinition[] $input_fields input_fields
     *
     * @return self
     */
     ...
     * Sets labels
     *
     * @param array<string,\HubSpot\Client\Automation\Actions\Model\PublicActionLabels> $labels Holds various labels associated with the action, including names and descriptions.
     *
     * @return self
     */
