 ...
 */
class SingleFieldDependency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['dependency_type'] = $data['dependency_type'] ?? DEPENDENCY_TYPE_SINGLE_FIELD;
