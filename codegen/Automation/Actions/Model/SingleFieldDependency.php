...
/**
 * SingleFieldDependency Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Automation\Actions
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SingleFieldDependency implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SingleFieldDependency';
    ...
    const DEPENDENCY_TYPE_SINGLE_FIELD = 'SINGLE_FIELD';
    ...
    {
        $this->container['dependency_type'] = isset($data['dependency_type']) ? $data['dependency_type'] : 'SINGLE_FIELD';
