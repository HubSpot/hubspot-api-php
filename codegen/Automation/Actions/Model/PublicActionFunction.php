...
/**
 * PublicActionFunction Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Automation\Actions
 * @author   OpenAPI Generator team
 ...
 */
class PublicActionFunction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicActionFunction';
    ...
    */
     ...
     *
     * @param string $function_source The source code or script that defines the function's behavior.
     *
     * @return self
     */
    public function setFunctionSource($function_source)
    {
        if (is_null($function_source)) {
            throw new \InvalidArgumentException('non-nullable function_source cannot be null');
        }
     ...
     * Sets function_type
     *
     * @param string $function_type The type of function, with accepted values: POST_ACTION_EXECUTION, POST_FETCH_OPTIONS, PRE_ACTION_EXECUTION, PRE_FETCH_OPTIONS.
     *
     * @return self
     */
    public function setFunctionType($function_type)
    {
        if (is_null($function_type)) {
            throw new \InvalidArgumentException('non-nullable function_type cannot be null');
        }
        $allowedValues = $this->getFunctionTypeAllowableValues();
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier for the action function.
     *
     * @return self
     */
