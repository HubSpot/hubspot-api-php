...
/**
 * StringFieldSchema Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Automation\Actions
 * @author   OpenAPI Generator team
 ...
 */
class StringFieldSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StringFieldSchema';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Indicates that the type is a string, with the default value being STRING.
     *
     * @return self
     */
