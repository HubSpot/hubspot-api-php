...
/**
 * PublicOption Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Automation\Actions
 * @author   OpenAPI Generator team
 ...
 */
class PublicOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicOption';
    ...
    */
     ...
     * Sets display_order
     *
     * @param int|null $display_order The position of the option relative to others in the list.
     *
     * @return self
     */
