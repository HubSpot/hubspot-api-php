...
/**
 * ExtensionActionDefinitionInput Class Doc Comment
 *
 * @category Class
 ...
 */
class ExtensionActionDefinitionInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExtensionActionDefinitionInput';
    ...
    protected static $openAPITypes = [
        'functions' => '\HubSpot\Client\Automation\Actions\Model\ActionFunction[]',
        'action_url' => 'string',
        'published' => 'bool',
        'archived_at' => 'int',
        ...
        'input_field_dependencies' => '\HubSpot\Client\Automation\Actions\Model\ExtensionActionDefinitionInputFieldDependenciesInner[]',
     ...
     * Gets functions
     *
     * @return \HubSpot\Client\Automation\Actions\Model\ActionFunction[]
     */
     ...
     * Sets functions
     *
     * @param \HubSpot\Client\Automation\Actions\Model\ActionFunction[] $functions A list of functions associated with the custom workflow action.
     *
     * @return self
     */
     ...
     *
     * @return \HubSpot\Client\Automation\Actions\Model\ExtensionActionDefinitionInputFieldDependenciesInner[]|null
     */
     ...
     *
     * @param \HubSpot\Client\Automation\Actions\Model\ExtensionActionDefinitionInputFieldDependenciesInner[]|null $input_field_dependencies A list of dependencies between the input fields. These configure when the input fields should be visible.
     *
     * @return self
     */
