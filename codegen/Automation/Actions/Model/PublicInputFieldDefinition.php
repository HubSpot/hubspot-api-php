...
/**
 * PublicInputFieldDefinition Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Automation\Actions
 * @author   OpenAPI Generator team
 ...
 */
class PublicInputFieldDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicInputFieldDefinition';
    ...
    protected static $openAPITypes = [
        ...
        'type_definition' => '\HubSpot\Client\Automation\Actions\Model\PublicFieldTypeDefinition'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('supported_value_types', $data ?? [], null);
    ...
    */
     ...
     * Sets is_required
     *
     * @param bool $is_required Indicates whether the input field is mandatory.
     *
     * @return self
     */
    ...
    {
        if (is_null($supported_value_types)) {
            throw new \InvalidArgumentException('non-nullable supported_value_types cannot be null');
        }
        $allowedValues = $this->getSupportedValueTypesAllowableValues();
        if (array_diff($supported_value_types, $allowedValues)) {
     ...
     *
     * @return \HubSpot\Client\Automation\Actions\Model\PublicFieldTypeDefinition
     */
     ...
     *
     * @param \HubSpot\Client\Automation\Actions\Model\PublicFieldTypeDefinition $type_definition type_definition
     *
     * @return self
     */
