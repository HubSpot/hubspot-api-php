...
class Option implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets display_order
     *
     * @param int $display_order The position of the item relative to others in the list.
     *
     * @return self
     */
     ...
     * Sets double_data
     *
     * @param float $double_data A numerical value associated with the option.
     *
     * @return self
     */
     ...
     * Sets hidden
     *
     * @param bool $hidden Whether the option is displayed in HubSpot's UI.
     *
     * @return self
     */
     ...
     * Sets read_only
     *
     * @param bool $read_only Whether the option is read-only.
     *
     * @return self
     */
