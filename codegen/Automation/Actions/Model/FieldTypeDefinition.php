...
class FieldTypeDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'schema' => '\HubSpot\Client\Automation\Actions\Model\FieldTypeDefinitionSchema',
        'type' => 'string',
        'use_chirp' => 'bool'
    ];
    ...
    public const REFERENCED_OBJECT_TYPE_CASE_STUDY = 'CASE_STUDY';
    ...
    public const REFERENCED_OBJECT_TYPE_COMBO_EVENT_CONFIGURATION = 'COMBO_EVENT_CONFIGURATION';
    ...
    public const REFERENCED_OBJECT_TYPE_CRM_OBJECTS_DUMMY_TYPE = 'CRM_OBJECTS_DUMMY_TYPE';
    ...
    public const REFERENCED_OBJECT_TYPE_PARTNER_SERVICE = 'PARTNER_SERVICE';
    ...
    public const REFERENCED_OBJECT_TYPE_PODCAST_EPISODE = 'PODCAST_EPISODE';
    ...
    public const REFERENCED_OBJECT_TYPE_PROSPECTING_AGENT_CONTACT_ASSIGNMENT = 'PROSPECTING_AGENT_CONTACT_ASSIGNMENT';
    ...
    public const REFERENCED_OBJECT_TYPE_SERVICE = 'SERVICE';
    ...
    public function getReferencedObjectTypeAllowableValues()
    {
        return [
            ...
            self::REFERENCED_OBJECT_TYPE_CRM_OBJECTS_DUMMY_TYPE,
            ...
            self::REFERENCED_OBJECT_TYPE_PARTNER_SERVICE,
            ...
            self::REFERENCED_OBJECT_TYPE_PODCAST_EPISODE,
            ...
            self::REFERENCED_OBJECT_TYPE_PROSPECTING_AGENT_CONTACT_ASSIGNMENT,
            ...
            self::REFERENCED_OBJECT_TYPE_SERVICE,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('use_chirp', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['use_chirp'] === null) {
            $invalidProperties[] = "'use_chirp' can't be null";
        }
     ...
     * Sets description
     *
     * @param string|null $description A detailed explanation of the field's purpose and usage.
     *
     * @return self
     */
     ...
     *
     * @param bool $external_options Indicates whether the field's options are sourced externally.
     *
     * @return self
     */
     ...
     *
     * @param string|null $external_options_reference_type Specifies the type of external reference for options.
     *
     * @return self
     */
     ...
     * Sets field_type
     *
     * @param string|null $field_type Describes the field's type in the UI, with accepted values like booleancheckbox, calculation_equation, checkbox, date, file, html, number, phonenumber, radio, select, text, textarea, unknown.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The user-friendly label for the field.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The unique identifier for the field.
     *
     * @return self
     */
     ...
     *
     * @param string|null $referenced_object_type Indicates the type of object that the field references, with accepted values like OWNER.
     *
     * @return self
     */
     ...
     * Gets schema
     *
     * @return \HubSpot\Client\Automation\Actions\Model\FieldTypeDefinitionSchema
     */
     ...
     * Sets schema
     *
     * @param \HubSpot\Client\Automation\Actions\Model\FieldTypeDefinitionSchema $schema schema
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Specifies the data type of the field, with accepted values like bool, date, datetime, enumeration, json, number, object_coordinates, phone_number, string.
     *
     * @return self
     */
     ...
     * @return bool
     */
    public function getUseChirp()
    {
        return $this->container['use_chirp'];
    }

    /**
     * Sets use_chirp
     *
     * @param bool $use_chirp Specifies whether the field uses the Chirp feature.
     *
     * @return self
     */
    public function setUseChirp($use_chirp)
    {
        if (is_null($use_chirp)) {
            throw new \InvalidArgumentException('non-nullable use_chirp cannot be null');
        }
        $this->container['use_chirp'] = $use_chirp;
