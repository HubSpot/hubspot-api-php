...
class PublicActionRevision implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The date and time when the action revision was created.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id The unique identifier for the action revision.
     *
     * @return self
     */
     ...
     * Sets revision_id
     *
     * @param string $revision_id The unique identifier for the specific revision of the action.
     *
     * @return self
     */
