...
class PublicActionDefinitionPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets action_url
     *
     * @param string|null $action_url The URL endpoint where the action is executed.
     *
     * @return self
     */
     ...
     * Gets input_fields
     *
     * @return \HubSpot\Client\Automation\Actions\Model\PublicInputFieldDefinition[]|null
     */
     ...
     * Sets input_fields
     *
     * @param \HubSpot\Client\Automation\Actions\Model\PublicInputFieldDefinition[]|null $input_fields input_fields
     *
     * @return self
     */
     ...
     * Sets labels
     *
     * @param array<string,\HubSpot\Client\Automation\Actions\Model\PublicActionLabels>|null $labels Contains labels for the action, including names and descriptions.
     *
     * @return self
     */
     ...
     * Sets published
     *
     * @param bool|null $published Indicates whether the action is published and available for use.
     *
     * @return self
     */
