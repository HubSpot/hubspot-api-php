...
class BatchApi
{
    ...
    public function crmObjectSchemasV3SchemasBatchReadRequest($object_schema_batch_read_request, string $contentType = self::contentTypes['crmObjectSchemasV3SchemasBatchRead'][0])
    {
        ...
        $resourcePath = '/crm-object-schemas/v3/schemas/batch/read';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($object_schema_batch_read_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($object_schema_batch_read_request), JSON_THROW_ON_ERROR);
            } else {
                $httpBody = $object_schema_batch_read_request;
            }
