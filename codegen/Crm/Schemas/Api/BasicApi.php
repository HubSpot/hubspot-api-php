...
class BasicApi
{
    ...
    public function createRequest($object_schema_egg, string $contentType = self::contentTypes['create'][0])
    {
        ...
        if (isset($object_schema_egg)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($object_schema_egg), JSON_THROW_ON_ERROR);
            } else {
     ...
     *
     * @param  bool|null $archived Whether to return only results that have been archived. (optional, default to false)
     * @param  bool|null $include_association_definitions  (optional, default to true)
     * @param  bool|null $include_audit_metadata  (optional, default to true)
     * @param  bool|null $include_property_definitions  (optional, default to true)
     ...
     */
    public function getAll($archived = false, $include_association_definitions = true, $include_audit_metadata = true, $include_property_definitions = true, string $contentType = self::contentTypes['getAll'][0])
    {
        list($response) = $this->getAllWithHttpInfo($archived, $include_association_definitions, $include_audit_metadata, $include_property_definitions, $contentType);
        return $response;
    }
     ...
     */
    public function getAllWithHttpInfo($archived = false, $include_association_definitions = true, $include_audit_metadata = true, $include_property_definitions = true, string $contentType = self::contentTypes['getAll'][0])
    {
        $request = $this->getAllRequest($archived, $include_association_definitions, $include_audit_metadata, $include_property_definitions, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllAsync($archived = false, $include_association_definitions = true, $include_audit_metadata = true, $include_property_definitions = true, string $contentType = self::contentTypes['getAll'][0])
    {
        return $this->getAllAsyncWithHttpInfo($archived, $include_association_definitions, $include_audit_metadata, $include_property_definitions, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllAsyncWithHttpInfo($archived = false, $include_association_definitions = true, $include_audit_metadata = true, $include_property_definitions = true, string $contentType = self::contentTypes['getAll'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllRequest($archived = false, $include_association_definitions = true, $include_audit_metadata = true, $include_property_definitions = true, string $contentType = self::contentTypes['getAll'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'includeAssociationDefinitions', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'includeAuditMetadata', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'includePropertyDefinitions', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     * @return \HubSpot\Client\Crm\Schemas\Model\ObjectSchema|\HubSpot\Client\Crm\Schemas\Model\Error
     */
    public function getById($object_type, $include_association_definitions = true, $include_audit_metadata = true, $include_property_definitions = true, string $contentType = self::contentTypes['getById'][0])
    {
        list($response) = $this->getByIdWithHttpInfo($object_type, $include_association_definitions, $include_audit_metadata, $include_property_definitions, $contentType);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Schemas\Model\ObjectSchema|\HubSpot\Client\Crm\Schemas\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getByIdWithHttpInfo($object_type, $include_association_definitions = true, $include_audit_metadata = true, $include_property_definitions = true, string $contentType = self::contentTypes['getById'][0])
    {
        $request = $this->getByIdRequest($object_type, $include_association_definitions, $include_audit_metadata, $include_property_definitions, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($object_type, $include_association_definitions = true, $include_audit_metadata = true, $include_property_definitions = true, string $contentType = self::contentTypes['getById'][0])
    {
        return $this->getByIdAsyncWithHttpInfo($object_type, $include_association_definitions, $include_audit_metadata, $include_property_definitions, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($object_type, $include_association_definitions = true, $include_audit_metadata = true, $include_property_definitions = true, string $contentType = self::contentTypes['getById'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Schemas\Model\ObjectSchema';
        $request = $this->getByIdRequest($object_type, $include_association_definitions, $include_audit_metadata, $include_property_definitions, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getByIdRequest($object_type, $include_association_definitions = true, $include_audit_metadata = true, $include_property_definitions = true, string $contentType = self::contentTypes['getById'][0])
    {
    ...
    public function updateRequest($object_type, $object_type_definition_patch, string $contentType = self::contentTypes['update'][0])
    {
        ...
        if (isset($object_type_definition_patch)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($object_type_definition_patch), JSON_THROW_ON_ERROR);
            } else {
