...
class SearchApi
{
    ...
    public function doSearchWithHttpInfo($public_object_search_request = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Companies\Model\CollectionResponseWithTotalSimplePublicObject' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Companies\Model\CollectionResponseWithTotalSimplePublicObject', []),
