...
class CollectionResponseSimplePublicObjectWithAssociationsForwardPaging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets results
     *
     * @param \HubSpot\Client\Crm\Deals\Model\SimplePublicObjectWithAssociations[] $results An array of simple public objects that are included in the current page of the response. Each object may include its associated data.
     *
     * @return self
     */
