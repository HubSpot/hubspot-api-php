...
class CollectionResponseWithTotalSimplePublicObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets results
     *
     * @param \HubSpot\Client\Crm\Deals\Model\SimplePublicObject[] $results An array containing the simple public objects returned in the current page of the response. This property is required.
     *
     * @return self
     */
