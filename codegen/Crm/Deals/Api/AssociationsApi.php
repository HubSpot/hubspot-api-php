...
class AssociationsApi
{
     ...
     * @return void
     */
    public function archive($deal_id, $to_object_type, $to_object_id, $association_type)
    {
        $this->archiveWithHttpInfo($deal_id, $to_object_type, $to_object_id, $association_type);
    }
     ...
     */
    public function archiveWithHttpInfo($deal_id, $to_object_type, $to_object_id, $association_type)
    {
        $request = $this->archiveRequest($deal_id, $to_object_type, $to_object_id, $association_type);
     ...
     */
    public function archiveAsync($deal_id, $to_object_type, $to_object_id, $association_type)
    {
        return $this->archiveAsyncWithHttpInfo($deal_id, $to_object_type, $to_object_id, $association_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function archiveAsyncWithHttpInfo($deal_id, $to_object_type, $to_object_id, $association_type)
    {
        $returnType = '';
        $request = $this->archiveRequest($deal_id, $to_object_type, $to_object_id, $association_type);
     ...
     */
    public function archiveRequest($deal_id, $to_object_type, $to_object_id, $association_type)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createRequest($deal_id, $to_object_type, $to_object_id, $association_type)
    {
        // verify the required parameter 'deal_id' is set
        if ($deal_id === null || (is_array($deal_id) && count($deal_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \HubSpot\Client\Crm\Deals\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Deals\Model\CollectionResponseAssociatedIdForwardPaging|\HubSpot\Client\Crm\Deals\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Deals\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Deals\Model\CollectionResponseAssociatedIdForwardPaging|\HubSpot\Client\Crm\Deals\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllWithHttpInfo($deal_id, $to_object_type, $after = null, $limit = 500)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Deals\Model\CollectionResponseAssociatedIdForwardPaging' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Deals\Model\CollectionResponseAssociatedIdForwardPaging' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Deals\Model\CollectionResponseAssociatedIdForwardPaging', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\HubSpot\Client\Crm\Deals\Model\CollectionResponseAssociatedIdForwardPaging';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\HubSpot\Client\Crm\Deals\Model\CollectionResponseAssociatedIdForwardPaging',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
