...
class BatchApi
{
     ...
     *
     * @param  \HubSpot\Client\Crm\Deals\Model\BatchInputSimplePublicObjectId $batch_input_simple_public_object_id batch_input_simple_public_object_id (optional)
     *
    ...
    protected function archiveBatchRequest($batch_input_simple_public_object_id = null)
    {
        ...
        $resourcePath = '/deals/batch/archive';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \HubSpot\Client\Crm\Deals\Model\BatchInputSimplePublicObjectInput $batch_input_simple_public_object_input batch_input_simple_public_object_input (optional)
     *
     * @throws \HubSpot\Client\Crm\Deals\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    protected function createBatchRequest($batch_input_simple_public_object_input = null)
    {
        ...
        $resourcePath = '/deals/batch/create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \HubSpot\Client\Crm\Deals\Model\BatchReadInputSimplePublicObjectId $batch_read_input_simple_public_object_id batch_read_input_simple_public_object_id (optional)
     *
     * @throws \HubSpot\Client\Crm\Deals\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Deals\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Deals\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Deals\Model\Error
     ...
     *
     * @param  \HubSpot\Client\Crm\Deals\Model\BatchInputSimplePublicObjectBatchInput $batch_input_simple_public_object_batch_input batch_input_simple_public_object_batch_input (optional)
     *
     * @throws \HubSpot\Client\Crm\Deals\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Deals\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Deals\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Deals\Model\Error
    ...
    protected function updateBatchRequest($batch_input_simple_public_object_batch_input = null)
    {
        ...
        $resourcePath = '/deals/batch/update';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
