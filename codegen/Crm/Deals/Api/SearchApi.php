...
class SearchApi
{
    ...
    public function doSearchWithHttpInfo($public_object_search_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Deals\Model\CollectionResponseWithTotalSimplePublicObject' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Deals\Model\CollectionResponseWithTotalSimplePublicObject', []),
