...
class SearchApi
{
     ...
     * Operation doSearch
     *
     * @param  \HubSpot\Client\Crm\Deals\Model\PublicObjectSearchRequest $public_object_search_request public_object_search_request (required)
     ...
     * @return \HubSpot\Client\Crm\Deals\Model\CollectionResponseWithTotalSimplePublicObjectForwardPaging|\HubSpot\Client\Crm\Deals\Model\Error
     */
     ...
     *
     * @param  \HubSpot\Client\Crm\Deals\Model\PublicObjectSearchRequest $public_object_search_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['doSearch'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Crm\Deals\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Deals\Model\CollectionResponseWithTotalSimplePublicObjectForwardPaging|\HubSpot\Client\Crm\Deals\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function doSearchWithHttpInfo($public_object_search_request, string $contentType = self::contentTypes['doSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Deals\Model\CollectionResponseWithTotalSimplePublicObjectForwardPaging' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Deals\Model\CollectionResponseWithTotalSimplePublicObjectForwardPaging' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Deals\Model\CollectionResponseWithTotalSimplePublicObjectForwardPaging', []),
            ...
            $returnType = '\HubSpot\Client\Crm\Deals\Model\CollectionResponseWithTotalSimplePublicObjectForwardPaging';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\HubSpot\Client\Crm\Deals\Model\CollectionResponseWithTotalSimplePublicObjectForwardPaging',
    ...
    public function doSearchRequest($public_object_search_request, string $contentType = self::contentTypes['doSearch'][0])
    {
        ...
        $resourcePath = '/crm/v3/objects/deals/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
