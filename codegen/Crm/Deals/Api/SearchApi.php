...
class SearchApi
{
     ...
     * @return \HubSpot\Client\Crm\Deals\Model\CollectionResponseWithTotalSimplePublicObject|\HubSpot\Client\Crm\Deals\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Deals\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Deals\Model\CollectionResponseWithTotalSimplePublicObject|\HubSpot\Client\Crm\Deals\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\HubSpot\Client\Crm\Deals\Model\CollectionResponseWithTotalSimplePublicObject',
                        $request,
                        $response,
                    );
                default:
    ...
    {
        $returnType = '\HubSpot\Client\Crm\Deals\Model\CollectionResponseWithTotalSimplePublicObject';
        $request = $this->doSearchRequest($public_object_search_request, $contentType);
    ...
    public function doSearchRequest($public_object_search_request, string $contentType = self::contentTypes['doSearch'][0])
    {
        ...
        $resourcePath = '/crm/v3/objects/0-3/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
