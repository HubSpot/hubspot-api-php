...
class BasicApi
{
     ...
     */
    protected function archiveRequest($deal_id)
    {
     ...
     * @return \HubSpot\Client\Crm\Deals\Model\SimplePublicObject|\HubSpot\Client\Crm\Deals\Model\Error
     */
    public function getById($deal_id, $properties = null, $associations = null, $paginate_associations = false, $archived = false, $id_property = null)
    {
        list($response) = $this->getByIdWithHttpInfo($deal_id, $properties, $associations, $paginate_associations, $archived, $id_property);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Deals\Model\SimplePublicObject|\HubSpot\Client\Crm\Deals\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getByIdWithHttpInfo($deal_id, $properties = null, $associations = null, $paginate_associations = false, $archived = false, $id_property = null)
    {
        $request = $this->getByIdRequest($deal_id, $properties, $associations, $paginate_associations, $archived, $id_property);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($deal_id, $properties = null, $associations = null, $paginate_associations = false, $archived = false, $id_property = null)
    {
        return $this->getByIdAsyncWithHttpInfo($deal_id, $properties, $associations, $paginate_associations, $archived, $id_property)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($deal_id, $properties = null, $associations = null, $paginate_associations = false, $archived = false, $id_property = null)
    {
        $returnType = '\HubSpot\Client\Crm\Deals\Model\SimplePublicObject';
        $request = $this->getByIdRequest($deal_id, $properties, $associations, $paginate_associations, $archived, $id_property);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getByIdRequest($deal_id, $properties = null, $associations = null, $paginate_associations = false, $archived = false, $id_property = null)
    {
        // verify the required parameter 'deal_id' is set
        if ($deal_id === null || (is_array($deal_id) && count($deal_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \HubSpot\Client\Crm\Deals\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Deals\Model\CollectionResponseSimplePublicObject|\HubSpot\Client\Crm\Deals\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Deals\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Deals\Model\CollectionResponseSimplePublicObject|\HubSpot\Client\Crm\Deals\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPageWithHttpInfo($limit = 10, $after = null, $properties = null, $associations = null, $paginate_associations = false, $archived = false)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Deals\Model\CollectionResponseSimplePublicObject' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Deals\Model\CollectionResponseSimplePublicObject', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\HubSpot\Client\Crm\Deals\Model\CollectionResponseSimplePublicObject';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\HubSpot\Client\Crm\Deals\Model\CollectionResponseSimplePublicObject',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \HubSpot\Client\Crm\Deals\Model\SimplePublicObject|\HubSpot\Client\Crm\Deals\Model\Error
     */
    public function update($deal_id, $simple_public_object_input)
    {
        list($response) = $this->updateWithHttpInfo($deal_id, $simple_public_object_input);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Deals\Model\SimplePublicObject|\HubSpot\Client\Crm\Deals\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($deal_id, $simple_public_object_input)
    {
        $request = $this->updateRequest($deal_id, $simple_public_object_input);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($deal_id, $simple_public_object_input)
    {
        return $this->updateAsyncWithHttpInfo($deal_id, $simple_public_object_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($deal_id, $simple_public_object_input)
    {
        $returnType = '\HubSpot\Client\Crm\Deals\Model\SimplePublicObject';
        $request = $this->updateRequest($deal_id, $simple_public_object_input);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateRequest($deal_id, $simple_public_object_input)
    {
        // verify the required parameter 'deal_id' is set
        if ($deal_id === null || (is_array($deal_id) && count($deal_id) === 0)) {
            throw new \InvalidArgumentException(
