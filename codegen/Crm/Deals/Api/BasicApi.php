...
class BasicApi
{
            ...
            switch($statusCode) {
                case 201:
                    if ('\HubSpot\Client\Crm\Deals\Model\SimplePublicObject' === '\SplFileObject') {
                        ...
                        if ('\HubSpot\Client\Crm\Deals\Model\SimplePublicObject' !== 'string') {
                            try {
     ...
     */
    public function getById($deal_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null, string $contentType = self::contentTypes['getById'][0])
    {
        list($response) = $this->getByIdWithHttpInfo($deal_id, $properties, $properties_with_history, $associations, $archived, $id_property, $contentType);
        return $response;
    }
     ...
     */
    public function getByIdWithHttpInfo($deal_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null, string $contentType = self::contentTypes['getById'][0])
    {
        $request = $this->getByIdRequest($deal_id, $properties, $properties_with_history, $associations, $archived, $id_property, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Deals\Model\SimplePublicObjectWithAssociations' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Deals\Model\SimplePublicObjectWithAssociations' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($deal_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null, string $contentType = self::contentTypes['getById'][0])
    {
        return $this->getByIdAsyncWithHttpInfo($deal_id, $properties, $properties_with_history, $associations, $archived, $id_property, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($deal_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null, string $contentType = self::contentTypes['getById'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Deals\Model\SimplePublicObjectWithAssociations';
        $request = $this->getByIdRequest($deal_id, $properties, $properties_with_history, $associations, $archived, $id_property, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getByIdRequest($deal_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null, string $contentType = self::contentTypes['getById'][0])
    {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Deals\Model\CollectionResponseSimplePublicObjectWithAssociationsForwardPaging' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Deals\Model\CollectionResponseSimplePublicObjectWithAssociationsForwardPaging' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
    ...
    public function mergeRequest($public_merge_input, string $contentType = self::contentTypes['merge'][0])
    {
        ...
        $resourcePath = '/crm/v3/objects/deals/merge';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
