...
class BatchReadInputSimplePublicObjectId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets inputs
     *
     * @param \HubSpot\Client\Crm\Contacts\Model\SimplePublicObjectId[] $inputs An array of SimplePublicObjectId objects, each containing the ID of an object to be read.
     *
     * @return self
     */
