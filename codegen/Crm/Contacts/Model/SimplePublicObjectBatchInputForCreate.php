...
class SimplePublicObjectBatchInputForCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets associations
     *
     * @param \HubSpot\Client\Crm\Contacts\Model\PublicAssociationsForObject[]|null $associations An array of associations that define the relationships between the objects being created and other existing objects. This property is required.
     *
     * @return self
     */
