...
class PublicMergeInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $object_id_to_merge The object ID of the record that the merge will not set as the current value after the merge.
     *
     * @return self
     */
     ...
     *
     * @param string $primary_object_id The object ID of the record that the merge will generally set as the current value after the merge.
     *
     * @return self
     */
