...
class BasicApi
{
     ...
     */
    public function getById($contact_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false)
    {
        list($response) = $this->getByIdWithHttpInfo($contact_id, $properties, $properties_with_history, $associations, $archived);
        return $response;
    }
     ...
     */
    public function getByIdWithHttpInfo($contact_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false)
    {
        $request = $this->getByIdRequest($contact_id, $properties, $properties_with_history, $associations, $archived);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($contact_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false)
    {
        return $this->getByIdAsyncWithHttpInfo($contact_id, $properties, $properties_with_history, $associations, $archived)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($contact_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false)
    {
        $returnType = '\HubSpot\Client\Crm\Contacts\Model\SimplePublicObjectWithAssociations';
        $request = $this->getByIdRequest($contact_id, $properties, $properties_with_history, $associations, $archived);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getByIdRequest($contact_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false)
    {
        // verify the required parameter 'contact_id' is set
        if ($contact_id === null || (is_array($contact_id) && count($contact_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \HubSpot\Client\Crm\Contacts\Model\SimplePublicObject|\HubSpot\Client\Crm\Contacts\Model\Error
     */
    public function update($contact_id, $simple_public_object_input)
    {
        list($response) = $this->updateWithHttpInfo($contact_id, $simple_public_object_input);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Contacts\Model\SimplePublicObject|\HubSpot\Client\Crm\Contacts\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($contact_id, $simple_public_object_input)
    {
        $request = $this->updateRequest($contact_id, $simple_public_object_input);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($contact_id, $simple_public_object_input)
    {
        return $this->updateAsyncWithHttpInfo($contact_id, $simple_public_object_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($contact_id, $simple_public_object_input)
    {
        $returnType = '\HubSpot\Client\Crm\Contacts\Model\SimplePublicObject';
        $request = $this->updateRequest($contact_id, $simple_public_object_input);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRequest($contact_id, $simple_public_object_input)
    {
        // verify the required parameter 'contact_id' is set
        if ($contact_id === null || (is_array($contact_id) && count($contact_id) === 0)) {
            throw new \InvalidArgumentException(
