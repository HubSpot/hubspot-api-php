...
class BasicApi
{
     ...
     * @return \HubSpot\Client\Crm\Contacts\Model\SimplePublicObject|\HubSpot\Client\Crm\Contacts\Model\Error
     */
    public function getById($contact_id, $properties = null, $associations = null, $paginate_associations = false, $archived = false, $id_property = null)
    {
        list($response) = $this->getByIdWithHttpInfo($contact_id, $properties, $associations, $paginate_associations, $archived, $id_property);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Contacts\Model\SimplePublicObject|\HubSpot\Client\Crm\Contacts\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getByIdWithHttpInfo($contact_id, $properties = null, $associations = null, $paginate_associations = false, $archived = false, $id_property = null)
    {
        $request = $this->getByIdRequest($contact_id, $properties, $associations, $paginate_associations, $archived, $id_property);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($contact_id, $properties = null, $associations = null, $paginate_associations = false, $archived = false, $id_property = null)
    {
        return $this->getByIdAsyncWithHttpInfo($contact_id, $properties, $associations, $paginate_associations, $archived, $id_property)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($contact_id, $properties = null, $associations = null, $paginate_associations = false, $archived = false, $id_property = null)
    {
        $returnType = '\HubSpot\Client\Crm\Contacts\Model\SimplePublicObject';
        $request = $this->getByIdRequest($contact_id, $properties, $associations, $paginate_associations, $archived, $id_property);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getByIdRequest($contact_id, $properties = null, $associations = null, $paginate_associations = false, $archived = false, $id_property = null)
    {
        // verify the required parameter 'contact_id' is set
        if ($contact_id === null || (is_array($contact_id) && count($contact_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \HubSpot\Client\Crm\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Contacts\Model\CollectionResponseSimplePublicObject|\HubSpot\Client\Crm\Contacts\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Contacts\Model\CollectionResponseSimplePublicObject|\HubSpot\Client\Crm\Contacts\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPageWithHttpInfo($limit = 10, $after = null, $properties = null, $associations = null, $paginate_associations = false, $archived = false)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Contacts\Model\CollectionResponseSimplePublicObject' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Contacts\Model\CollectionResponseSimplePublicObject', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\HubSpot\Client\Crm\Contacts\Model\CollectionResponseSimplePublicObject';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\HubSpot\Client\Crm\Contacts\Model\CollectionResponseSimplePublicObject',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateRequest($contact_id, $simple_public_object_input)
    {
        // verify the required parameter 'contact_id' is set
        if ($contact_id === null || (is_array($contact_id) && count($contact_id) === 0)) {
            throw new \InvalidArgumentException(
