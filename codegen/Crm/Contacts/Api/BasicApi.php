...
class BasicApi
{
     ...
     * Create
     *
     * @param  \HubSpot\Client\Crm\Contacts\Model\SimplePublicObjectInput $simple_public_object_input simple_public_object_input (optional)
     *
     * @throws \HubSpot\Client\Crm\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Create
     *
     * @param  \HubSpot\Client\Crm\Contacts\Model\SimplePublicObjectInput $simple_public_object_input (optional)
     *
     * @throws \HubSpot\Client\Crm\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @return \HubSpot\Client\Crm\Contacts\Model\SimplePublicObject|\HubSpot\Client\Crm\Contacts\Model\Error
     */
    public function update($contact_id, $simple_public_object_input = null)
    {
     ...
     * @return array of \HubSpot\Client\Crm\Contacts\Model\SimplePublicObject|\HubSpot\Client\Crm\Contacts\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($contact_id, $simple_public_object_input = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($contact_id, $simple_public_object_input = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($contact_id, $simple_public_object_input = null)
    {
        $returnType = '\HubSpot\Client\Crm\Contacts\Model\SimplePublicObject';
        $request = $this->updateRequest($contact_id, $simple_public_object_input);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateRequest($contact_id, $simple_public_object_input = null)
    {
        // verify the required parameter 'contact_id' is set
        if ($contact_id === null || (is_array($contact_id) && count($contact_id) === 0)) {
            throw new \InvalidArgumentException(
