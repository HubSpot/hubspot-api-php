...
class BasicApi
{
    ...
    {
        $this->archiveWithHttpInfo($contact_id);
    }
     ...
     */
    public function archiveWithHttpInfo($contact_id)
    {
        $request = $this->archiveRequest($contact_id);
     ...
     */
    public function archiveAsync($contact_id)
    {
        return $this->archiveAsyncWithHttpInfo($contact_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function archiveAsyncWithHttpInfo($contact_id)
    {
        $returnType = '';
        $request = $this->archiveRequest($contact_id);
     ...
     */
    public function archiveRequest($contact_id)
    {
     ...
     */
    public function getById($contact_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        list($response) = $this->getByIdWithHttpInfo($contact_id, $properties, $properties_with_history, $associations, $archived, $id_property);
        return $response;
    }
     ...
     */
    public function getByIdWithHttpInfo($contact_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        $request = $this->getByIdRequest($contact_id, $properties, $properties_with_history, $associations, $archived, $id_property);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($contact_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        return $this->getByIdAsyncWithHttpInfo($contact_id, $properties, $properties_with_history, $associations, $archived, $id_property)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($contact_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        $returnType = '\HubSpot\Client\Crm\Contacts\Model\SimplePublicObjectWithAssociations';
        $request = $this->getByIdRequest($contact_id, $properties, $properties_with_history, $associations, $archived, $id_property);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getByIdRequest($contact_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        // verify the required parameter 'contact_id' is set
        if ($contact_id === null || (is_array($contact_id) && count($contact_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \HubSpot\Client\Crm\Contacts\Model\SimplePublicObject|\HubSpot\Client\Crm\Contacts\Model\Error
     */
    public function update($contact_id, $simple_public_object_input, $id_property = null)
    {
        list($response) = $this->updateWithHttpInfo($contact_id, $simple_public_object_input, $id_property);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Contacts\Model\SimplePublicObject|\HubSpot\Client\Crm\Contacts\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($contact_id, $simple_public_object_input, $id_property = null)
    {
        $request = $this->updateRequest($contact_id, $simple_public_object_input, $id_property);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($contact_id, $simple_public_object_input, $id_property = null)
    {
        return $this->updateAsyncWithHttpInfo($contact_id, $simple_public_object_input, $id_property)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($contact_id, $simple_public_object_input, $id_property = null)
    {
        $returnType = '\HubSpot\Client\Crm\Contacts\Model\SimplePublicObject';
        $request = $this->updateRequest($contact_id, $simple_public_object_input, $id_property);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRequest($contact_id, $simple_public_object_input, $id_property = null)
    {
        // verify the required parameter 'contact_id' is set
        if ($contact_id === null || (is_array($contact_id) && count($contact_id) === 0)) {
            throw new \InvalidArgumentException(
