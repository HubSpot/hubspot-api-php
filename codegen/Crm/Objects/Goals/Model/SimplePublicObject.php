...
class SimplePublicObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param array<string,\HubSpot\Client\Crm\Objects\Goals\Model\ValueWithTimestamp[]>|null $properties_with_history Key-value pairs representing the properties of the object along with their history, each with a timestamp and source information.
     *
     * @return self
     */
