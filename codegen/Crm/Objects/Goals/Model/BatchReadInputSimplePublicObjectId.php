...
class BatchReadInputSimplePublicObjectId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id_property' => 'string',
        'inputs' => '\HubSpot\Client\Crm\Objects\Goals\Model\SimplePublicObjectId[]',
        'properties' => 'string[]',
    ...
    */
     ...
     * Gets inputs
     *
     * @return \HubSpot\Client\Crm\Objects\Goals\Model\SimplePublicObjectId[]
     */
     ...
     * Sets inputs
     *
     * @param \HubSpot\Client\Crm\Objects\Goals\Model\SimplePublicObjectId[] $inputs An array of SimplePublicObjectId objects, each containing the ID of an object to be read.
     *
     * @return self
     */
