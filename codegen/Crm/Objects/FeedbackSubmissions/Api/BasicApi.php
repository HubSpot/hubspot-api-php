...
class BasicApi
{
     ...
     * @return void
     */
    public function archive($feedback_submission_id, string $contentType = self::contentTypes['archive'][0])
    {
        $this->archiveWithHttpInfo($feedback_submission_id, $contentType);
    }
     ...
     */
    public function archiveWithHttpInfo($feedback_submission_id, string $contentType = self::contentTypes['archive'][0])
    {
        $request = $this->archiveRequest($feedback_submission_id, $contentType);
     ...
     */
    public function archiveAsync($feedback_submission_id, string $contentType = self::contentTypes['archive'][0])
    {
        return $this->archiveAsyncWithHttpInfo($feedback_submission_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function archiveAsyncWithHttpInfo($feedback_submission_id, string $contentType = self::contentTypes['archive'][0])
    {
        $returnType = '';
        $request = $this->archiveRequest($feedback_submission_id, $contentType);
     ...
     */
    public function archiveRequest($feedback_submission_id, string $contentType = self::contentTypes['archive'][0])
    {
     ...
     * Create
     *
     * @param  \HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\SimplePublicObjectInputForCreate $simple_public_object_input_for_create simple_public_object_input_for_create (required)
     ...
     * Create
     *
     * @param  \HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\SimplePublicObjectInputForCreate $simple_public_object_input_for_create (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['create'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Crm\Objects\FeedbackSubmissions\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\CollectionResponseSimplePublicObjectWithAssociationsForwardPaging' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\CollectionResponseSimplePublicObjectWithAssociationsForwardPaging' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
     ...
     * @return \HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\SimplePublicObject|\HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\Error
     */
    public function update($feedback_submission_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
        list($response) = $this->updateWithHttpInfo($feedback_submission_id, $simple_public_object_input, $id_property, $contentType);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\SimplePublicObject|\HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($feedback_submission_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
        $request = $this->updateRequest($feedback_submission_id, $simple_public_object_input, $id_property, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($feedback_submission_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
        return $this->updateAsyncWithHttpInfo($feedback_submission_id, $simple_public_object_input, $id_property, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($feedback_submission_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\SimplePublicObject';
        $request = $this->updateRequest($feedback_submission_id, $simple_public_object_input, $id_property, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRequest($feedback_submission_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
