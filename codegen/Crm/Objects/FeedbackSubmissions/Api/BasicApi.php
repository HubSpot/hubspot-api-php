...
class BasicApi
{
     ...
     */
    public function getById($feedback_submission_id, $properties = null, $associations = null, $archived = false, $id_property = null)
    {
        list($response) = $this->getByIdWithHttpInfo($feedback_submission_id, $properties, $associations, $archived, $id_property);
        return $response;
    }
     ...
     */
    public function getByIdWithHttpInfo($feedback_submission_id, $properties = null, $associations = null, $archived = false, $id_property = null)
    {
        $request = $this->getByIdRequest($feedback_submission_id, $properties, $associations, $archived, $id_property);
     ...
     */
    public function getByIdAsync($feedback_submission_id, $properties = null, $associations = null, $archived = false, $id_property = null)
    {
        return $this->getByIdAsyncWithHttpInfo($feedback_submission_id, $properties, $associations, $archived, $id_property)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($feedback_submission_id, $properties = null, $associations = null, $archived = false, $id_property = null)
    {
        $returnType = '\HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\SimplePublicObjectWithAssociations';
        $request = $this->getByIdRequest($feedback_submission_id, $properties, $associations, $archived, $id_property);
     ...
     */
    protected function getByIdRequest($feedback_submission_id, $properties = null, $associations = null, $archived = false, $id_property = null)
    {
