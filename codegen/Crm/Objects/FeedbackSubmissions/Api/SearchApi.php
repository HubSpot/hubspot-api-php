...
class SearchApi
{
     ...
     * @return \HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\CollectionResponseWithTotalSimplePublicObject|\HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Objects\FeedbackSubmissions\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\CollectionResponseWithTotalSimplePublicObject|\HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\CollectionResponseWithTotalSimplePublicObject',
                        $request,
                        $response,
                    );
                default:
    ...
    {
        $returnType = '\HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\CollectionResponseWithTotalSimplePublicObject';
        $request = $this->doSearchRequest($public_object_search_request, $contentType);
