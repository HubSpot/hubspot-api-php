...
class PublicObjectApi
{
     ...
     *
     * @param  \HubSpot\Client\Crm\Objects\FeedbackSubmissions\Model\PublicMergeInput $public_merge_input public_merge_input (required)
     *
    ...
    public function mergeRequest($public_merge_input)
    {
        ...
        $resourcePath = '/crm/v3/objects/feedback_submissions/merge';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
