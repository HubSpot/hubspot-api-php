...
class CollectionResponseWithTotalSimplePublicObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets results
     *
     * @param \HubSpot\Client\Crm\Objects\Communications\Model\SimplePublicObject[] $results An array containing the simple public objects returned in the current page of the response. This property is required.
     *
     * @return self
     */
