...
class BasicApi
{
     ...
     * @return void
     */
    public function archive($communication_id)
    {
        $this->archiveWithHttpInfo($communication_id);
    }
     ...
     */
    public function archiveWithHttpInfo($communication_id)
    {
        $request = $this->archiveRequest($communication_id);
     ...
     */
    public function archiveAsync($communication_id)
    {
        return $this->archiveAsyncWithHttpInfo($communication_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function archiveAsyncWithHttpInfo($communication_id)
    {
        $returnType = '';
        $request = $this->archiveRequest($communication_id);
     ...
     */
    public function archiveRequest($communication_id)
    {
        ...
        if ($communication_id === null || (is_array($communication_id) && count($communication_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $communication_id when calling archive'
            );
        }
     ...
     * Create
     *
     * @param  \HubSpot\Client\Crm\Objects\Communications\Model\SimplePublicObjectInputForCreate $simple_public_object_input_for_create simple_public_object_input_for_create (required)
     *
     * @throws \HubSpot\Client\Crm\Objects\Communications\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Create
     *
     * @param  \HubSpot\Client\Crm\Objects\Communications\Model\SimplePublicObjectInputForCreate $simple_public_object_input_for_create (required)
     *
     * @throws \HubSpot\Client\Crm\Objects\Communications\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function getById($communication_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        list($response) = $this->getByIdWithHttpInfo($communication_id, $properties, $properties_with_history, $associations, $archived, $id_property);
        return $response;
    }
     ...
     */
    public function getByIdWithHttpInfo($communication_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        $request = $this->getByIdRequest($communication_id, $properties, $properties_with_history, $associations, $archived, $id_property);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Objects\Communications\Model\SimplePublicObjectWithAssociations' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Objects\Communications\Model\SimplePublicObjectWithAssociations' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Objects\Communications\Model\SimplePublicObjectWithAssociations', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\HubSpot\Client\Crm\Objects\Communications\Model\SimplePublicObjectWithAssociations',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($communication_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        return $this->getByIdAsyncWithHttpInfo($communication_id, $properties, $properties_with_history, $associations, $archived, $id_property)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($communication_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        $returnType = '\HubSpot\Client\Crm\Objects\Communications\Model\SimplePublicObjectWithAssociations';
        $request = $this->getByIdRequest($communication_id, $properties, $properties_with_history, $associations, $archived, $id_property);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getByIdRequest($communication_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        // verify the required parameter 'communication_id' is set
        if ($communication_id === null || (is_array($communication_id) && count($communication_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $communication_id when calling getById'
            );
        }
    ...
    public function getPageWithHttpInfo($limit = 10, $after = null, $properties = null, $properties_with_history = null, $associations = null, $archived = false)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Objects\Communications\Model\CollectionResponseSimplePublicObjectWithAssociationsForwardPaging' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Objects\Communications\Model\CollectionResponseSimplePublicObjectWithAssociationsForwardPaging' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Objects\Communications\Model\CollectionResponseSimplePublicObjectWithAssociationsForwardPaging', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     * @return \HubSpot\Client\Crm\Objects\Communications\Model\SimplePublicObject|\HubSpot\Client\Crm\Objects\Communications\Model\Error
     */
    public function update($communication_id, $simple_public_object_input, $id_property = null)
    {
        list($response) = $this->updateWithHttpInfo($communication_id, $simple_public_object_input, $id_property);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Objects\Communications\Model\SimplePublicObject|\HubSpot\Client\Crm\Objects\Communications\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($communication_id, $simple_public_object_input, $id_property = null)
    {
        $request = $this->updateRequest($communication_id, $simple_public_object_input, $id_property);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($communication_id, $simple_public_object_input, $id_property = null)
    {
        return $this->updateAsyncWithHttpInfo($communication_id, $simple_public_object_input, $id_property)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($communication_id, $simple_public_object_input, $id_property = null)
    {
        $returnType = '\HubSpot\Client\Crm\Objects\Communications\Model\SimplePublicObject';
        $request = $this->updateRequest($communication_id, $simple_public_object_input, $id_property);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRequest($communication_id, $simple_public_object_input, $id_property = null)
    {
        // verify the required parameter 'communication_id' is set
        if ($communication_id === null || (is_array($communication_id) && count($communication_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $communication_id when calling update'
            );
        }
