...
class BasicApi
{
     ...
     * Archive
     *
     * @param  string $communication_id The ID of the message to update. (required)
     ...
     * @return void
     */
    public function archive($communication_id, string $contentType = self::contentTypes['archive'][0])
    {
        $this->archiveWithHttpInfo($communication_id, $contentType);
    }
     ...
     */
    public function archiveWithHttpInfo($communication_id, string $contentType = self::contentTypes['archive'][0])
    {
        $request = $this->archiveRequest($communication_id, $contentType);
     ...
     */
    public function archiveAsync($communication_id, string $contentType = self::contentTypes['archive'][0])
    {
        return $this->archiveAsyncWithHttpInfo($communication_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function archiveAsyncWithHttpInfo($communication_id, string $contentType = self::contentTypes['archive'][0])
    {
        $returnType = '';
        $request = $this->archiveRequest($communication_id, $contentType);
     ...
     */
    public function archiveRequest($communication_id, string $contentType = self::contentTypes['archive'][0])
    {
     ...
     * Read
     *
     * @param  string $communication_id The ID of the message to retrieve. (required)
     ...
     * Update
     *
     * @param  string $communication_id The ID of the communication to update. (required)
     ...
     * @return \HubSpot\Client\Crm\Objects\Communications\Model\SimplePublicObject|\HubSpot\Client\Crm\Objects\Communications\Model\Error
     */
    public function update($communication_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
        list($response) = $this->updateWithHttpInfo($communication_id, $simple_public_object_input, $id_property, $contentType);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Objects\Communications\Model\SimplePublicObject|\HubSpot\Client\Crm\Objects\Communications\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($communication_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
        $request = $this->updateRequest($communication_id, $simple_public_object_input, $id_property, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($communication_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
        return $this->updateAsyncWithHttpInfo($communication_id, $simple_public_object_input, $id_property, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($communication_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Objects\Communications\Model\SimplePublicObject';
        $request = $this->updateRequest($communication_id, $simple_public_object_input, $id_property, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRequest($communication_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
