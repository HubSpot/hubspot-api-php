...
class SearchApi
{
     ...
     * Operation doSearch
     *
     * @param  \HubSpot\Client\Crm\Objects\Communications\Model\PublicObjectSearchRequest $public_object_search_request public_object_search_request (required)
     ...
     * @return \HubSpot\Client\Crm\Objects\Communications\Model\CollectionResponseWithTotalSimplePublicObjectForwardPaging|\HubSpot\Client\Crm\Objects\Communications\Model\Error
     */
     ...
     *
     * @param  \HubSpot\Client\Crm\Objects\Communications\Model\PublicObjectSearchRequest $public_object_search_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['doSearch'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Crm\Objects\Communications\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Objects\Communications\Model\CollectionResponseWithTotalSimplePublicObjectForwardPaging|\HubSpot\Client\Crm\Objects\Communications\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function doSearchWithHttpInfo($public_object_search_request, string $contentType = self::contentTypes['doSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Objects\Communications\Model\CollectionResponseWithTotalSimplePublicObjectForwardPaging' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Objects\Communications\Model\CollectionResponseWithTotalSimplePublicObjectForwardPaging' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Objects\Communications\Model\CollectionResponseWithTotalSimplePublicObjectForwardPaging', []),
            ...
            $returnType = '\HubSpot\Client\Crm\Objects\Communications\Model\CollectionResponseWithTotalSimplePublicObjectForwardPaging';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\HubSpot\Client\Crm\Objects\Communications\Model\CollectionResponseWithTotalSimplePublicObjectForwardPaging',
    ...
    public function doSearchRequest($public_object_search_request, string $contentType = self::contentTypes['doSearch'][0])
    {
        ...
        $resourcePath = '/crm/v3/objects/communications/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
