...
class StandardError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'errors' => '\HubSpot\Client\Crm\Objects\DealSplits\Model\ErrorDetail[]',
        'id' => 'string',
    ...
    */
     ...
     * Gets errors
     *
     * @return \HubSpot\Client\Crm\Objects\DealSplits\Model\ErrorDetail[]
     */
     ...
     * Sets errors
     *
     * @param \HubSpot\Client\Crm\Objects\DealSplits\Model\ErrorDetail[] $errors The detailed error objects.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id The id of the error
     *
     * @return self
     */
     ...
     * Sets links
     *
     * @param array<string,string> $links A map of link names to associated URIs containing documentation about the error or recommended remediation steps
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status A human readable message describing the error along with remediation steps where appropriate
     *
     * @return self
     */
