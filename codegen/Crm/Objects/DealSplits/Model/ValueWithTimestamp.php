...
class ValueWithTimestamp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets source_label
     *
     * @param string|null $source_label A human-readable label.
     *
     * @return self
     */
     ...
     * Sets timestamp
     *
     * @param \DateTime $timestamp The timestamp when the property was updated, in ISO 8601 format.
     *
     * @return self
     */
     ...
     *
     * @param int|null $updated_by_user_id The ID of the user who last updated the property.
     *
     * @return self
     */
