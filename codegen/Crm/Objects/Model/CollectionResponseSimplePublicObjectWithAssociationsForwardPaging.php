...
class CollectionResponseSimplePublicObjectWithAssociationsForwardPaging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets results
     *
     * @return \HubSpot\Client\Crm\Objects\Model\SimplePublicObjectWithAssociations[]
     */
     ...
     * Sets results
     *
     * @param \HubSpot\Client\Crm\Objects\Model\SimplePublicObjectWithAssociations[] $results An array of simple public objects that are included in the current page of the response. Each object may include its associated data.
     *
     * @return self
     */
