...
class BasicApi
{
    ...
    public function archiveRequest($note_id, string $contentType = self::contentTypes['archive'][0])
    {
        ...
        if (!preg_match("/.+/", $note_id)) {
            throw new \InvalidArgumentException("invalid value for \"note_id\" when calling BasicApi.archive, must conform to the pattern /.+/.");
        }
    ...
    public function getByIdRequest($note_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null, string $contentType = self::contentTypes['getById'][0])
    {
        ...
        if (!preg_match("/.+/", $note_id)) {
            throw new \InvalidArgumentException("invalid value for \"note_id\" when calling BasicApi.getById, must conform to the pattern /.+/.");
        }
     ...
     * @param  string[]|null $properties A comma separated list of the properties to be returned in the response. If any of the specified properties are not present on the requested object(s), they will be ignored. (optional)
     * @param  string[]|null $properties_with_history A comma separated list of the properties to be returned along with their history of previous values. If any of the specified properties are not present on the requested object(s), they will be ignored. Usage of this parameter will reduce the maximum number of notes that can be read by a single request. (optional)
     * @param  string[]|null $associations A comma separated list of object types to retrieve associated IDs for. If any of the specified associations do not exist, they will be ignored. (optional)
     * @param  bool|null $archived Whether to return only results that have been archived. (optional, default to false)
     ...
     * @throws \HubSpot\Client\Crm\Objects\Notes\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Objects\Notes\Model\CollectionResponseSimplePublicObjectWithAssociations|\HubSpot\Client\Crm\Objects\Notes\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Objects\Notes\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Objects\Notes\Model\CollectionResponseSimplePublicObjectWithAssociations|\HubSpot\Client\Crm\Objects\Notes\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPageWithHttpInfo($limit = 10, $after = null, $properties = null, $properties_with_history = null, $associations = null, $archived = false, string $contentType = self::contentTypes['getPage'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\HubSpot\Client\Crm\Objects\Notes\Model\CollectionResponseSimplePublicObjectWithAssociations',
                        $request,
                        $response,
                    );
                default:
    ...
    {
        $returnType = '\HubSpot\Client\Crm\Objects\Notes\Model\CollectionResponseSimplePublicObjectWithAssociations';
        $request = $this->getPageRequest($limit, $after, $properties, $properties_with_history, $associations, $archived, $contentType);
    ...
    public function updateRequest($note_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
        ...
        if (!preg_match("/.+/", $note_id)) {
            throw new \InvalidArgumentException("invalid value for \"note_id\" when calling BasicApi.update, must conform to the pattern /.+/.");
        }
