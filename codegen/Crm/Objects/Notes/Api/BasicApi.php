...
class BasicApi
{
    ...
    {
        $this->archiveWithHttpInfo($note_id);
    }
     ...
     */
    public function archiveWithHttpInfo($note_id)
    {
        $request = $this->archiveRequest($note_id);
     ...
     */
    public function archiveAsync($note_id)
    {
        return $this->archiveAsyncWithHttpInfo($note_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function archiveAsyncWithHttpInfo($note_id)
    {
        $returnType = '';
        $request = $this->archiveRequest($note_id);
     ...
     */
    public function archiveRequest($note_id)
    {
        ...
        $resourcePath = '/crm/v3/objects/notes/{noteId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Create
     *
     * @param  \HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObjectInputForCreate $simple_public_object_input_for_create simple_public_object_input_for_create (required)
     *
     * @throws \HubSpot\Client\Crm\Objects\Notes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObject|\HubSpot\Client\Crm\Objects\Notes\Model\Error
     */
     ...
     * Create
     *
     * @param  \HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObjectInputForCreate $simple_public_object_input_for_create (required)
     *
     * @throws \HubSpot\Client\Crm\Objects\Notes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObject|\HubSpot\Client\Crm\Objects\Notes\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($simple_public_object_input_for_create)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObject' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObject' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObject', []),
            ...
            $returnType = '\HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObject';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObject',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function createRequest($simple_public_object_input_for_create)
    {
        ...
        $resourcePath = '/crm/v3/objects/notes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getById($note_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        list($response) = $this->getByIdWithHttpInfo($note_id, $properties, $properties_with_history, $associations, $archived, $id_property);
        return $response;
    }
     ...
     */
    public function getByIdWithHttpInfo($note_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        $request = $this->getByIdRequest($note_id, $properties, $properties_with_history, $associations, $archived, $id_property);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObjectWithAssociations' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObjectWithAssociations' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObjectWithAssociations', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($note_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        return $this->getByIdAsyncWithHttpInfo($note_id, $properties, $properties_with_history, $associations, $archived, $id_property)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($note_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        $returnType = '\HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObjectWithAssociations';
        $request = $this->getByIdRequest($note_id, $properties, $properties_with_history, $associations, $archived, $id_property);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getByIdRequest($note_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        // verify the required parameter 'note_id' is set
        if ($note_id === null || (is_array($note_id) && count($note_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $note_id when calling getById'
            );
        }
    ...
    public function getPageWithHttpInfo($limit = 10, $after = null, $properties = null, $properties_with_history = null, $associations = null, $archived = false)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Objects\Notes\Model\CollectionResponseSimplePublicObjectWithAssociationsForwardPaging' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Objects\Notes\Model\CollectionResponseSimplePublicObjectWithAssociationsForwardPaging' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Objects\Notes\Model\CollectionResponseSimplePublicObjectWithAssociationsForwardPaging', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\HubSpot\Client\Crm\Objects\Notes\Model\CollectionResponseSimplePublicObjectWithAssociationsForwardPaging',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $note_id note_id (required)
     * @param  \HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObjectInput $simple_public_object_input simple_public_object_input (required)
     * @param  string $id_property The name of a property whose values are unique for this object type (optional)
     *
     * @throws \HubSpot\Client\Crm\Objects\Notes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObject|\HubSpot\Client\Crm\Objects\Notes\Model\Error
     */
    public function update($note_id, $simple_public_object_input, $id_property = null)
    {
        list($response) = $this->updateWithHttpInfo($note_id, $simple_public_object_input, $id_property);
        return $response;
    }
     ...
     *
     * @param  string $note_id (required)
     * @param  \HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObjectInput $simple_public_object_input (required)
     * @param  string $id_property The name of a property whose values are unique for this object type (optional)
     *
     * @throws \HubSpot\Client\Crm\Objects\Notes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObject|\HubSpot\Client\Crm\Objects\Notes\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($note_id, $simple_public_object_input, $id_property = null)
    {
        $request = $this->updateRequest($note_id, $simple_public_object_input, $id_property);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($note_id, $simple_public_object_input, $id_property = null)
    {
        return $this->updateAsyncWithHttpInfo($note_id, $simple_public_object_input, $id_property)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($note_id, $simple_public_object_input, $id_property = null)
    {
        $returnType = '\HubSpot\Client\Crm\Objects\Notes\Model\SimplePublicObject';
        $request = $this->updateRequest($note_id, $simple_public_object_input, $id_property);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRequest($note_id, $simple_public_object_input, $id_property = null)
    {
        // verify the required parameter 'note_id' is set
        if ($note_id === null || (is_array($note_id) && count($note_id) === 0)) {
            throw new \InvalidArgumentException(
