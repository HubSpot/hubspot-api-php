...
class BatchApi
{
     ...
     * @throws \HubSpot\Client\Crm\Objects\Meetings\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Objects\Meetings\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Objects\Meetings\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Objects\Meetings\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Objects\Meetings\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Objects\Meetings\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \HubSpot\Client\Crm\Objects\Meetings\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Objects\Meetings\Model\BatchResponseSimplePublicUpsertObject|\HubSpot\Client\Crm\Objects\Meetings\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Objects\Meetings\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Objects\Meetings\Model\BatchResponseSimplePublicUpsertObject|\HubSpot\Client\Crm\Objects\Meetings\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
