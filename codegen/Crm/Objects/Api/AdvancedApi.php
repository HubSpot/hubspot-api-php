...
class AdvancedApi
{
     ...
     */
    public function merge($object_type, $public_merge_input, string $contentType = self::contentTypes['merge'][0])
    {
        list($response) = $this->mergeWithHttpInfo($object_type, $public_merge_input, $contentType);
        return $response;
    }
     ...
     */
    public function mergeWithHttpInfo($object_type, $public_merge_input, string $contentType = self::contentTypes['merge'][0])
    {
        $request = $this->mergeRequest($object_type, $public_merge_input, $contentType);
     ...
     */
    public function mergeAsync($object_type, $public_merge_input, string $contentType = self::contentTypes['merge'][0])
    {
        return $this->mergeAsyncWithHttpInfo($object_type, $public_merge_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mergeAsyncWithHttpInfo($object_type, $public_merge_input, string $contentType = self::contentTypes['merge'][0])
    {
     ...
     */
    public function mergeRequest($object_type, $public_merge_input, string $contentType = self::contentTypes['merge'][0])
    {
