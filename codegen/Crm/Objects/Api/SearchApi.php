...
class SearchApi
{
    ...
    {
        list($response) = $this->doSearchWithHttpInfo($object_type, $public_object_search_request, $contentType);
        return $response;
    }
     ...
     */
    public function doSearchAsync($object_type, $public_object_search_request, string $contentType = self::contentTypes['doSearch'][0])
    {
        return $this->doSearchAsyncWithHttpInfo($object_type, $public_object_search_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function doSearchRequest($object_type, $public_object_search_request, string $contentType = self::contentTypes['doSearch'][0])
    {
