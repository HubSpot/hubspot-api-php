...
class BatchApi
{
     ...
     */
    protected function archiveRequest($object_type, $batch_input_simple_public_object_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createRequest($object_type, $batch_input_simple_public_object_input)
    {
        // verify the required parameter 'object_type' is set
        if ($object_type === null || (is_array($object_type) && count($object_type) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function readRequest($object_type, $batch_read_input_simple_public_object_id, $archived = false)
    {
        // verify the required parameter 'object_type' is set
        if ($object_type === null || (is_array($object_type) && count($object_type) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateRequest($object_type, $batch_input_simple_public_object_batch_input)
    {
        // verify the required parameter 'object_type' is set
        if ($object_type === null || (is_array($object_type) && count($object_type) === 0)) {
            throw new \InvalidArgumentException(
