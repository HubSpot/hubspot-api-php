...
class BatchApi
{
     ...
     * @return void
     */
    public function archive($object_type, $batch_input_simple_public_object_id)
    {
        $this->archiveWithHttpInfo($object_type, $batch_input_simple_public_object_id);
    }
     ...
     */
    public function archiveWithHttpInfo($object_type, $batch_input_simple_public_object_id)
    {
        $request = $this->archiveRequest($object_type, $batch_input_simple_public_object_id);
     ...
     */
    public function archiveAsync($object_type, $batch_input_simple_public_object_id)
    {
        return $this->archiveAsyncWithHttpInfo($object_type, $batch_input_simple_public_object_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function archiveAsyncWithHttpInfo($object_type, $batch_input_simple_public_object_id)
    {
        $returnType = '';
        $request = $this->archiveRequest($object_type, $batch_input_simple_public_object_id);
     ...
     */
    public function archiveRequest($object_type, $batch_input_simple_public_object_id)
    {
        ...
        $resourcePath = '/crm/v3/objects/{objectType}/batch/archive';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $object_type object_type (required)
     * @param  \HubSpot\Client\Crm\Objects\Model\BatchInputSimplePublicObjectInput $batch_input_simple_public_object_input batch_input_simple_public_object_input (required)
     *
     * @throws \HubSpot\Client\Crm\Objects\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function create($object_type, $batch_input_simple_public_object_input)
    {
        list($response) = $this->createWithHttpInfo($object_type, $batch_input_simple_public_object_input);
        return $response;
    }
     ...
     *
     * @param  string $object_type (required)
     * @param  \HubSpot\Client\Crm\Objects\Model\BatchInputSimplePublicObjectInput $batch_input_simple_public_object_input (required)
     *
     * @throws \HubSpot\Client\Crm\Objects\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function createWithHttpInfo($object_type, $batch_input_simple_public_object_input)
    {
        $request = $this->createRequest($object_type, $batch_input_simple_public_object_input);
            ...
            switch($statusCode) {
                case 201:
                    if ('\HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObject' === '\SplFileObject') {
                        ...
                        if ('\HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObject' !== 'string') {
                ...
                case 207:
                    if ('\HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObjectWithErrors' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObjectWithErrors' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObjectWithErrors', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsync($object_type, $batch_input_simple_public_object_input)
    {
        return $this->createAsyncWithHttpInfo($object_type, $batch_input_simple_public_object_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsyncWithHttpInfo($object_type, $batch_input_simple_public_object_input)
    {
        $returnType = '\HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObject';
        $request = $this->createRequest($object_type, $batch_input_simple_public_object_input);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createRequest($object_type, $batch_input_simple_public_object_input)
    {
        // verify the required parameter 'object_type' is set
        if ($object_type === null || (is_array($object_type) && count($object_type) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/crm/v3/objects/{objectType}/batch/create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObjectWithErrors|\HubSpot\Client\Crm\Objects\Model\Error
     */
    public function read($object_type, $batch_read_input_simple_public_object_id, $archived = false)
    {
        list($response) = $this->readWithHttpInfo($object_type, $batch_read_input_simple_public_object_id, $archived);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObjectWithErrors|\HubSpot\Client\Crm\Objects\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function readWithHttpInfo($object_type, $batch_read_input_simple_public_object_id, $archived = false)
    {
        $request = $this->readRequest($object_type, $batch_read_input_simple_public_object_id, $archived);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function readAsync($object_type, $batch_read_input_simple_public_object_id, $archived = false)
    {
        return $this->readAsyncWithHttpInfo($object_type, $batch_read_input_simple_public_object_id, $archived)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function readAsyncWithHttpInfo($object_type, $batch_read_input_simple_public_object_id, $archived = false)
    {
        $returnType = '\HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObject';
        $request = $this->readRequest($object_type, $batch_read_input_simple_public_object_id, $archived);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function readRequest($object_type, $batch_read_input_simple_public_object_id, $archived = false)
    {
        // verify the required parameter 'object_type' is set
        if ($object_type === null || (is_array($object_type) && count($object_type) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/crm/v3/objects/{objectType}/batch/read';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObjectWithErrors|\HubSpot\Client\Crm\Objects\Model\Error
     */
    public function update($object_type, $batch_input_simple_public_object_batch_input)
    {
        list($response) = $this->updateWithHttpInfo($object_type, $batch_input_simple_public_object_batch_input);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObjectWithErrors|\HubSpot\Client\Crm\Objects\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($object_type, $batch_input_simple_public_object_batch_input)
    {
        $request = $this->updateRequest($object_type, $batch_input_simple_public_object_batch_input);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($object_type, $batch_input_simple_public_object_batch_input)
    {
        return $this->updateAsyncWithHttpInfo($object_type, $batch_input_simple_public_object_batch_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($object_type, $batch_input_simple_public_object_batch_input)
    {
        $returnType = '\HubSpot\Client\Crm\Objects\Model\BatchResponseSimplePublicObject';
        $request = $this->updateRequest($object_type, $batch_input_simple_public_object_batch_input);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRequest($object_type, $batch_input_simple_public_object_batch_input)
    {
        // verify the required parameter 'object_type' is set
        if ($object_type === null || (is_array($object_type) && count($object_type) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/crm/v3/objects/{objectType}/batch/update';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
