...
class BasicApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getByIdRequest($object_type, $object_id, $properties = null, $associations = null, $archived = false, $id_property = null)
    {
        // verify the required parameter 'object_type' is set
        if ($object_type === null || (is_array($object_type) && count($object_type) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPageRequest($object_type, $limit = 10, $after = null, $properties = null, $associations = null, $archived = false)
    {
        // verify the required parameter 'object_type' is set
        if ($object_type === null || (is_array($object_type) && count($object_type) === 0)) {
            throw new \InvalidArgumentException(
