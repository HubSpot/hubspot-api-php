...
class BasicApi
{
     ...
     *
     * @param  string $object_type object_type (required)
     * @param  \HubSpot\Client\Crm\Objects\Model\SimplePublicObjectInput $simple_public_object_input simple_public_object_input (optional)
     *
     * @throws \HubSpot\Client\Crm\Objects\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Objects\Model\SimplePublicObject|\HubSpot\Client\Crm\Objects\Model\Error
     */
    public function create($object_type, $simple_public_object_input = null)
    {
     ...
     *
     * @param  string $object_type (required)
     * @param  \HubSpot\Client\Crm\Objects\Model\SimplePublicObjectInput $simple_public_object_input (optional)
     *
     * @throws \HubSpot\Client\Crm\Objects\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function createWithHttpInfo($object_type, $simple_public_object_input = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsync($object_type, $simple_public_object_input = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsyncWithHttpInfo($object_type, $simple_public_object_input = null)
    {
        $returnType = '\HubSpot\Client\Crm\Objects\Model\SimplePublicObject';
        $request = $this->createRequest($object_type, $simple_public_object_input);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createRequest($object_type, $simple_public_object_input = null)
    {
        // verify the required parameter 'object_type' is set
        if ($object_type === null || (is_array($object_type) && count($object_type) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \HubSpot\Client\Crm\Objects\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Objects\Model\CollectionResponseSimplePublicObject|\HubSpot\Client\Crm\Objects\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Objects\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Objects\Model\CollectionResponseSimplePublicObject|\HubSpot\Client\Crm\Objects\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPageWithHttpInfo($object_type, $limit = 10, $after = null, $properties = null, $associations = null, $archived = false)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Objects\Model\CollectionResponseSimplePublicObject' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Objects\Model\CollectionResponseSimplePublicObject', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
     ...
     * @return \HubSpot\Client\Crm\Objects\Model\SimplePublicObject|\HubSpot\Client\Crm\Objects\Model\Error
     */
    public function update($object_type, $object_id, $simple_public_object_input = null)
    {
        list($response) = $this->updateWithHttpInfo($object_type, $object_id, $simple_public_object_input);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Objects\Model\SimplePublicObject|\HubSpot\Client\Crm\Objects\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($object_type, $object_id, $simple_public_object_input = null)
    {
        $request = $this->updateRequest($object_type, $object_id, $simple_public_object_input);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($object_type, $object_id, $simple_public_object_input = null)
    {
        return $this->updateAsyncWithHttpInfo($object_type, $object_id, $simple_public_object_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($object_type, $object_id, $simple_public_object_input = null)
    {
        $returnType = '\HubSpot\Client\Crm\Objects\Model\SimplePublicObject';
        $request = $this->updateRequest($object_type, $object_id, $simple_public_object_input);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateRequest($object_type, $object_id, $simple_public_object_input = null)
    {
        // verify the required parameter 'object_type' is set
        if ($object_type === null || (is_array($object_type) && count($object_type) === 0)) {
            throw new \InvalidArgumentException(
