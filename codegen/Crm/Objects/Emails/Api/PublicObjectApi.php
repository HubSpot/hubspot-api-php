...
class PublicObjectApi
{
     ...
     *
     * @param  \HubSpot\Client\Crm\Objects\Emails\Model\PublicMergeInput $public_merge_input public_merge_input (required)
     *
     ...
     * Merge two emails with same type
     *
     * @param  \HubSpot\Client\Crm\Objects\Emails\Model\PublicMergeInput $public_merge_input (required)
     *
     * @throws \HubSpot\Client\Crm\Objects\Emails\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function mergeRequest($public_merge_input)
    {
        ...
        $resourcePath = '/crm/v3/objects/emails/merge';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
