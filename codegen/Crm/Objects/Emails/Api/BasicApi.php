...
class BasicApi
{
    ...
    public function archiveRequest($email_id, string $contentType = self::contentTypes['archive'][0])
    {
        ...
        if (!preg_match("/.+/", $email_id)) {
            throw new \InvalidArgumentException("invalid value for \"email_id\" when calling BasicApi.archive, must conform to the pattern /.+/.");
        }
     ...
     */
    public function getById($email_id, $archived = false, $associations = null, $id_property = null, $properties = null, $properties_with_history = null, string $contentType = self::contentTypes['getById'][0])
    {
        list($response) = $this->getByIdWithHttpInfo($email_id, $archived, $associations, $id_property, $properties, $properties_with_history, $contentType);
        return $response;
    }
     ...
     */
    public function getByIdWithHttpInfo($email_id, $archived = false, $associations = null, $id_property = null, $properties = null, $properties_with_history = null, string $contentType = self::contentTypes['getById'][0])
    {
        $request = $this->getByIdRequest($email_id, $archived, $associations, $id_property, $properties, $properties_with_history, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($email_id, $archived = false, $associations = null, $id_property = null, $properties = null, $properties_with_history = null, string $contentType = self::contentTypes['getById'][0])
    {
        return $this->getByIdAsyncWithHttpInfo($email_id, $archived, $associations, $id_property, $properties, $properties_with_history, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($email_id, $archived = false, $associations = null, $id_property = null, $properties = null, $properties_with_history = null, string $contentType = self::contentTypes['getById'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getByIdRequest($email_id, $archived = false, $associations = null, $id_property = null, $properties = null, $properties_with_history = null, string $contentType = self::contentTypes['getById'][0])
    {
        ...
        if (!preg_match("/.+/", $email_id)) {
            throw new \InvalidArgumentException("invalid value for \"email_id\" when calling BasicApi.getById, must conform to the pattern /.+/.");
        }
    ...
    public function updateRequest($email_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
        ...
        if (!preg_match("/.+/", $email_id)) {
            throw new \InvalidArgumentException("invalid value for \"email_id\" when calling BasicApi.update, must conform to the pattern /.+/.");
        }
