...
class PublicObjectSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'after' => 'string',
        'filter_groups' => '\HubSpot\Client\Crm\Objects\Emails\Model\FilterGroup[]',
        'limit' => 'int',
        'properties' => 'string[]',
        'query' => 'string',
        'sorts' => 'string[]'
    ...
    */
     ...
     * Gets filter_groups
     *
     * @return \HubSpot\Client\Crm\Objects\Emails\Model\FilterGroup[]|null
     */
     ...
     * Sets filter_groups
     *
     * @param \HubSpot\Client\Crm\Objects\Emails\Model\FilterGroup[]|null $filter_groups Up to 6 groups of filters defining additional query criteria.
     *
     * @return self
     */
