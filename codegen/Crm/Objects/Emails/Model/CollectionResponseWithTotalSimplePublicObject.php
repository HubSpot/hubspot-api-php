...
class CollectionResponseWithTotalSimplePublicObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets paging
     *
     * @param \HubSpot\Client\Crm\Objects\Emails\Model\Paging|null $paging paging
     *
     * @return self
     */
     ...
     * Sets results
     *
     * @param \HubSpot\Client\Crm\Objects\Emails\Model\SimplePublicObject[] $results An array containing the simple public objects returned in the current page of the response. This property is required.
     *
     * @return self
     */
