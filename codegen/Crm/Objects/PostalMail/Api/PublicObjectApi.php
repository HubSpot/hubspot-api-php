...
class PublicObjectApi
{
     ...
     *
     * @param  \HubSpot\Client\Crm\Objects\PostalMail\Model\PublicMergeInput $public_merge_input public_merge_input (required)
     *
     ...
     * Merge two postal mail with same type
     *
     * @param  \HubSpot\Client\Crm\Objects\PostalMail\Model\PublicMergeInput $public_merge_input (required)
     *
     * @throws \HubSpot\Client\Crm\Objects\PostalMail\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function mergeRequest($public_merge_input)
    {
        ...
        $resourcePath = '/crm/v3/objects/postal_mail/merge';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
