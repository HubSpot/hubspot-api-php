...
class PublicObjectApi
{
     ...
     *
     * @param  \HubSpot\Client\Crm\Objects\Taxes\Model\PublicMergeInput $public_merge_input public_merge_input (required)
     ...
     * Merge two taxes with same type
     *
     * @param  \HubSpot\Client\Crm\Objects\Taxes\Model\PublicMergeInput $public_merge_input (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['merge'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Crm\Objects\Taxes\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    public function mergeRequest($public_merge_input, string $contentType = self::contentTypes['merge'][0])
    {
        ...
        $resourcePath = '/crm/v3/objects/taxes/merge';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
