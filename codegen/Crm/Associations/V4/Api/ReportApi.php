...
class ReportApi
{
     ...
     * @return \HubSpot\Client\Crm\Associations\V4\Model\ReportCreationResponse|\HubSpot\Client\Crm\Associations\V4\Model\Error
     */
    public function request($user_id, string $contentType = self::contentTypes['request'][0])
    {
        list($response) = $this->requestWithHttpInfo($user_id, $contentType);
        return $response;
    }
     ...
     * @throws \HubSpot\Client\Crm\Associations\V4\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Associations\V4\Model\ReportCreationResponse|\HubSpot\Client\Crm\Associations\V4\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function requestWithHttpInfo($user_id, string $contentType = self::contentTypes['request'][0])
    {
        $request = $this->requestRequest($user_id, $contentType);
     ...
     */
    public function requestAsync($user_id, string $contentType = self::contentTypes['request'][0])
    {
        return $this->requestAsyncWithHttpInfo($user_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function requestAsyncWithHttpInfo($user_id, string $contentType = self::contentTypes['request'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Associations\V4\Model\ReportCreationResponse';
        $request = $this->requestRequest($user_id, $contentType);
     ...
     */
    public function requestRequest($user_id, string $contentType = self::contentTypes['request'][0])
    {

        // verify the required parameter 'user_id' is set
        if ($user_id === null || (is_array($user_id) && count($user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $user_id when calling request'
            );
        }


        $resourcePath = '/crm/v4/associations/usage/high-usage-report/{userId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
