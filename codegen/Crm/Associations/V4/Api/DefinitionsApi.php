...
class DefinitionsApi
{
     ...
     * @return void
     */
    public function archive($from_object_type, $to_object_type, $association_type_id)
    {
     ...
     */
    public function archiveWithHttpInfo($from_object_type, $to_object_type, $association_type_id)
    {
     ...
     */
    public function archiveAsync($from_object_type, $to_object_type, $association_type_id)
    {
        return $this->archiveAsyncWithHttpInfo($from_object_type, $to_object_type, $association_type_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function archiveAsyncWithHttpInfo($from_object_type, $to_object_type, $association_type_id)
    {
        $returnType = '';
        $request = $this->archiveRequest($from_object_type, $to_object_type, $association_type_id);
     ...
     */
    public function archiveRequest($from_object_type, $to_object_type, $association_type_id)
    {
     ...
     * @param  string $from_object_type from_object_type (required)
     * @param  string $to_object_type to_object_type (required)
     * @param  \HubSpot\Client\Crm\Associations\V4\Model\PublicAssociationDefinitionCreateRequest $public_association_definition_create_request public_association_definition_create_request (required)
     *
     * @throws \HubSpot\Client\Crm\Associations\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Associations\V4\Model\CollectionResponseAssociationSpecWithLabelNoPaging|\HubSpot\Client\Crm\Associations\V4\Model\Error
     */
     ...
     * @param  string $from_object_type (required)
     * @param  string $to_object_type (required)
     * @param  \HubSpot\Client\Crm\Associations\V4\Model\PublicAssociationDefinitionCreateRequest $public_association_definition_create_request (required)
     *
     * @throws \HubSpot\Client\Crm\Associations\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Associations\V4\Model\CollectionResponseAssociationSpecWithLabelNoPaging|\HubSpot\Client\Crm\Associations\V4\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($from_object_type, $to_object_type, $public_association_definition_create_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Associations\V4\Model\CollectionResponseAssociationSpecWithLabelNoPaging' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Associations\V4\Model\CollectionResponseAssociationSpecWithLabelNoPaging' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Associations\V4\Model\CollectionResponseAssociationSpecWithLabelNoPaging', []),
            ...
            $returnType = '\HubSpot\Client\Crm\Associations\V4\Model\CollectionResponseAssociationSpecWithLabelNoPaging';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\HubSpot\Client\Crm\Associations\V4\Model\CollectionResponseAssociationSpecWithLabelNoPaging',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $from_object_type from_object_type (required)
     * @param  string $to_object_type to_object_type (required)
     * @param  \HubSpot\Client\Crm\Associations\V4\Model\PublicAssociationDefinitionUpdateRequest $public_association_definition_update_request public_association_definition_update_request (required)
     *
     * @throws \HubSpot\Client\Crm\Associations\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @param  string $from_object_type (required)
     * @param  string $to_object_type (required)
     * @param  \HubSpot\Client\Crm\Associations\V4\Model\PublicAssociationDefinitionUpdateRequest $public_association_definition_update_request (required)
     *
     * @throws \HubSpot\Client\Crm\Associations\V4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
