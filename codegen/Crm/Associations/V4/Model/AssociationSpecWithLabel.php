...
class AssociationSpecWithLabel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets category
     *
     * @param string $category The category of the association, such as HUBSPOT_DEFINED, USER_DEFINED, or INTEGRATOR_DEFINED.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label A label describing the association between two objects.
     *
     * @return self
     */
     ...
     * Sets type_id
     *
     * @param int $type_id The unique identifier for the type of association.
     *
     * @return self
     */
