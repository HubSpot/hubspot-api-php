...
/**
 * ReportCreationResponse Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Associations\V4
 * @author   OpenAPI Generator team
 ...
 */
class ReportCreationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReportCreationResponse';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('enqueue_time', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['enqueue_time'] === null) {
            $invalidProperties[] = "'enqueue_time' can't be null";
        }
     ...
     * Sets enqueue_time
     *
     * @param \DateTime $enqueue_time enqueue_time
     *
     * @return self
     */
    public function setEnqueueTime($enqueue_time)
    {
        if (is_null($enqueue_time)) {
            throw new \InvalidArgumentException('non-nullable enqueue_time cannot be null');
        }
