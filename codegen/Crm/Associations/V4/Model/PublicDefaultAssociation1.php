...
/**
 * PublicDefaultAssociation1 Class Doc Comment
 *
 * @category Class
 * @description The PublicDefaultAssociation component represents the default association configuration between two objects in HubSpot. It is used to define how objects are related to each other within the platform.
 * @package  HubSpot\Client\Crm\Associations\V4
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PublicDefaultAssociation1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicDefaultAssociation_1';
    ...
    {
        $this->setIfExists('association_spec', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($association_spec)) {
            throw new \InvalidArgumentException('non-nullable association_spec cannot be null');
        }
     ...
     * Gets from
     *
     * @return \HubSpot\Client\Crm\Associations\V4\Model\PublicObjectId
     */
     ...
     * Sets from
     *
     * @param \HubSpot\Client\Crm\Associations\V4\Model\PublicObjectId $from from
     *
     * @return self
     */
     ...
     * Sets to
     *
     * @param \HubSpot\Client\Crm\Associations\V4\Model\PublicObjectId $to to
     *
     * @return self
     */
