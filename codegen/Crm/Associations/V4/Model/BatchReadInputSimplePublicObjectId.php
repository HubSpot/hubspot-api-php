...
class BatchReadInputSimplePublicObjectId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'id_property' => 'string',
        'inputs' => '\HubSpot\Client\Crm\Associations\V4\Model\SimplePublicObjectId[]',
        'properties' => 'string[]'
    ];
     ...
     * Gets inputs
     *
     * @return \HubSpot\Client\Crm\Associations\V4\Model\SimplePublicObjectId[]
     */
     ...
     * Sets inputs
     *
     * @param \HubSpot\Client\Crm\Associations\V4\Model\SimplePublicObjectId[] $inputs inputs
     *
     * @return self
     */
