...
class DefinitionsApi
{
     ...
     * @return void
     */
    public function remove($from_object_type, $to_object_type, $association_type_id, string $contentType = self::contentTypes['remove'][0])
    {
        $this->removeWithHttpInfo($from_object_type, $to_object_type, $association_type_id, $contentType);
    }
     ...
     */
    public function removeWithHttpInfo($from_object_type, $to_object_type, $association_type_id, string $contentType = self::contentTypes['remove'][0])
    {
        $request = $this->removeRequest($from_object_type, $to_object_type, $association_type_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeAsync($from_object_type, $to_object_type, $association_type_id, string $contentType = self::contentTypes['remove'][0])
    {
        return $this->removeAsyncWithHttpInfo($from_object_type, $to_object_type, $association_type_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeAsyncWithHttpInfo($from_object_type, $to_object_type, $association_type_id, string $contentType = self::contentTypes['remove'][0])
    {
        $returnType = '';
        $request = $this->removeRequest($from_object_type, $to_object_type, $association_type_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function removeRequest($from_object_type, $to_object_type, $association_type_id, string $contentType = self::contentTypes['remove'][0])
    {
