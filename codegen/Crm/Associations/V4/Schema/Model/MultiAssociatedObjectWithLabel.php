...
class MultiAssociatedObjectWithLabel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'to_object_id' => 'int',
        'association_types' => '\HubSpot\Client\Crm\Associations\V4\Schema\Model\AssociationSpecWithLabel[]'
    ];
     ...
     *
     * @param \HubSpot\Client\Crm\Associations\V4\Schema\Model\AssociationSpecWithLabel[] $association_types association_types
     *
     * @return self
     */
