...
class AssociationSpecWithLabel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets category
     *
     * @param string $category Association category. Can be HUBSPOT_DEFINED, USER_DEFINED, INTEGRATOR_DEFINED or WORK
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label An optional descriptor that provides additional context about the relationship between associated records, such as \"Mentor\" and \"Mentee\".
     *
     * @return self
     */
