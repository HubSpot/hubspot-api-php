...
/**
 * BatchResponsePublicAssociationDefinitionUserConfiguration Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Associations\V4\Schema
 * @author   OpenAPI Generator team
 ...
 */
class BatchResponsePublicAssociationDefinitionUserConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchResponsePublicAssociationDefinitionUserConfiguration';
    ...
    */
     ...
     * Sets links
     *
     * @param array<string,string>|null $links A collection of URLs linking to related documentation or resources associated with the batch operation.
     *
     * @return self
     */
     ...
     * Sets num_errors
     *
     * @param int|null $num_errors The total number of errors encountered during the batch operation.
     *
     * @return self
     */
     ...
     * Gets results
     *
     * @return \HubSpot\Client\Crm\Associations\V4\Schema\Model\PublicAssociationDefinitionUserConfiguration[]
     */
     ...
     * Sets results
     *
     * @param \HubSpot\Client\Crm\Associations\V4\Schema\Model\PublicAssociationDefinitionUserConfiguration[] $results results
     *
     * @return self
     */
