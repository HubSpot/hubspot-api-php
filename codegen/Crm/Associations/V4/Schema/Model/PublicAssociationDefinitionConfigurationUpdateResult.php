...
/**
 * PublicAssociationDefinitionConfigurationUpdateResult Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Associations\V4\Schema
 * @author   OpenAPI Generator team
 ...
 */
class PublicAssociationDefinitionConfigurationUpdateResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicAssociationDefinitionConfigurationUpdateResult';
    ...
    */
     ...
     * Sets category
     *
     * @param string $category The category of the association, which can be HUBSPOT_DEFINED, INTEGRATOR_DEFINED, or USER_DEFINED.
     *
     * @return self
     */
     ...
     * Sets type_id
     *
     * @param int $type_id An integer value used to uniquely identify a specific association type within its Association Category.
     *
     * @return self
     */
     ...
     *
     * @param int|null $user_enforced_max_to_object_ids The maximum number of object IDs that a user can enforce for associations.
     *
     * @return self
     */
