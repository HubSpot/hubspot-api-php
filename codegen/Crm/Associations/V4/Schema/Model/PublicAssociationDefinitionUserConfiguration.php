...
class PublicAssociationDefinitionUserConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets label
     *
     * @param string|null $label A descriptor providing context about the relationship between associated records.
     *
     * @return self
     */
     ...
     * Sets type_id
     *
     * @param int $type_id A unique integer identifier for the association type within its category.
     *
     * @return self
     */
     ...
     *
     * @param int|null $user_enforced_max_to_object_ids The maximum number of target object IDs that a user can enforce in an association.
     *
     * @return self
     */
