...
class BatchResponseVoid implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets links
     *
     * @param array<string,string>|null $links A collection of URLs linking to related resources or documentation.
     *
     * @return self
     */
     ...
     * Sets started_at
     *
     * @param \DateTime $started_at The date and time when the batch operation began.
     *
     * @return self
     */
