...
/**
 * PublicAssociationDefinitionUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Associations\V4\Schema
 * @author   OpenAPI Generator team
 ...
 */
class PublicAssociationDefinitionUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicAssociationDefinitionUpdateRequest';
    ...
    */
     ...
     *
     * @param int $association_type_id The unique identifier for the association type.
     *
     * @return self
     */
     ...
     * Sets inverse_label
     *
     * @param string|null $inverse_label An optional descriptor for the inverse relationship between associated records.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string $label A descriptor that provides context about the relationship between associated records.
     *
     * @return self
     */
