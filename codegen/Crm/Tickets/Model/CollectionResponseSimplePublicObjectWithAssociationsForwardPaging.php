...
class CollectionResponseSimplePublicObjectWithAssociationsForwardPaging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'results' => '\HubSpot\Client\Crm\Tickets\Model\SimplePublicObjectWithAssociations[]'
    ];
    ...
    */
     ...
     * Sets results
     *
     * @param \HubSpot\Client\Crm\Tickets\Model\SimplePublicObjectWithAssociations[] $results An array of simple public objects that are included in the current page of the response. Each object may include its associated data.
     *
     * @return self
     */
