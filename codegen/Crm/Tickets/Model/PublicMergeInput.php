...
class PublicMergeInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $object_id_to_merge The ID of the object that will be merged into the primary object.
     *
     * @return self
     */
     ...
     *
     * @param string $primary_object_id The ID of the primary object into which another object will be merged.
     *
     * @return self
     */
