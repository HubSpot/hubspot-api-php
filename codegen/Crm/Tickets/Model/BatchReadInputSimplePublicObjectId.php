...
class BatchReadInputSimplePublicObjectId implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id_property' => 'string',
        'inputs' => '\HubSpot\Client\Crm\Tickets\Model\SimplePublicObjectId[]',
        'properties' => 'string[]',
    ...
    */
     ...
     * Sets inputs
     *
     * @param \HubSpot\Client\Crm\Tickets\Model\SimplePublicObjectId[] $inputs An array of SimplePublicObjectId objects, each containing the ID of an object to be read.
     *
     * @return self
     */
