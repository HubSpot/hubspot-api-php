...
class BatchApi
{
     ...
     * @throws \HubSpot\Client\Crm\Tickets\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Tickets\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Tickets\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Tickets\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Tickets\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Tickets\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \HubSpot\Client\Crm\Tickets\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Tickets\Model\BatchResponseSimplePublicUpsertObject|\HubSpot\Client\Crm\Tickets\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Tickets\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Tickets\Model\BatchResponseSimplePublicUpsertObject|\HubSpot\Client\Crm\Tickets\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
