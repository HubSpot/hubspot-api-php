...
class BasicApi
{
     ...
     * @return \HubSpot\Client\Crm\Tickets\Model\SimplePublicObject|\HubSpot\Client\Crm\Tickets\Model\Error
     */
    public function getById($ticket_id, $properties = null, $associations = null, $paginate_associations = false, $archived = false, $id_property = null)
    {
        list($response) = $this->getByIdWithHttpInfo($ticket_id, $properties, $associations, $paginate_associations, $archived, $id_property);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Tickets\Model\SimplePublicObject|\HubSpot\Client\Crm\Tickets\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getByIdWithHttpInfo($ticket_id, $properties = null, $associations = null, $paginate_associations = false, $archived = false, $id_property = null)
    {
        $request = $this->getByIdRequest($ticket_id, $properties, $associations, $paginate_associations, $archived, $id_property);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($ticket_id, $properties = null, $associations = null, $paginate_associations = false, $archived = false, $id_property = null)
    {
        return $this->getByIdAsyncWithHttpInfo($ticket_id, $properties, $associations, $paginate_associations, $archived, $id_property)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($ticket_id, $properties = null, $associations = null, $paginate_associations = false, $archived = false, $id_property = null)
    {
        $returnType = '\HubSpot\Client\Crm\Tickets\Model\SimplePublicObject';
        $request = $this->getByIdRequest($ticket_id, $properties, $associations, $paginate_associations, $archived, $id_property);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getByIdRequest($ticket_id, $properties = null, $associations = null, $paginate_associations = false, $archived = false, $id_property = null)
    {
        // verify the required parameter 'ticket_id' is set
        if ($ticket_id === null || (is_array($ticket_id) && count($ticket_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \HubSpot\Client\Crm\Tickets\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Tickets\Model\CollectionResponseSimplePublicObject|\HubSpot\Client\Crm\Tickets\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Tickets\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Tickets\Model\CollectionResponseSimplePublicObject|\HubSpot\Client\Crm\Tickets\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPageWithHttpInfo($limit = 10, $after = null, $properties = null, $associations = null, $paginate_associations = false, $archived = false)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Tickets\Model\CollectionResponseSimplePublicObject' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Tickets\Model\CollectionResponseSimplePublicObject', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\HubSpot\Client\Crm\Tickets\Model\CollectionResponseSimplePublicObject';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\HubSpot\Client\Crm\Tickets\Model\CollectionResponseSimplePublicObject',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \HubSpot\Client\Crm\Tickets\Model\SimplePublicObject|\HubSpot\Client\Crm\Tickets\Model\Error
     */
    public function update($ticket_id, $simple_public_object_input)
    {
        list($response) = $this->updateWithHttpInfo($ticket_id, $simple_public_object_input);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Tickets\Model\SimplePublicObject|\HubSpot\Client\Crm\Tickets\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($ticket_id, $simple_public_object_input)
    {
        $request = $this->updateRequest($ticket_id, $simple_public_object_input);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($ticket_id, $simple_public_object_input)
    {
        return $this->updateAsyncWithHttpInfo($ticket_id, $simple_public_object_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($ticket_id, $simple_public_object_input)
    {
        $returnType = '\HubSpot\Client\Crm\Tickets\Model\SimplePublicObject';
        $request = $this->updateRequest($ticket_id, $simple_public_object_input);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateRequest($ticket_id, $simple_public_object_input)
    {
        // verify the required parameter 'ticket_id' is set
        if ($ticket_id === null || (is_array($ticket_id) && count($ticket_id) === 0)) {
            throw new \InvalidArgumentException(
