...
class BasicApi
{
    ...
    {
        $this->archiveWithHttpInfo($ticket_id);
    }
     ...
     */
    public function archiveWithHttpInfo($ticket_id)
    {
        $request = $this->archiveRequest($ticket_id);
     ...
     */
    public function archiveAsync($ticket_id)
    {
        return $this->archiveAsyncWithHttpInfo($ticket_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function archiveAsyncWithHttpInfo($ticket_id)
    {
        $returnType = '';
        $request = $this->archiveRequest($ticket_id);
     ...
     */
    public function archiveRequest($ticket_id)
    {
     ...
     */
    public function getById($ticket_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        list($response) = $this->getByIdWithHttpInfo($ticket_id, $properties, $properties_with_history, $associations, $archived, $id_property);
        return $response;
    }
     ...
     */
    public function getByIdWithHttpInfo($ticket_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        $request = $this->getByIdRequest($ticket_id, $properties, $properties_with_history, $associations, $archived, $id_property);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($ticket_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        return $this->getByIdAsyncWithHttpInfo($ticket_id, $properties, $properties_with_history, $associations, $archived, $id_property)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($ticket_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        $returnType = '\HubSpot\Client\Crm\Tickets\Model\SimplePublicObjectWithAssociations';
        $request = $this->getByIdRequest($ticket_id, $properties, $properties_with_history, $associations, $archived, $id_property);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getByIdRequest($ticket_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        // verify the required parameter 'ticket_id' is set
        if ($ticket_id === null || (is_array($ticket_id) && count($ticket_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \HubSpot\Client\Crm\Tickets\Model\SimplePublicObject|\HubSpot\Client\Crm\Tickets\Model\Error
     */
    public function update($ticket_id, $simple_public_object_input, $id_property = null)
    {
        list($response) = $this->updateWithHttpInfo($ticket_id, $simple_public_object_input, $id_property);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Tickets\Model\SimplePublicObject|\HubSpot\Client\Crm\Tickets\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($ticket_id, $simple_public_object_input, $id_property = null)
    {
        $request = $this->updateRequest($ticket_id, $simple_public_object_input, $id_property);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($ticket_id, $simple_public_object_input, $id_property = null)
    {
        return $this->updateAsyncWithHttpInfo($ticket_id, $simple_public_object_input, $id_property)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($ticket_id, $simple_public_object_input, $id_property = null)
    {
        $returnType = '\HubSpot\Client\Crm\Tickets\Model\SimplePublicObject';
        $request = $this->updateRequest($ticket_id, $simple_public_object_input, $id_property);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRequest($ticket_id, $simple_public_object_input, $id_property = null)
    {
        // verify the required parameter 'ticket_id' is set
        if ($ticket_id === null || (is_array($ticket_id) && count($ticket_id) === 0)) {
            throw new \InvalidArgumentException(
