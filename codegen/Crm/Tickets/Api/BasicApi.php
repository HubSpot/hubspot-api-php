...
class BasicApi
{
     ...
     * @return \HubSpot\Client\Crm\Tickets\Model\SimplePublicObject|\HubSpot\Client\Crm\Tickets\Model\Error
     */
    public function getById($ticket_id, $properties = null, $associations = null, $archived = false)
    {
        list($response) = $this->getByIdWithHttpInfo($ticket_id, $properties, $associations, $archived);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Tickets\Model\SimplePublicObject|\HubSpot\Client\Crm\Tickets\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getByIdWithHttpInfo($ticket_id, $properties = null, $associations = null, $archived = false)
    {
        $request = $this->getByIdRequest($ticket_id, $properties, $associations, $archived);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($ticket_id, $properties = null, $associations = null, $archived = false)
    {
        return $this->getByIdAsyncWithHttpInfo($ticket_id, $properties, $associations, $archived)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($ticket_id, $properties = null, $associations = null, $archived = false)
    {
        $returnType = '\HubSpot\Client\Crm\Tickets\Model\SimplePublicObject';
        $request = $this->getByIdRequest($ticket_id, $properties, $associations, $archived);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getByIdRequest($ticket_id, $properties = null, $associations = null, $archived = false)
    {
        // verify the required parameter 'ticket_id' is set
        if ($ticket_id === null || (is_array($ticket_id) && count($ticket_id) === 0)) {
            throw new \InvalidArgumentException(
