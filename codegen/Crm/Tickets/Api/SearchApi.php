...
class SearchApi
{
     ...
     *
     * @param  \HubSpot\Client\Crm\Tickets\Model\PublicObjectSearchRequest $public_object_search_request public_object_search_request (optional)
     *
     ...
     * Filter, Sort, and Search CRM Objects
     *
     * @param  \HubSpot\Client\Crm\Tickets\Model\PublicObjectSearchRequest $public_object_search_request (optional)
     *
     * @throws \HubSpot\Client\Crm\Tickets\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function doSearchWithHttpInfo($public_object_search_request = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Tickets\Model\CollectionResponseWithTotalSimplePublicObject' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Tickets\Model\CollectionResponseWithTotalSimplePublicObject', []),
