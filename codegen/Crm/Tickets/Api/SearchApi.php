...
class SearchApi
{
     ...
     * @return \HubSpot\Client\Crm\Tickets\Model\CollectionResponseWithTotalSimplePublicObject|\HubSpot\Client\Crm\Tickets\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Tickets\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Tickets\Model\CollectionResponseWithTotalSimplePublicObject|\HubSpot\Client\Crm\Tickets\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\HubSpot\Client\Crm\Tickets\Model\CollectionResponseWithTotalSimplePublicObject',
                        $request,
                        $response,
                    );
                default:
    ...
    {
        $returnType = '\HubSpot\Client\Crm\Tickets\Model\CollectionResponseWithTotalSimplePublicObject';
        $request = $this->doSearchRequest($public_object_search_request, $contentType);
