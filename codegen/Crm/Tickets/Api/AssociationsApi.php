...
class AssociationsApi
{
     ...
     */
    public function create($ticket_id, $to_object_type, $to_object_id, $association_type, $paginate_associations = false)
    {
        list($response) = $this->createWithHttpInfo($ticket_id, $to_object_type, $to_object_id, $association_type, $paginate_associations);
        return $response;
    }
     ...
     */
    public function createWithHttpInfo($ticket_id, $to_object_type, $to_object_id, $association_type, $paginate_associations = false)
    {
        $request = $this->createRequest($ticket_id, $to_object_type, $to_object_id, $association_type, $paginate_associations);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsync($ticket_id, $to_object_type, $to_object_id, $association_type, $paginate_associations = false)
    {
        return $this->createAsyncWithHttpInfo($ticket_id, $to_object_type, $to_object_id, $association_type, $paginate_associations)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsyncWithHttpInfo($ticket_id, $to_object_type, $to_object_id, $association_type, $paginate_associations = false)
    {
        $returnType = '\HubSpot\Client\Crm\Tickets\Model\SimplePublicObject';
        $request = $this->createRequest($ticket_id, $to_object_type, $to_object_id, $association_type, $paginate_associations);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createRequest($ticket_id, $to_object_type, $to_object_id, $association_type, $paginate_associations = false)
    {
        // verify the required parameter 'ticket_id' is set
        if ($ticket_id === null || (is_array($ticket_id) && count($ticket_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getAll($ticket_id, $to_object_type, $paginate_associations = false, $after = null, $limit = 500)
    {
        list($response) = $this->getAllWithHttpInfo($ticket_id, $to_object_type, $paginate_associations, $after, $limit);
        return $response;
    }
     ...
     */
    public function getAllWithHttpInfo($ticket_id, $to_object_type, $paginate_associations = false, $after = null, $limit = 500)
    {
        $request = $this->getAllRequest($ticket_id, $to_object_type, $paginate_associations, $after, $limit);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllAsync($ticket_id, $to_object_type, $paginate_associations = false, $after = null, $limit = 500)
    {
        return $this->getAllAsyncWithHttpInfo($ticket_id, $to_object_type, $paginate_associations, $after, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllAsyncWithHttpInfo($ticket_id, $to_object_type, $paginate_associations = false, $after = null, $limit = 500)
    {
        $returnType = '\HubSpot\Client\Crm\Tickets\Model\CollectionResponseAssociatedId';
        $request = $this->getAllRequest($ticket_id, $to_object_type, $paginate_associations, $after, $limit);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllRequest($ticket_id, $to_object_type, $paginate_associations = false, $after = null, $limit = 500)
    {
        // verify the required parameter 'ticket_id' is set
        if ($ticket_id === null || (is_array($ticket_id) && count($ticket_id) === 0)) {
            throw new \InvalidArgumentException(
