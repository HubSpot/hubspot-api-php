...
class EventsApi
{
    ...
    protected function createBatchRequest($batch_input_timeline_event)
    {
        ...
        if (isset($batch_input_timeline_event)) {
            $_tempBody = $batch_input_timeline_event;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getByIdRequest($event_template_id, $event_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getDetailByIdRequest($event_template_id, $event_id)
    {
        // verify the required parameter 'event_template_id' is set
        if ($event_template_id === null || (is_array($event_template_id) && count($event_template_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getRenderByIdRequest($event_template_id, $event_id, $detail = null)
    {
        // verify the required parameter 'event_template_id' is set
        if ($event_template_id === null || (is_array($event_template_id) && count($event_template_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // query params
        if ($detail !== null) {
            $queryParams['detail'] = ObjectSerializer::toQueryValue($detail);
        }
