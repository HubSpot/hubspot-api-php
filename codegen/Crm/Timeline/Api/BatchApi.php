...
class BatchApi
{
     ...
     *
     * @param  \HubSpot\Client\Crm\Timeline\Model\BatchInputTimelineEvent $batch_input_timeline_event batch_input_timeline_event (required)
    ...
    {
        list($response) = $this->createBatchWithHttpInfo($batch_input_timeline_event, $contentType);
        return $response;
    }
     ...
     * Create multiple events
     *
     * @param  \HubSpot\Client\Crm\Timeline\Model\BatchInputTimelineEvent $batch_input_timeline_event (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createBatch'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Crm\Timeline\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
