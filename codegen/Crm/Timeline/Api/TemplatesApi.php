...
class TemplatesApi
{
    ...
    public function createRequest($app_id, $timeline_event_template_create_request)
    {
        ...
        if (isset($timeline_event_template_create_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($timeline_event_template_create_request));
            } else {
    ...
    public function updateRequest($event_template_id, $app_id, $timeline_event_template_update_request)
    {
        ...
        if (isset($timeline_event_template_update_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($timeline_event_template_update_request));
            } else {
