 ...
 * @link     https://openapi-generator.tech
 */
class AddNumbers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddNumbers';
    ...
    const OPERATOR_ADD_NUMBERS = 'ADD_NUMBERS';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'ADD_NUMBERS';
