...
/**
 * FetchExchangeRate Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class FetchExchangeRate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FetchExchangeRate';
    ...
    const OPERATOR_FETCH_EXCHANGE_RATE = 'FETCH_EXCHANGE_RATE';
    ...
    {
        return [
            self::OPERATOR_FETCH_EXCHANGE_RATE,
        ];
    }
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'FETCH_EXCHANGE_RATE';
