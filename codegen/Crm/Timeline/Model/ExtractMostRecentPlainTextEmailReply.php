...
/**
 * ExtractMostRecentPlainTextEmailReply Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ExtractMostRecentPlainTextEmailReply implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExtractMostRecentPlainTextEmailReply';
    ...
    const OPERATOR_EXTRACT_MOST_RECENT_PLAIN_TEXT_EMAIL_REPLY = 'EXTRACT_MOST_RECENT_PLAIN_TEXT_EMAIL_REPLY';
    ...
    {
        return [
            self::OPERATOR_EXTRACT_MOST_RECENT_PLAIN_TEXT_EMAIL_REPLY,
        ];
    }
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'EXTRACT_MOST_RECENT_PLAIN_TEXT_EMAIL_REPLY';
