 ...
 * @link     https://openapi-generator.tech
 */
class MinNumbers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MinNumbers';
    ...
    const OPERATOR_MIN_NUMBERS = 'MIN_NUMBERS';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'MIN_NUMBERS';
