...
/**
 * SubtractNumbers Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SubtractNumbers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubtractNumbers';
    ...
    const OPERATOR_SUBTRACT_NUMBERS = 'SUBTRACT_NUMBERS';
    ...
    {
        return [
            self::OPERATOR_SUBTRACT_NUMBERS,
        ];
    }
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'SUBTRACT_NUMBERS';
