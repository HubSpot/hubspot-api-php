...
/**
 * BooleanPropertyVariable Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class BooleanPropertyVariable implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BooleanPropertyVariable';
    ...
    const OPERATOR_BOOLEAN_PROPERTY_VARIABLE = 'BOOLEAN_PROPERTY_VARIABLE';
    ...
    {
        return [
            self::OPERATOR_BOOLEAN_PROPERTY_VARIABLE,
        ];
    }
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'BOOLEAN_PROPERTY_VARIABLE';
