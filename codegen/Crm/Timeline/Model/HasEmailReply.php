...
/**
 * HasEmailReply Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class HasEmailReply implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HasEmailReply';
    ...
    const OPERATOR_HAS_EMAIL_REPLY = 'HAS_EMAIL_REPLY';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'HAS_EMAIL_REPLY';
