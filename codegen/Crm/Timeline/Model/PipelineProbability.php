...
/**
 * PipelineProbability Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PipelineProbability implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PipelineProbability';
    ...
    const OPERATOR_PIPELINE_PROBABILITY = 'PIPELINE_PROBABILITY';
    ...
    {
        return [
            self::OPERATOR_PIPELINE_PROBABILITY,
        ];
    }
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'PIPELINE_PROBABILITY';
