...
/**
 * StringEquals Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class StringEquals implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StringEquals';
    ...
    const OPERATOR_STRING_EQUALS = 'STRING_EQUALS';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'STRING_EQUALS';
