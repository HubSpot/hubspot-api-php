...
/**
 * HasPlainTextEmailReply Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class HasPlainTextEmailReply implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HasPlainTextEmailReply';
    ...
    const OPERATOR_HAS_PLAIN_TEXT_EMAIL_REPLY = 'HAS_PLAIN_TEXT_EMAIL_REPLY';
    ...
    {
        return [
            self::OPERATOR_HAS_PLAIN_TEXT_EMAIL_REPLY,
        ];
    }
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'HAS_PLAIN_TEXT_EMAIL_REPLY';
