 ...
 * @link     https://openapi-generator.tech
 */
class IfBoolean implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IfBoolean';
    ...
    protected static $openAPITypes = [
        ...
        'else_expression' => '',
    ...
    protected static $setters = [
        ...
        'value' => 'setValue',
        'inputs' => 'setInputs',
        'if_expression' => 'setIfExpression',
        'else_expression' => 'setElseExpression',
    ...
    protected static $getters = [
        ...
        'value' => 'getValue',
        'inputs' => 'getInputs',
        'if_expression' => 'getIfExpression',
        'else_expression' => 'getElseExpression',
    ...
    const OPERATOR_IF_BOOLEAN = 'IF_BOOLEAN';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'IF_BOOLEAN';
        $this->container['value'] = isset($data['value']) ? $data['value'] : null;
        $this->container['inputs'] = isset($data['inputs']) ? $data['inputs'] : null;
        $this->container['if_expression'] = isset($data['if_expression']) ? $data['if_expression'] : null;
        $this->container['else_expression'] = isset($data['else_expression']) ? $data['else_expression'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['if_expression'] === null) {
            $invalidProperties[] = "'if_expression' can't be null";
        }
     ...
     * Gets if_expression
     *
     * @return 
     */
    public function getIfExpression()
    {
        return $this->container['if_expression'];
    }

    /**
     * Sets if_expression
     *
     * @param  $if_expression if_expression
     *
     * @return $this
     */
    public function setIfExpression($if_expression)
    {
        $this->container['if_expression'] = $if_expression;

        return $this;
    }

    /**
     * Gets else_expression
     *
     * @return |null
     */
    public function getElseExpression()
    {
        return $this->container['else_expression'];
    }

    /**
     * Sets else_expression
     *
     * @param |null $else_expression else_expression
     *
     * @return $this
     */
    public function setElseExpression($else_expression)
    {
        $this->container['else_expression'] = $else_expression;
