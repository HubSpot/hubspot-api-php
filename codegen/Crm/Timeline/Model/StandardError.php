...
class StandardError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets context
     *
     * @param array<string,string[]> $context The context of the error, potentially including occurrence information.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param \HubSpot\Client\Crm\Timeline\Model\ErrorDetail[] $errors The detailed error objects.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id The error ID, if any.
     *
     * @return self
     */
     ...
     * Sets links
     *
     * @param array<string,string> $links Links to any helpful documentation.
     *
     * @return self
     */
     ...
     * Sets sub_category
     *
     * @param object|null $sub_category Sub category of the error, if any.
     *
     * @return self
     */
