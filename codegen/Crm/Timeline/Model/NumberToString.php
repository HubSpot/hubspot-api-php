...
/**
 * NumberToString Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class NumberToString implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NumberToString';
    ...
    const OPERATOR_NUMBER_TO_STRING = 'NUMBER_TO_STRING';
    ...
    {
        return [
            self::OPERATOR_NUMBER_TO_STRING,
        ];
    }
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'NUMBER_TO_STRING';
