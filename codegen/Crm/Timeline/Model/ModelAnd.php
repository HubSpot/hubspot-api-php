 ...
 * @link     https://openapi-generator.tech
 */
class ModelAnd implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'And';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'AND';
