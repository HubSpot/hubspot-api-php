...
/**
 * MultiplyNumbers Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class MultiplyNumbers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MultiplyNumbers';
    ...
    const OPERATOR_MULTIPLY_NUMBERS = 'MULTIPLY_NUMBERS';
    ...
    {
        return [
            self::OPERATOR_MULTIPLY_NUMBERS,
        ];
    }
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'MULTIPLY_NUMBERS';
