...
/**
 * StringPropertyVariable Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class StringPropertyVariable implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StringPropertyVariable';
    ...
    const OPERATOR_STRING_PROPERTY_VARIABLE = 'STRING_PROPERTY_VARIABLE';
    ...
    {
        return [
            self::OPERATOR_STRING_PROPERTY_VARIABLE,
        ];
    }
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'STRING_PROPERTY_VARIABLE';
