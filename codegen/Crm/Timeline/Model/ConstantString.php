...
/**
 * ConstantString Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ConstantString implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConstantString';
    ...
    const OPERATOR_CONSTANT_STRING = 'CONSTANT_STRING';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'CONSTANT_STRING';
