...
/**
 * RoundDownNumbers Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RoundDownNumbers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RoundDownNumbers';
    ...
    const OPERATOR_ROUND_DOWN = 'ROUND_DOWN';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'ROUND_DOWN';
