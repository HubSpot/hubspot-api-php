 ...
 * @link     https://openapi-generator.tech
 */
class LessThan implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LessThan';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'LESS_THAN';
