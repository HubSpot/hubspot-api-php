 ...
 * @link     https://openapi-generator.tech
 */
class ParseNumber implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ParseNumber';
    ...
    const OPERATOR_PARSE_NUMBER = 'PARSE_NUMBER';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'PARSE_NUMBER';
