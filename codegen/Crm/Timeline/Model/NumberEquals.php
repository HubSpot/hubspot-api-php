...
/**
 * NumberEquals Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class NumberEquals implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NumberEquals';
    ...
    const OPERATOR_NUMBER_EQUALS = 'NUMBER_EQUALS';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'NUMBER_EQUALS';
