...
/**
 * RoundUpNumbers Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RoundUpNumbers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RoundUpNumbers';
    ...
    const OPERATOR_ROUND_UP = 'ROUND_UP';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'ROUND_UP';
