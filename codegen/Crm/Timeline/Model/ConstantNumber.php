...
/**
 * ConstantNumber Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ConstantNumber implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConstantNumber';
    ...
    const OPERATOR_CONSTANT_NUMBER = 'CONSTANT_NUMBER';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'CONSTANT_NUMBER';
