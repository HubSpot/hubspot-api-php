...
/**
 * DivideNumbers Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class DivideNumbers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DivideNumbers';
    ...
    const OPERATOR_DIVIDE_NUMBERS = 'DIVIDE_NUMBERS';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'DIVIDE_NUMBERS';
