...
/**
 * ExtractMostRecentEmailReplyText Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ExtractMostRecentEmailReplyText implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExtractMostRecentEmailReplyText';
    ...
    const OPERATOR_EXTRACT_MOST_RECENT_EMAIL_REPLY_TEXT = 'EXTRACT_MOST_RECENT_EMAIL_REPLY_TEXT';
    ...
    {
        return [
            self::OPERATOR_EXTRACT_MOST_RECENT_EMAIL_REPLY_TEXT,
        ];
    }
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'EXTRACT_MOST_RECENT_EMAIL_REPLY_TEXT';
