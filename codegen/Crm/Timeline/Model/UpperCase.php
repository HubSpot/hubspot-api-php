 ...
 * @link     https://openapi-generator.tech
 */
class UpperCase implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpperCase';
    ...
    const OPERATOR_UPPER_CASE = 'UPPER_CASE';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'UPPER_CASE';
