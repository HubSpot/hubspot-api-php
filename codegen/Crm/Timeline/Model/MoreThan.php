 ...
 * @link     https://openapi-generator.tech
 */
class MoreThan implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MoreThan';
    ...
    const OPERATOR_MORE_THAN = 'MORE_THAN';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'MORE_THAN';
