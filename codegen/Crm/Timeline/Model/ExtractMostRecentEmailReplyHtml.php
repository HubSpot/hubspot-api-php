...
/**
 * ExtractMostRecentEmailReplyHtml Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ExtractMostRecentEmailReplyHtml implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExtractMostRecentEmailReplyHtml';
    ...
    const OPERATOR_EXTRACT_MOST_RECENT_EMAIL_REPLY_HTML = 'EXTRACT_MOST_RECENT_EMAIL_REPLY_HTML';
    ...
    {
        return [
            self::OPERATOR_EXTRACT_MOST_RECENT_EMAIL_REPLY_HTML,
        ];
    }
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'EXTRACT_MOST_RECENT_EMAIL_REPLY_HTML';
