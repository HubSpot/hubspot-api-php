...
/**
 * ConstantBoolean Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ConstantBoolean implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConstantBoolean';
    ...
    const OPERATOR_CONSTANT_BOOLEAN = 'CONSTANT_BOOLEAN';
    ...
    {
        return [
            self::OPERATOR_CONSTANT_BOOLEAN,
        ];
    }
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'CONSTANT_BOOLEAN';
