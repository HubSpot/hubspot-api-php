 ...
 * @link     https://openapi-generator.tech
 */
class Not implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Not';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'NOT';
