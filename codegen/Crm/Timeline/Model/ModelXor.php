 ...
 * @link     https://openapi-generator.tech
 */
class ModelXor implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Xor';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'XOR';
