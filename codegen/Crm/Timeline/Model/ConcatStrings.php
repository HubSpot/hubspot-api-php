...
/**
 * ConcatStrings Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ConcatStrings implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConcatStrings';
    ...
    const OPERATOR_CONCAT_STRINGS = 'CONCAT_STRINGS';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'CONCAT_STRINGS';
