 ...
 * @link     https://openapi-generator.tech
 */
class IfString implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IfString';
    ...
    const OPERATOR_IF_STRING = 'IF_STRING';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'IF_STRING';
