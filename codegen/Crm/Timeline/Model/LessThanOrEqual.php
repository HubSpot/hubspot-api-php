...
/**
 * LessThanOrEqual Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class LessThanOrEqual implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LessThanOrEqual';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'LESS_THAN_OR_EQUAL';
