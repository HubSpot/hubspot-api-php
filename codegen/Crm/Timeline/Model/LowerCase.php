 ...
 * @link     https://openapi-generator.tech
 */
class LowerCase implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LowerCase';
    ...
    const OPERATOR_LOWER_CASE = 'LOWER_CASE';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'LOWER_CASE';
