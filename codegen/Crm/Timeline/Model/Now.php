 ...
 * @link     https://openapi-generator.tech
 */
class Now implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Now';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'NOW';
