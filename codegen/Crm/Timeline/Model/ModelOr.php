 ...
 * @link     https://openapi-generator.tech
 */
class ModelOr implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Or';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'OR';
