 ...
 * @link     https://openapi-generator.tech
 */
class IfNumber implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IfNumber';
    ...
    const OPERATOR_IF_NUMBER = 'IF_NUMBER';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'IF_NUMBER';
