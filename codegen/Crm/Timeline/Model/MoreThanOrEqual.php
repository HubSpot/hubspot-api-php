...
/**
 * MoreThanOrEqual Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class MoreThanOrEqual implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MoreThanOrEqual';
    ...
    const OPERATOR_MORE_THAN_OR_EQUAL = 'MORE_THAN_OR_EQUAL';
    ...
    {
        return [
            self::OPERATOR_MORE_THAN_OR_EQUAL,
        ];
    }
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'MORE_THAN_OR_EQUAL';
