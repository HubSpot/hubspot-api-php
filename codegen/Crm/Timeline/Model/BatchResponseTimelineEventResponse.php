...
class BatchResponseTimelineEventResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets num_errors
     *
     * @param int|null $num_errors The number of events that weren't created because of an error.
     *
     * @return $this
     */
     ...
     * Sets errors
     *
     * @param \HubSpot\Client\Crm\Timeline\Model\Error[]|null $errors The events that weren't created.
     *
     * @return $this
     */
