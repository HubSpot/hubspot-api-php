 ...
 */
class BatchResponseTimelineEventResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets links
     *
     * @param array<string,string>|null $links Any links to documentation.
     *
     * @return self
     */
