 ...
 * @link     https://openapi-generator.tech
 */
class TimeBetween implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TimeBetween';
    ...
    const OPERATOR_TIME_BETWEEN = 'TIME_BETWEEN';
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'TIME_BETWEEN';
