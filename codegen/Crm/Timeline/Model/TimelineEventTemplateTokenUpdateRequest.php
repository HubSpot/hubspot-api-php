...
class TimelineEventTemplateTokenUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('object_property_name', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($object_property_name)) {
            throw new \InvalidArgumentException('non-nullable object_property_name cannot be null');
        }
