...
/**
 * PeriodToMonths Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Timeline
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PeriodToMonths implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PeriodToMonths';
    ...
    const OPERATOR_PERIOD_TO_MONTHS = 'PERIOD_TO_MONTHS';
    ...
    {
        return [
            self::OPERATOR_PERIOD_TO_MONTHS,
        ];
    }
    ...
    {
        $this->container['operator'] = isset($data['operator']) ? $data['operator'] : 'PERIOD_TO_MONTHS';
