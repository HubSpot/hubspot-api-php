...
class SimplePublicObjectInputForCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets associations
     *
     * @param \HubSpot\Client\Crm\Commerce\Invoices\Model\PublicAssociationsForObject[]|null $associations An array that specifies the relationships between the new public object and existing objects. This is required to establish how the new object is connected within the system.
     *
     * @return self
     */
