...
class SearchApi
{
    ...
    public function doSearchWithHttpInfo($public_object_search_request, string $contentType = self::contentTypes['doSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Commerce\Invoices\Model\CollectionResponseWithTotalSimplePublicObject' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Commerce\Invoices\Model\CollectionResponseWithTotalSimplePublicObject' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Commerce\Invoices\Model\CollectionResponseWithTotalSimplePublicObject', []),
    ...
    public function doSearchRequest($public_object_search_request, string $contentType = self::contentTypes['doSearch'][0])
    {
        ...
        $resourcePath = '/crm/v3/objects/invoices/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
