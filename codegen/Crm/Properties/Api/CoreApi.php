...
class CoreApi
{
     ...
     */
    public function getAll($object_type, $archived = false, $properties = null, string $contentType = self::contentTypes['getAll'][0])
    {
        list($response) = $this->getAllWithHttpInfo($object_type, $archived, $properties, $contentType);
        return $response;
    }
     ...
     */
    public function getAllWithHttpInfo($object_type, $archived = false, $properties = null, string $contentType = self::contentTypes['getAll'][0])
    {
        $request = $this->getAllRequest($object_type, $archived, $properties, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllAsync($object_type, $archived = false, $properties = null, string $contentType = self::contentTypes['getAll'][0])
    {
        return $this->getAllAsyncWithHttpInfo($object_type, $archived, $properties, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllAsyncWithHttpInfo($object_type, $archived = false, $properties = null, string $contentType = self::contentTypes['getAll'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Properties\Model\CollectionResponsePropertyNoPaging';
        $request = $this->getAllRequest($object_type, $archived, $properties, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllRequest($object_type, $archived = false, $properties = null, string $contentType = self::contentTypes['getAll'][0])
    {
     ...
     * @return \HubSpot\Client\Crm\Properties\Model\Property|\HubSpot\Client\Crm\Properties\Model\Error
     */
    public function getByName($object_type, $property_name, $archived = false, $properties = null, string $contentType = self::contentTypes['getByName'][0])
    {
        list($response) = $this->getByNameWithHttpInfo($object_type, $property_name, $archived, $properties, $contentType);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Properties\Model\Property|\HubSpot\Client\Crm\Properties\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getByNameWithHttpInfo($object_type, $property_name, $archived = false, $properties = null, string $contentType = self::contentTypes['getByName'][0])
    {
        $request = $this->getByNameRequest($object_type, $property_name, $archived, $properties, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByNameAsync($object_type, $property_name, $archived = false, $properties = null, string $contentType = self::contentTypes['getByName'][0])
    {
        return $this->getByNameAsyncWithHttpInfo($object_type, $property_name, $archived, $properties, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByNameAsyncWithHttpInfo($object_type, $property_name, $archived = false, $properties = null, string $contentType = self::contentTypes['getByName'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Properties\Model\Property';
        $request = $this->getByNameRequest($object_type, $property_name, $archived, $properties, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getByNameRequest($object_type, $property_name, $archived = false, $properties = null, string $contentType = self::contentTypes['getByName'][0])
    {
