...
class BatchApi
{
    ...
    public function archiveRequest($object_type, $batch_input_property_name, string $contentType = self::contentTypes['archive'][0])
    {
        ...
        if (isset($batch_input_property_name)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($batch_input_property_name), JSON_THROW_ON_ERROR);
            } else {
    ...
    public function createRequest($object_type, $batch_input_property_create, string $contentType = self::contentTypes['create'][0])
    {
        ...
        if (isset($batch_input_property_create)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($batch_input_property_create), JSON_THROW_ON_ERROR);
            } else {
    ...
    {
        list($response) = $this->readWithHttpInfo($object_type, $batch_read_input_property_name, $locale, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->readRequest($object_type, $batch_read_input_property_name, $locale, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function readAsync($object_type, $batch_read_input_property_name, $locale = null, string $contentType = self::contentTypes['read'][0])
    {
        return $this->readAsyncWithHttpInfo($object_type, $batch_read_input_property_name, $locale, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function readAsyncWithHttpInfo($object_type, $batch_read_input_property_name, $locale = null, string $contentType = self::contentTypes['read'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Properties\Model\BatchResponseProperty';
        $request = $this->readRequest($object_type, $batch_read_input_property_name, $locale, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function readRequest($object_type, $batch_read_input_property_name, $locale = null, string $contentType = self::contentTypes['read'][0])
    {
        ...
        if (isset($batch_read_input_property_name)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($batch_read_input_property_name), JSON_THROW_ON_ERROR);
            } else {
