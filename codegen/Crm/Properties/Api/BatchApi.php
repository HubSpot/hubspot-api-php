...
class BatchApi
{
     ...
     * @return void
     */
    public function archive($object_type, $batch_input_property_name, string $contentType = self::contentTypes['archive'][0])
    {
        $this->archiveWithHttpInfo($object_type, $batch_input_property_name, $contentType);
    }
     ...
     */
    public function archiveWithHttpInfo($object_type, $batch_input_property_name, string $contentType = self::contentTypes['archive'][0])
    {
        $request = $this->archiveRequest($object_type, $batch_input_property_name, $contentType);
     ...
     */
    public function archiveAsync($object_type, $batch_input_property_name, string $contentType = self::contentTypes['archive'][0])
    {
        return $this->archiveAsyncWithHttpInfo($object_type, $batch_input_property_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function archiveAsyncWithHttpInfo($object_type, $batch_input_property_name, string $contentType = self::contentTypes['archive'][0])
    {
        $returnType = '';
        $request = $this->archiveRequest($object_type, $batch_input_property_name, $contentType);
     ...
     */
    public function archiveRequest($object_type, $batch_input_property_name, string $contentType = self::contentTypes['archive'][0])
    {
        ...
        if (isset($batch_input_property_name)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($batch_input_property_name));
            } else {
    ...
    {
        list($response) = $this->createWithHttpInfo($object_type, $batch_input_property_create, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->createRequest($object_type, $batch_input_property_create, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsync($object_type, $batch_input_property_create, string $contentType = self::contentTypes['create'][0])
    {
        return $this->createAsyncWithHttpInfo($object_type, $batch_input_property_create, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsyncWithHttpInfo($object_type, $batch_input_property_create, string $contentType = self::contentTypes['create'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Properties\Model\BatchResponseProperty';
        $request = $this->createRequest($object_type, $batch_input_property_create, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createRequest($object_type, $batch_input_property_create, string $contentType = self::contentTypes['create'][0])
    {
        ...
        if (isset($batch_input_property_create)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($batch_input_property_create));
            } else {
     ...
     * @return \HubSpot\Client\Crm\Properties\Model\BatchResponseProperty|\HubSpot\Client\Crm\Properties\Model\BatchResponsePropertyWithErrors|\HubSpot\Client\Crm\Properties\Model\Error
     */
    public function read($object_type, $batch_read_input_property_name, string $contentType = self::contentTypes['read'][0])
    {
        list($response) = $this->readWithHttpInfo($object_type, $batch_read_input_property_name, $contentType);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Properties\Model\BatchResponseProperty|\HubSpot\Client\Crm\Properties\Model\BatchResponsePropertyWithErrors|\HubSpot\Client\Crm\Properties\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function readWithHttpInfo($object_type, $batch_read_input_property_name, string $contentType = self::contentTypes['read'][0])
    {
        $request = $this->readRequest($object_type, $batch_read_input_property_name, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function readAsync($object_type, $batch_read_input_property_name, string $contentType = self::contentTypes['read'][0])
    {
        return $this->readAsyncWithHttpInfo($object_type, $batch_read_input_property_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function readAsyncWithHttpInfo($object_type, $batch_read_input_property_name, string $contentType = self::contentTypes['read'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Properties\Model\BatchResponseProperty';
        $request = $this->readRequest($object_type, $batch_read_input_property_name, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function readRequest($object_type, $batch_read_input_property_name, string $contentType = self::contentTypes['read'][0])
    {
        ...
        if (isset($batch_read_input_property_name)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($batch_read_input_property_name));
            } else {
