...
class BasicApi
{
     ...
     * Create
     *
     * @param  \HubSpot\Client\Crm\Products\Model\SimplePublicObjectInput $simple_public_object_input simple_public_object_input (optional)
     *
     * @throws \HubSpot\Client\Crm\Products\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Create
     *
     * @param  \HubSpot\Client\Crm\Products\Model\SimplePublicObjectInput $simple_public_object_input (optional)
     *
     * @throws \HubSpot\Client\Crm\Products\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \HubSpot\Client\Crm\Products\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Products\Model\CollectionResponseSimplePublicObject|\HubSpot\Client\Crm\Products\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Products\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Products\Model\CollectionResponseSimplePublicObject|\HubSpot\Client\Crm\Products\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPageWithHttpInfo($limit = 10, $after = null, $properties = null, $associations = null, $archived = false)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Products\Model\CollectionResponseSimplePublicObject' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Products\Model\CollectionResponseSimplePublicObject', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\HubSpot\Client\Crm\Products\Model\CollectionResponseSimplePublicObject';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\HubSpot\Client\Crm\Products\Model\CollectionResponseSimplePublicObject',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \HubSpot\Client\Crm\Products\Model\SimplePublicObject|\HubSpot\Client\Crm\Products\Model\Error
     */
    public function update($product_id, $simple_public_object_input = null)
    {
        list($response) = $this->updateWithHttpInfo($product_id, $simple_public_object_input);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Products\Model\SimplePublicObject|\HubSpot\Client\Crm\Products\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($product_id, $simple_public_object_input = null)
    {
        $request = $this->updateRequest($product_id, $simple_public_object_input);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($product_id, $simple_public_object_input = null)
    {
        return $this->updateAsyncWithHttpInfo($product_id, $simple_public_object_input)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($product_id, $simple_public_object_input = null)
    {
        $returnType = '\HubSpot\Client\Crm\Products\Model\SimplePublicObject';
        $request = $this->updateRequest($product_id, $simple_public_object_input);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateRequest($product_id, $simple_public_object_input = null)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null || (is_array($product_id) && count($product_id) === 0)) {
            throw new \InvalidArgumentException(
