...
class BasicApi
{
    ...
    {
        $this->archiveWithHttpInfo($product_id);
    }
     ...
     */
    public function archiveWithHttpInfo($product_id)
    {
        $request = $this->archiveRequest($product_id);
     ...
     */
    public function archiveAsync($product_id)
    {
        return $this->archiveAsyncWithHttpInfo($product_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function archiveAsyncWithHttpInfo($product_id)
    {
        $returnType = '';
        $request = $this->archiveRequest($product_id);
     ...
     */
    public function archiveRequest($product_id)
    {
     ...
     */
    public function getById($product_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        list($response) = $this->getByIdWithHttpInfo($product_id, $properties, $properties_with_history, $associations, $archived, $id_property);
        return $response;
    }
     ...
     */
    public function getByIdWithHttpInfo($product_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        $request = $this->getByIdRequest($product_id, $properties, $properties_with_history, $associations, $archived, $id_property);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($product_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        return $this->getByIdAsyncWithHttpInfo($product_id, $properties, $properties_with_history, $associations, $archived, $id_property)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($product_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        $returnType = '\HubSpot\Client\Crm\Products\Model\SimplePublicObjectWithAssociations';
        $request = $this->getByIdRequest($product_id, $properties, $properties_with_history, $associations, $archived, $id_property);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getByIdRequest($product_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null || (is_array($product_id) && count($product_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \HubSpot\Client\Crm\Products\Model\SimplePublicObject|\HubSpot\Client\Crm\Products\Model\Error
     */
    public function update($product_id, $simple_public_object_input, $id_property = null)
    {
        list($response) = $this->updateWithHttpInfo($product_id, $simple_public_object_input, $id_property);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Products\Model\SimplePublicObject|\HubSpot\Client\Crm\Products\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($product_id, $simple_public_object_input, $id_property = null)
    {
        $request = $this->updateRequest($product_id, $simple_public_object_input, $id_property);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($product_id, $simple_public_object_input, $id_property = null)
    {
        return $this->updateAsyncWithHttpInfo($product_id, $simple_public_object_input, $id_property)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($product_id, $simple_public_object_input, $id_property = null)
    {
        $returnType = '\HubSpot\Client\Crm\Products\Model\SimplePublicObject';
        $request = $this->updateRequest($product_id, $simple_public_object_input, $id_property);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRequest($product_id, $simple_public_object_input, $id_property = null)
    {
        // verify the required parameter 'product_id' is set
        if ($product_id === null || (is_array($product_id) && count($product_id) === 0)) {
            throw new \InvalidArgumentException(
