...
class GDPRApi
{
     ...
     * GDPR DELETE
     *
     * @param  \HubSpot\Client\Crm\Products\Model\PublicGdprDeleteInput $public_gdpr_delete_input public_gdpr_delete_input (required)
     *
     ...
     * GDPR DELETE
     *
     * @param  \HubSpot\Client\Crm\Products\Model\PublicGdprDeleteInput $public_gdpr_delete_input (required)
     *
     * @throws \HubSpot\Client\Crm\Products\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function purgeRequest($public_gdpr_delete_input)
    {
        ...
        $resourcePath = '/crm/v3/objects/products/gdpr-delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
