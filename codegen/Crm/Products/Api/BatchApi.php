...
class BatchApi
{
     ...
     * @throws \HubSpot\Client\Crm\Products\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Products\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Products\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Products\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Products\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Products\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \HubSpot\Client\Crm\Products\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Products\Model\BatchResponseSimplePublicUpsertObject|\HubSpot\Client\Crm\Products\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Products\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Products\Model\BatchResponseSimplePublicUpsertObject|\HubSpot\Client\Crm\Products\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
