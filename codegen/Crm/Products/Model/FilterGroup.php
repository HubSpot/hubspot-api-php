...
class FilterGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'filters' => '\HubSpot\Client\Crm\Products\Model\Filter[]'
    ];
    ...
    */
     ...
     * Gets filters
     *
     * @return \HubSpot\Client\Crm\Products\Model\Filter[]
     */
     ...
     * Sets filters
     *
     * @param \HubSpot\Client\Crm\Products\Model\Filter[] $filters A list of individual filter criteria that are applied together as a group. Each filter specifies a condition that records must meet to be included in the results.
     *
     * @return self
     */
