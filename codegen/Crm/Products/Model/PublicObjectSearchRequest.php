...
class PublicObjectSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'after' => 'string',
        'filter_groups' => '\HubSpot\Client\Crm\Products\Model\FilterGroup[]',
        'limit' => 'int',
        'properties' => 'string[]',
        'query' => 'string',
        'sorts' => 'string[]'
    ...
    */
     ...
     * Sets filter_groups
     *
     * @param \HubSpot\Client\Crm\Products\Model\FilterGroup[]|null $filter_groups Up to 6 groups of filters defining additional query criteria.
     *
     * @return self
     */
