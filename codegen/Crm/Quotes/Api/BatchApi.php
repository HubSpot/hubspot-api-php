...
class BatchApi
{
     ...
     * @throws \HubSpot\Client\Crm\Quotes\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Quotes\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Quotes\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\Quotes\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \HubSpot\Client\Crm\Quotes\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicUpsertObject|\HubSpot\Client\Crm\Quotes\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Quotes\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicUpsertObject|\HubSpot\Client\Crm\Quotes\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
