...
class BatchApi
{
     ...
     *
     * @param  \HubSpot\Client\Crm\Quotes\Model\BatchInputSimplePublicObjectId $batch_input_simple_public_object_id batch_input_simple_public_object_id (required)
     ...
     *
     * @throws \HubSpot\Client\Crm\Quotes\ApiException on non-2xx response or if the response body is not in the expected format
    ...
    public function archiveRequest($batch_input_simple_public_object_id, string $contentType = self::contentTypes['archive'][0])
    {
        ...
        $resourcePath = '/crm/v3/objects/quotes/batch/archive';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \HubSpot\Client\Crm\Quotes\Model\BatchInputSimplePublicObjectBatchInputForCreate $batch_input_simple_public_object_batch_input_for_create batch_input_simple_public_object_batch_input_for_create (required)
     ...
     * Create a batch of quotes
     *
     * @param  \HubSpot\Client\Crm\Quotes\Model\BatchInputSimplePublicObjectBatchInputForCreate $batch_input_simple_public_object_batch_input_for_create (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['create'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Crm\Quotes\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
            ...
            switch($statusCode) {
                case 201:
                    if ('\HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicObject' === '\SplFileObject') {
                        ...
                        if ('\HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicObject' !== 'string') {
                            try {
                ...
                case 207:
                    if ('\HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicObjectWithErrors' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicObjectWithErrors' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
    ...
    public function createRequest($batch_input_simple_public_object_batch_input_for_create, string $contentType = self::contentTypes['create'][0])
    {
        ...
        $resourcePath = '/crm/v3/objects/quotes/batch/create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \HubSpot\Client\Crm\Quotes\Model\BatchInputSimplePublicObjectBatchInput $batch_input_simple_public_object_batch_input batch_input_simple_public_object_batch_input (required)
    ...
    public function updateRequest($batch_input_simple_public_object_batch_input, string $contentType = self::contentTypes['update'][0])
    {
        ...
        $resourcePath = '/crm/v3/objects/quotes/batch/update';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \HubSpot\Client\Crm\Quotes\Model\BatchInputSimplePublicObjectBatchInputUpsert $batch_input_simple_public_object_batch_input_upsert batch_input_simple_public_object_batch_input_upsert (required)
     ...
     * @throws \HubSpot\Client\Crm\Quotes\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicUpsertObject|\HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicUpsertObjectWithErrors|\HubSpot\Client\Crm\Quotes\Model\Error
     */
     ...
     * Create or update a batch of quotes by unique property values
     *
     * @param  \HubSpot\Client\Crm\Quotes\Model\BatchInputSimplePublicObjectBatchInputUpsert $batch_input_simple_public_object_batch_input_upsert (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['upsert'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Crm\Quotes\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicUpsertObject|\HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicUpsertObjectWithErrors|\HubSpot\Client\Crm\Quotes\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function upsertWithHttpInfo($batch_input_simple_public_object_batch_input_upsert, string $contentType = self::contentTypes['upsert'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicUpsertObject' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicUpsertObject' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicUpsertObject', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 207:
                    if ('\HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicUpsertObjectWithErrors' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicUpsertObjectWithErrors' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicUpsertObjectWithErrors', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicUpsertObject';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                ...
                case 207:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\HubSpot\Client\Crm\Quotes\Model\BatchResponseSimplePublicUpsertObjectWithErrors',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function upsertRequest($batch_input_simple_public_object_batch_input_upsert, string $contentType = self::contentTypes['upsert'][0])
    {
        ...
        $resourcePath = '/crm/v3/objects/quotes/batch/upsert';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
