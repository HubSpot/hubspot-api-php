...
class AssociationsApi
{
     ...
     * @return void
     */
    public function archiveAssociation($quote_id, $associated_object_type, $to_object_id)
    {
        $this->archiveAssociationWithHttpInfo($quote_id, $associated_object_type, $to_object_id);
    }
     ...
     */
    public function archiveAssociationWithHttpInfo($quote_id, $associated_object_type, $to_object_id)
    {
        $request = $this->archiveAssociationRequest($quote_id, $associated_object_type, $to_object_id);
     ...
     */
    public function archiveAssociationAsync($quote_id, $associated_object_type, $to_object_id)
    {
        return $this->archiveAssociationAsyncWithHttpInfo($quote_id, $associated_object_type, $to_object_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function archiveAssociationAsyncWithHttpInfo($quote_id, $associated_object_type, $to_object_id)
    {
        $returnType = '';
        $request = $this->archiveAssociationRequest($quote_id, $associated_object_type, $to_object_id);
     ...
     */
    protected function archiveAssociationRequest($quote_id, $associated_object_type, $to_object_id)
    {
        ...
        $resourcePath = '/quotes/{quoteId}/associations/{associatedObjectType}/{toObjectId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function createAssociation($quote_id, $associated_object_type, $to_object_id)
    {
        list($response) = $this->createAssociationWithHttpInfo($quote_id, $associated_object_type, $to_object_id);
        return $response;
    }
     ...
     */
    public function createAssociationWithHttpInfo($quote_id, $associated_object_type, $to_object_id)
    {
        $request = $this->createAssociationRequest($quote_id, $associated_object_type, $to_object_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAssociationAsync($quote_id, $associated_object_type, $to_object_id)
    {
        return $this->createAssociationAsyncWithHttpInfo($quote_id, $associated_object_type, $to_object_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAssociationAsyncWithHttpInfo($quote_id, $associated_object_type, $to_object_id)
    {
        $returnType = '\HubSpot\Client\Crm\Quotes\Model\SimplePublicObject';
        $request = $this->createAssociationRequest($quote_id, $associated_object_type, $to_object_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createAssociationRequest($quote_id, $associated_object_type, $to_object_id)
    {
        // verify the required parameter 'quote_id' is set
        if ($quote_id === null || (is_array($quote_id) && count($quote_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \HubSpot\Client\Crm\Quotes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Quotes\Model\CollectionResponseSimplePublicObjectId|\HubSpot\Client\Crm\Quotes\Model\Error
     */
    public function getAssociations($quote_id, $associated_object_type)
    {
        list($response) = $this->getAssociationsWithHttpInfo($quote_id, $associated_object_type);
        return $response;
    }
     ...
     * @throws \HubSpot\Client\Crm\Quotes\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Quotes\Model\CollectionResponseSimplePublicObjectId|\HubSpot\Client\Crm\Quotes\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAssociationsWithHttpInfo($quote_id, $associated_object_type)
    {
        $request = $this->getAssociationsRequest($quote_id, $associated_object_type);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Quotes\Model\CollectionResponseSimplePublicObjectId' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Crm\Quotes\Model\CollectionResponseSimplePublicObjectId', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\HubSpot\Client\Crm\Quotes\Model\CollectionResponseSimplePublicObjectId';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\HubSpot\Client\Crm\Quotes\Model\CollectionResponseSimplePublicObjectId',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAssociationsAsync($quote_id, $associated_object_type)
    {
        return $this->getAssociationsAsyncWithHttpInfo($quote_id, $associated_object_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAssociationsAsyncWithHttpInfo($quote_id, $associated_object_type)
    {
        $returnType = '\HubSpot\Client\Crm\Quotes\Model\CollectionResponseSimplePublicObjectId';
        $request = $this->getAssociationsRequest($quote_id, $associated_object_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAssociationsRequest($quote_id, $associated_object_type)
    {
        // verify the required parameter 'quote_id' is set
        if ($quote_id === null || (is_array($quote_id) && count($quote_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/quotes/{quoteId}/associations/{associatedObjectType}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
