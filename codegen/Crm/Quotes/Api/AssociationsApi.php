...
class AssociationsApi
{
     ...
     */
    public function archiveRequest($quote_id, $to_object_type, $to_object_id, $association_type)
    {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Crm\Quotes\Model\CollectionResponseAssociatedIdForwardPaging' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Crm\Quotes\Model\CollectionResponseAssociatedIdForwardPaging' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
