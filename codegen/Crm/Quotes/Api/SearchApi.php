...
class SearchApi
{
     ...
     * @return \HubSpot\Client\Crm\Quotes\Model\CollectionResponseWithTotalSimplePublicObject|\HubSpot\Client\Crm\Quotes\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Quotes\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Quotes\Model\CollectionResponseWithTotalSimplePublicObject|\HubSpot\Client\Crm\Quotes\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\HubSpot\Client\Crm\Quotes\Model\CollectionResponseWithTotalSimplePublicObject',
                        $request,
                        $response,
                    );
                default:
    ...
    {
        $returnType = '\HubSpot\Client\Crm\Quotes\Model\CollectionResponseWithTotalSimplePublicObject';
        $request = $this->doSearchRequest($public_object_search_request, $contentType);
    ...
    public function doSearchRequest($public_object_search_request, string $contentType = self::contentTypes['doSearch'][0])
    {
        ...
        $resourcePath = '/crm/v3/objects/quotes/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
