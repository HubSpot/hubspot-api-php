...
class BasicApi
{
     ...
     * @return \HubSpot\Client\Crm\Quotes\Model\SimplePublicObject|\HubSpot\Client\Crm\Quotes\Model\Error
     */
    public function getById($quote_id, $properties = null, $associations = null, $archived = false)
    {
        list($response) = $this->getByIdWithHttpInfo($quote_id, $properties, $associations, $archived);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Quotes\Model\SimplePublicObject|\HubSpot\Client\Crm\Quotes\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getByIdWithHttpInfo($quote_id, $properties = null, $associations = null, $archived = false)
    {
        $request = $this->getByIdRequest($quote_id, $properties, $associations, $archived);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($quote_id, $properties = null, $associations = null, $archived = false)
    {
        return $this->getByIdAsyncWithHttpInfo($quote_id, $properties, $associations, $archived)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($quote_id, $properties = null, $associations = null, $archived = false)
    {
        $returnType = '\HubSpot\Client\Crm\Quotes\Model\SimplePublicObject';
        $request = $this->getByIdRequest($quote_id, $properties, $associations, $archived);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getByIdRequest($quote_id, $properties = null, $associations = null, $archived = false)
    {
        // verify the required parameter 'quote_id' is set
        if ($quote_id === null || (is_array($quote_id) && count($quote_id) === 0)) {
            throw new \InvalidArgumentException(
