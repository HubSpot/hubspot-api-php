...
class BasicApi
{
     ...
     * @return void
     */
    public function archive($quote_id, string $contentType = self::contentTypes['archive'][0])
    {
        $this->archiveWithHttpInfo($quote_id, $contentType);
    }
     ...
     */
    public function archiveWithHttpInfo($quote_id, string $contentType = self::contentTypes['archive'][0])
    {
        $request = $this->archiveRequest($quote_id, $contentType);
     ...
     */
    public function archiveAsync($quote_id, string $contentType = self::contentTypes['archive'][0])
    {
        return $this->archiveAsyncWithHttpInfo($quote_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function archiveAsyncWithHttpInfo($quote_id, string $contentType = self::contentTypes['archive'][0])
    {
        $returnType = '';
        $request = $this->archiveRequest($quote_id, $contentType);
     ...
     */
    public function archiveRequest($quote_id, string $contentType = self::contentTypes['archive'][0])
    {
        ...
        if (!preg_match("/.+/", $quote_id)) {
            throw new \InvalidArgumentException("invalid value for \"quote_id\" when calling BasicApi.archive, must conform to the pattern /.+/.");
        }
     ...
     */
    public function getById($quote_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null, string $contentType = self::contentTypes['getById'][0])
    {
        list($response) = $this->getByIdWithHttpInfo($quote_id, $properties, $properties_with_history, $associations, $archived, $id_property, $contentType);
        return $response;
    }
     ...
     */
    public function getByIdWithHttpInfo($quote_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null, string $contentType = self::contentTypes['getById'][0])
    {
        $request = $this->getByIdRequest($quote_id, $properties, $properties_with_history, $associations, $archived, $id_property, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($quote_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null, string $contentType = self::contentTypes['getById'][0])
    {
        return $this->getByIdAsyncWithHttpInfo($quote_id, $properties, $properties_with_history, $associations, $archived, $id_property, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($quote_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null, string $contentType = self::contentTypes['getById'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getByIdRequest($quote_id, $properties = null, $properties_with_history = null, $associations = null, $archived = false, $id_property = null, string $contentType = self::contentTypes['getById'][0])
    {
        ...
        if (!preg_match("/.+/", $quote_id)) {
            throw new \InvalidArgumentException("invalid value for \"quote_id\" when calling BasicApi.getById, must conform to the pattern /.+/.");
        }
     ...
     * @param  string[]|null $properties A comma separated list of the properties to be returned in the response. If any of the specified properties are not present on the requested object(s), they will be ignored. (optional)
     * @param  string[]|null $properties_with_history A comma separated list of the properties to be returned along with their history of previous values. If any of the specified properties are not present on the requested object(s), they will be ignored. Usage of this parameter will reduce the maximum number of quotes that can be read by a single request. (optional)
     * @param  string[]|null $associations A comma separated list of object types to retrieve associated IDs for. If any of the specified associations do not exist, they will be ignored. (optional)
     * @param  bool|null $archived Whether to return only results that have been archived. (optional, default to false)
     ...
     * @throws \HubSpot\Client\Crm\Quotes\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\Quotes\Model\CollectionResponseSimplePublicObjectWithAssociations|\HubSpot\Client\Crm\Quotes\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\Quotes\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\Quotes\Model\CollectionResponseSimplePublicObjectWithAssociations|\HubSpot\Client\Crm\Quotes\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPageWithHttpInfo($limit = 10, $after = null, $properties = null, $properties_with_history = null, $associations = null, $archived = false, string $contentType = self::contentTypes['getPage'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\HubSpot\Client\Crm\Quotes\Model\CollectionResponseSimplePublicObjectWithAssociations',
                        $request,
                        $response,
                    );
                default:
    ...
    {
        $returnType = '\HubSpot\Client\Crm\Quotes\Model\CollectionResponseSimplePublicObjectWithAssociations';
        $request = $this->getPageRequest($limit, $after, $properties, $properties_with_history, $associations, $archived, $contentType);
     ...
     * @return \HubSpot\Client\Crm\Quotes\Model\SimplePublicObject|\HubSpot\Client\Crm\Quotes\Model\Error
     */
    public function update($quote_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
        list($response) = $this->updateWithHttpInfo($quote_id, $simple_public_object_input, $id_property, $contentType);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Quotes\Model\SimplePublicObject|\HubSpot\Client\Crm\Quotes\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($quote_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
        $request = $this->updateRequest($quote_id, $simple_public_object_input, $id_property, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($quote_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
        return $this->updateAsyncWithHttpInfo($quote_id, $simple_public_object_input, $id_property, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($quote_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Quotes\Model\SimplePublicObject';
        $request = $this->updateRequest($quote_id, $simple_public_object_input, $id_property, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRequest($quote_id, $simple_public_object_input, $id_property = null, string $contentType = self::contentTypes['update'][0])
    {
        ...
        if (!preg_match("/.+/", $quote_id)) {
            throw new \InvalidArgumentException("invalid value for \"quote_id\" when calling BasicApi.update, must conform to the pattern /.+/.");
        }
