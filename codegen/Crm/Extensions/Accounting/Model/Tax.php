...
class Tax implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets code
     *
     * @param string $code The code/ID of the tax in the external accounting system.
     *
     * @return self
     */
     ...
     * Sets percentage
     *
     * @param float $percentage The tax percentage.  For example, 8.05 represents a 8.05% tax rate.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The display name of the tax.
     *
     * @return self
     */
