...
/**
 * ImportInvoiceFeature Class Doc Comment
 *
 * @category Class
 ...
 */
class ImportInvoiceFeature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImportInvoiceFeature';
     ...
     * Sets enabled
     *
     * @param bool $enabled Indicates if importing invoices from the external account system into HubSpot.
     *
     * @return self
     */
