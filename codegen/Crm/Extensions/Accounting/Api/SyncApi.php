...
class SyncApi
{
     ...
     */
    protected function createContactRequest($app_id, $sync_contacts_request)
    {
        ...
        if (isset($sync_contacts_request)) {
            $_tempBody = $sync_contacts_request;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createProductRequest($app_id, $sync_products_request)
    {
        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($sync_products_request)) {
            $_tempBody = $sync_products_request;
        }
