...
class RecordingSettingsApi
{
     ...
     */
    public function create($app_id, $recording_settings_request, string $contentType = self::contentTypes['create'][0])
    {
        list($response) = $this->createWithHttpInfo($app_id, $recording_settings_request, $contentType);
        return $response;
    }
     ...
     */
    public function createWithHttpInfo($app_id, $recording_settings_request, string $contentType = self::contentTypes['create'][0])
    {
        $request = $this->createRequest($app_id, $recording_settings_request, $contentType);
     ...
     */
    public function createAsync($app_id, $recording_settings_request, string $contentType = self::contentTypes['create'][0])
    {
        return $this->createAsyncWithHttpInfo($app_id, $recording_settings_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsyncWithHttpInfo($app_id, $recording_settings_request, string $contentType = self::contentTypes['create'][0])
    {
     ...
     */
    public function createRequest($app_id, $recording_settings_request, string $contentType = self::contentTypes['create'][0])
    {
        ...
        if ($recording_settings_request === null || (is_array($recording_settings_request) && count($recording_settings_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $recording_settings_request when calling create'
            );
        }
     ...
     * @return \HubSpot\Client\Crm\Extensions\Calling\Model\RecordingSettingsResponse|\HubSpot\Client\Crm\Extensions\Calling\Model\Error
     */
    public function update($app_id, $recording_settings_patch_request, string $contentType = self::contentTypes['update'][0])
    {
        list($response) = $this->updateWithHttpInfo($app_id, $recording_settings_patch_request, $contentType);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Extensions\Calling\Model\RecordingSettingsResponse|\HubSpot\Client\Crm\Extensions\Calling\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($app_id, $recording_settings_patch_request, string $contentType = self::contentTypes['update'][0])
    {
        $request = $this->updateRequest($app_id, $recording_settings_patch_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($app_id, $recording_settings_patch_request, string $contentType = self::contentTypes['update'][0])
    {
        return $this->updateAsyncWithHttpInfo($app_id, $recording_settings_patch_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($app_id, $recording_settings_patch_request, string $contentType = self::contentTypes['update'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Extensions\Calling\Model\RecordingSettingsResponse';
        $request = $this->updateRequest($app_id, $recording_settings_patch_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRequest($app_id, $recording_settings_patch_request, string $contentType = self::contentTypes['update'][0])
    {
        ...
        if ($recording_settings_patch_request === null || (is_array($recording_settings_patch_request) && count($recording_settings_patch_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $recording_settings_patch_request when calling update'
            );
        }
