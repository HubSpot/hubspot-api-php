...
class AdvancedApi
{
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\HubSpot\Client\Crm\Extensions\Calling\Model\CompletedThirdPartyCallResponse',
                        $request,
                        $response,
                    );
                default:
    ...
    public function crmV3ExtensionsCallingInboundCallRequest($completed_third_party_call_request, string $contentType = self::contentTypes['crmV3ExtensionsCallingInboundCall'][0])
    {
        ...
        $resourcePath = '/crm/v3/extensions/calling/inbound-call';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (isset($completed_third_party_call_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($completed_third_party_call_request));
            } else {
