...
class SettingsPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets uses_remote
     *
     * @param bool|null $uses_remote When false, this indicates that your calling app does not use the anchored calling remote within the HubSpot app.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $uses_calling_window When false, this indicates that your calling app does not require the use of the separate calling window to hold the call connection.
     *
     * @return self
     */
