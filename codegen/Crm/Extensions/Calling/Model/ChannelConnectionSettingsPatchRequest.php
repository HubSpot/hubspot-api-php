...
/**
 * ChannelConnectionSettingsPatchRequest Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Extensions\Calling
 * @author   OpenAPI Generator team
 ...
 */
class ChannelConnectionSettingsPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelConnectionSettingsPatchRequest';
    ...
    */
     ...
     * Sets is_ready
     *
     * @param bool|null $is_ready If true, this app will be considered to support channel connection
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The URL to fetch phone numbers available for channel connection
     *
     * @return self
     */
