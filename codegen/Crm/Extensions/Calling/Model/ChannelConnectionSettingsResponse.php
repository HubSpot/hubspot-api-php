...
class ChannelConnectionSettingsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The date and time when the channel connection settings were created.
     *
     * @return self
     */
     ...
     * Sets is_ready
     *
     * @param bool $is_ready Indicates whether the channel connection settings are ready for use.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at The date and time when the channel connection settings were last updated.
     *
     * @return self
     */
