...
class SettingsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets is_ready
     *
     * @param bool $is_ready Indicates if the calling extension is ready for use.
     *
     * @return self
     */
     ...
     *
     * @param bool $uses_calling_window Indicates if the calling extension uses a separate calling window.
     *
     * @return self
     */
     ...
     * Sets uses_remote
     *
     * @param bool $uses_remote Indicates if the calling extension uses remote services.
     *
     * @return self
     */
