...
class SettingsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The date and time when the calling extension settings were created.
     *
     * @return self
     */
     ...
     * Sets height
     *
     * @param int $height The height of the calling extension interface.
     *
     * @return self
     */
     ...
     * Sets is_ready
     *
     * @param bool $is_ready Specifies whether the calling extension settings are ready for use.
     *
     * @return self
     */
     ...
     *
     * @param bool $supports_custom_objects Indicates if the calling extension supports custom objects.
     *
     * @return self
     */
     ...
     *
     * @param bool $supports_inbound_calling Indicates if the calling extension supports inbound calling.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at The date and time when the calling extension settings were last updated.
     *
     * @return self
     */
     ...
     *
     * @param bool $uses_calling_window Specifies if the calling extension uses a dedicated calling window.
     *
     * @return self
     */
     ...
     * Sets uses_remote
     *
     * @param bool $uses_remote Indicates if the calling extension uses a remote service.
     *
     * @return self
     */
     ...
     * Sets width
     *
     * @param int $width The width of the calling extension interface.
     *
     * @return self
     */
