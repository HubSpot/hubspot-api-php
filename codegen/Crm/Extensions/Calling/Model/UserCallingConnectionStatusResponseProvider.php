<?php
/**
 * UserCallingConnectionStatusResponseProvider
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * UserCallingConnectionStatusResponseProvider Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Extensions\Calling
 * @author   OpenAPI Generator team
 ...
 */
class UserCallingConnectionStatusResponseProvider implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserCallingConnectionStatusResponse_provider';
    ...
    {
        $this->setIfExists('type', $data ?? [], 'HUBSPOT');
