...
/**
 * RecordingSettingsResponse Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Extensions\Calling
 * @author   OpenAPI Generator team
 ...
 */
class RecordingSettingsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecordingSettingsResponse';
    ...
    {
        $this->container['url_to_retrieve_authed_recording'] = $data['url_to_retrieve_authed_recording'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['url_to_retrieve_authed_recording'] === null) {
            $invalidProperties[] = "'url_to_retrieve_authed_recording' can't be null";
        }
     ...
     *
     * @param string $url_to_retrieve_authed_recording url_to_retrieve_authed_recording
     *
     * @return self
     */
