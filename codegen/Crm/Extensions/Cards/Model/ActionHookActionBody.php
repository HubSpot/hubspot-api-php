...
class ActionHookActionBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string[] $property_names_included A list of property names that will be included on the action. See the documentation for more information
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url The URL endpoint that will be called when the action is triggered.
     *
     * @return self
     */
