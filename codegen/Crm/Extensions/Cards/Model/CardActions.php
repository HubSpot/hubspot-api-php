 ...
 * @link     https://openapi-generator.tech
 */
class CardActions implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['base_urls'] = isset($data['base_urls']) ? $data['base_urls'] : null;
    }
     ...
     * Sets base_urls
     *
     * @param string[] $base_urls base_urls
     *
     * @return $this
     */
