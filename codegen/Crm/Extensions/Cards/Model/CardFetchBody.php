...
class CardFetchBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets card_type
     *
     * @param string|null $card_type A deprecated field to determine the type of card returned.
     *
     * @return self
     */
     ...
     *
     * @param string|null $serverless_function A deprecated field to specify serverless functionality with the card
     *
     * @return self
     */
