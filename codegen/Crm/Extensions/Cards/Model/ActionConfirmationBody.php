...
class ActionConfirmationBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $cancel_button_label The label for the button that cancels the action.
     *
     * @return self
     */
    public function setCancelButtonLabel($cancel_button_label)
    {
        if (is_null($cancel_button_label)) {
     ...
     *
     * @param string $confirm_button_label The label for the button that confirms the action.
     *
     * @return self
     */
    public function setConfirmButtonLabel($confirm_button_label)
    {
        if (is_null($confirm_button_label)) {
            throw new \InvalidArgumentException('non-nullable confirm_button_label cannot be null');
        }
     ...
     * Sets prompt
     *
     * @param string $prompt The message displayed to the user to confirm the action.
     *
     * @return self
     */
