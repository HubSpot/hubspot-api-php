...
class IntegratorObjectResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets actions
     *
     * @param \HubSpot\Client\Crm\Extensions\Cards\Model\IntegratorObjectResultActionsInner[] $actions A list of actions associated with the card, which can include action hooks, confirmation action hooks, or iframes.
     *
     * @return self
     */
     ...
     * Sets link_url
     *
     * @param string|null $link_url A URL used on the title of the card
     *
     * @return self
     */
     ...
     * Sets tokens
     *
     * @param \HubSpot\Client\Crm\Extensions\Cards\Model\ObjectToken[] $tokens A collection of tokens representing specific properties related to the card.
     *
     * @return self
     */
