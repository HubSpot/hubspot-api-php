...
class CardObjectTypeBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('properties_to_send', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($properties_to_send)) {
            throw new \InvalidArgumentException('non-nullable properties_to_send cannot be null');
        }
