...
class CardAuditResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets action_type
     *
     * @param string $action_type The type of action performed, with possible values: CREATE, DELETE, UPDATE.
     *
     * @return self
     */
     ...
     * Sets application_id
     *
     * @param int $application_id The ID of the application associated with the card.
     *
     * @return self
     */
     ...
     * Sets auth_source
     *
     * @param string $auth_source The source of authentication for the action, with possible values: APP, EXTERNAL, INTERNAL.
     *
     * @return self
     */
     ...
     * Sets changed_at
     *
     * @param int $changed_at The timestamp indicating when the change occurred.
     *
     * @return self
     */
     ...
     *
     * @param int $initiating_user_id The ID of the user who initiated the action.
     *
     * @return self
     */
     ...
     * Sets object_type_id
     *
     * @param int $object_type_id The ID of the card.
     *
     * @return self
     */
