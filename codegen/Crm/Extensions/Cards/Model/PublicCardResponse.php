...
class PublicCardResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets audit_history
     *
     * @param \HubSpot\Client\Crm\Extensions\Cards\Model\CardAuditResponse[] $audit_history A list of actions performed on the card, including creation, deletion, and updates.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at The date and time when the card was created.
     *
     * @return self
     */
    ...
    {
        if (is_null($fetch)) {
            throw new \InvalidArgumentException('non-nullable fetch cannot be null');
        }
     ...
     * Sets id
     *
     * @param string $id The unique id of the card.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime|null $updated_at The date and time when the card was last updated.
     *
     * @return self
     */
