...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.hubapi.com/crm/v3/extensions';
    ...
    {
        $report  = 'PHP SDK (HubSpot\Client\Crm\Extensions\Cards) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return array(
          array(
            "url" => "https://api.hubapi.com/crm/v3/extensions",
