...
class BasicApi
{
     ...
     * Create a new card
     *
     * @param  int $app_id The id of the app to contain the Legacy CRM Card (required)
     * @param  \HubSpot\Client\Crm\Extensions\Cards\Model\CardCreateRequest $card_create_request card_create_request (required)
     ...
     */
    public function create($app_id, $card_create_request, string $contentType = self::contentTypes['create'][0])
    {
        list($response) = $this->createWithHttpInfo($app_id, $card_create_request, $contentType);
        return $response;
    }
     ...
     *
     * @param  int $app_id The id of the app to contain the Legacy CRM Card (required)
     * @param  \HubSpot\Client\Crm\Extensions\Cards\Model\CardCreateRequest $card_create_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['create'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Crm\Extensions\Cards\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function createWithHttpInfo($app_id, $card_create_request, string $contentType = self::contentTypes['create'][0])
    {
        $request = $this->createRequest($app_id, $card_create_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsync($app_id, $card_create_request, string $contentType = self::contentTypes['create'][0])
    {
        return $this->createAsyncWithHttpInfo($app_id, $card_create_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsyncWithHttpInfo($app_id, $card_create_request, string $contentType = self::contentTypes['create'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createRequest($app_id, $card_create_request, string $contentType = self::contentTypes['create'][0])
    {
        ...
        if (isset($card_create_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($card_create_request), JSON_THROW_ON_ERROR);
            } else {
     ...
     * Get all cards
     *
     * @param  int $app_id The id of the app containing the Legacy CRM Card(s) (required)
     ...
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getCardsSampleResponse'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Crm\Extensions\Cards\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function getCardsSampleResponse(string $contentType = self::contentTypes['getCardsSampleResponse'][0])
    {
        list($response) = $this->getCardsSampleResponseWithHttpInfo($contentType);
        return $response;
    }
     ...
     */
    public function getCardsSampleResponseWithHttpInfo(string $contentType = self::contentTypes['getCardsSampleResponse'][0])
    {
        $request = $this->getCardsSampleResponseRequest($contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCardsSampleResponseAsync(string $contentType = self::contentTypes['getCardsSampleResponse'][0])
    {
        return $this->getCardsSampleResponseAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCardsSampleResponseAsyncWithHttpInfo(string $contentType = self::contentTypes['getCardsSampleResponse'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCardsSampleResponseRequest(string $contentType = self::contentTypes['getCardsSampleResponse'][0])
    {


        $resourcePath = '/crm/v3/extensions/cards-dev/sample-response';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function updateRequest($app_id, $card_id, $card_patch_request, string $contentType = self::contentTypes['update'][0])
    {
        ...
        if (isset($card_patch_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($card_patch_request), JSON_THROW_ON_ERROR);
            } else {
