...
class BasicApi
{
    ...
    public function createRequest($app_id, $card_create_request, string $contentType = self::contentTypes['create'][0])
    {
        ...
        if (isset($card_create_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($card_create_request));
            } else {
    ...
    public function updateRequest($app_id, $card_id, $card_patch_request, string $contentType = self::contentTypes['update'][0])
    {
        ...
        if (isset($card_patch_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($card_patch_request));
            } else {
