...
use HubSpot\Client\Crm\Extensions\Videoconferencing\FormDataProcessor;
...
class SettingsApi
{
     ...
     * Delete settings
     *
     * @param  int $app_id the [ID of your app](https://developers.hubspot.com/docs/apps/legacy-apps/public-apps/overview) (required)
     ...
     *
     * @throws \HubSpot\Client\Crm\Extensions\Videoconferencing\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     * @return \HubSpot\Client\Crm\Extensions\Videoconferencing\Model\ExternalSettings|\HubSpot\Client\Crm\Extensions\Videoconferencing\Model\Error
     */
    public function replace($app_id, $external_settings, string $contentType = self::contentTypes['replace'][0])
    {
        list($response) = $this->replaceWithHttpInfo($app_id, $external_settings, $contentType);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Extensions\Videoconferencing\Model\ExternalSettings|\HubSpot\Client\Crm\Extensions\Videoconferencing\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function replaceWithHttpInfo($app_id, $external_settings, string $contentType = self::contentTypes['replace'][0])
    {
        $request = $this->replaceRequest($app_id, $external_settings, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replaceAsync($app_id, $external_settings, string $contentType = self::contentTypes['replace'][0])
    {
        return $this->replaceAsyncWithHttpInfo($app_id, $external_settings, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replaceAsyncWithHttpInfo($app_id, $external_settings, string $contentType = self::contentTypes['replace'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Extensions\Videoconferencing\Model\ExternalSettings';
        $request = $this->replaceRequest($app_id, $external_settings, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function replaceRequest($app_id, $external_settings, string $contentType = self::contentTypes['replace'][0])
    {
        ...
        if (isset($external_settings)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($external_settings));
            } else {
