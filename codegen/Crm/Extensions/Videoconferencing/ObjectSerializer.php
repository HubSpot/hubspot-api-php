...
namespace HubSpot\Client\Crm\Extensions\Videoconferencing;

use HubSpot\Client\Crm\Extensions\Videoconferencing\Model\ModelInterface;
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\HubSpot\Client\Crm\Extensions\Videoconferencing\Model\\' . $data->{$discriminator};
