...
/**
 * ActionResponseWithSingleResultURI Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Exports
 * @author   OpenAPI Generator team
 ...
 */
class ActionResponseWithSingleResultURI implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActionResponseWithSingleResultURI';
    ...
    protected static $openAPITypes = [
        ...
        'errors' => '\HubSpot\Client\Crm\Exports\Model\StandardError[]',
    ...
    */
     ...
     * Sets completed_at
     *
     * @param \DateTime $completed_at The timestamp when the export was completed, in ISO 8601 format.
     *
     * @return self
     */
     ...
     * Gets errors
     *
     * @return \HubSpot\Client\Crm\Exports\Model\StandardError[]|null
     */
     ...
     * Sets errors
     *
     * @param \HubSpot\Client\Crm\Exports\Model\StandardError[]|null $errors errors
     *
     * @return self
     */
     ...
     * Sets links
     *
     * @param array<string,string>|null $links A collection of related links associated with the export.
     *
     * @return self
     */
     ...
     * Sets num_errors
     *
     * @param int|null $num_errors The number of errors encountered during the export process.
     *
     * @return self
     */
     ...
     * Sets requested_at
     *
     * @param \DateTime|null $requested_at The timestamp when the export request was made, in ISO 8601 format.
     *
     * @return self
     */
     ...
     * Sets result
     *
     * @param string|null $result The URL of the resulting file if the export status is COMPLETE.
     *
     * @return self
     */
     ...
     * Sets started_at
     *
     * @param \DateTime $started_at The timestamp when the export process started, in ISO 8601 format.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status The current status of the export, which can be PENDING, PROCESSING, COMPLETE or CANCELED.
     *
     * @return self
     */
