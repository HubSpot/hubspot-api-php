...
class FilterGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets filters
     *
     * @return \HubSpot\Client\Crm\Exports\Model\Filter[]
     */
     ...
     * Sets filters
     *
     * @param \HubSpot\Client\Crm\Exports\Model\Filter[] $filters A list of individual filter criteria that are applied together as a group. Each filter specifies a condition that records must meet to be included in the results.
     *
     * @return self
     */
