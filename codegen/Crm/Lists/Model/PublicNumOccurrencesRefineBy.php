...
/**
 * PublicNumOccurrencesRefineBy Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicNumOccurrencesRefineBy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicNumOccurrencesRefineBy';
    ...
    public const TYPE_NUM_OCCURRENCES = 'NUM_OCCURRENCES';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type The type of refinement (NUM_OCCURRENCES).
     *
     * @return self
     */
