...
class PublicPropertyAssociationFilterBranch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $filter_branch_operator The logical operator used to combine filters within the branch.
     *
     * @return self
     */
     ...
     *
     * @param string $filter_branch_type The type of the filter branch (PROPERTY_ASSOCIATION).
     *
     * @return self
     */
