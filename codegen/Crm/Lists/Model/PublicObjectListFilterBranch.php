...
/**
 * PublicObjectListFilterBranch Class Doc Comment
 *
 * @category Class
 * @description Defines the filter criteria for the list, allowing for complex logical operations and nested filter branches to determine list membership.
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PublicObjectListFilterBranch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = 'filter_branch_type';
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicObjectList_filterBranch';
    ...
    */
     ...
     *
     * @param string $filter_branch_operator Filter branch operator (AND)
     *
     * @return self
     */
     ...
     *
     * @param string $filter_branch_type Type of the filter branch (ASSOCIATION)
     *
     * @return self
     */
     ...
     * Sets event_type_id
     *
     * @param string $event_type_id The identifier for the type of event associated with the filter branch.
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Defines the operation to be applied within the filter branch (IN_LIST, NOT_IN_LIST).
     *
     * @return self
     */
     ...
     *
     * @param string $association_category Specifies the category of the association for the filter branch (HUBSPOT_DEFINED, USER_DEFINED, INTEGRATOR_DEFINED, WORK).
     *
     * @return self
     */
     ...
     *
     * @param int $association_type_id Type id of the association
     *
     * @return self
     */
