...
class PublicIntegrationEventFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets event_type_id
     *
     * @param int $event_type_id The ID representing the type of event for the integration event filter.
     *
     * @return self
     */
     ...
     * Sets filter_type
     *
     * @param string $filter_type Indicates the type of filter (INTEGRATION_EVENT).
     *
     * @return self
     */
