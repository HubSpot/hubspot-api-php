...
/**
 * PublicWebinarFilter Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicWebinarFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicWebinarFilter';
    ...
    public const FILTER_TYPE_WEBINAR = 'WEBINAR';
    ...
    */
     ...
     * Sets filter_type
     *
     * @param string $filter_type Indicates the type of filter, (WEBINAR).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Specifies the operation to be performed by the filter (HAS_WEBINAR_REGISTRATION, NOT_HAS_WEBINAR_REGISTRATION, HAS_WEBINAR_ATTENDANCE, NOT_HAS_WEBINAR_ATTENDANCE).
     *
     * @return self
     */
