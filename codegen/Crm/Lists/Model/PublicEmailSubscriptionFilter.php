...
class PublicEmailSubscriptionFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets filter_type
     *
     * @param string $filter_type Indicates the type of filter (EMAIL_SUBSCRIPTION).
     *
     * @return self
     */
     ...
     *
     * @param string|null $subscription_type The type of subscription related to the filter (PORTAL, BRAND, SUBSCRIPTION, HARDBOUNCE, SPAMREPORT).
     *
     * @return self
     */
