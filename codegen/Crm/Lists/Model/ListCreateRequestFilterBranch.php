...
/**
 * ListCreateRequestFilterBranch Class Doc Comment
 *
 * @category Class
 * @description Filter branch object containing filtering criteria for the list
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ListCreateRequestFilterBranch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListCreateRequest_filterBranch';
