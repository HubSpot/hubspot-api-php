<?php
/**
 * ListFilterUpdateRequestFilterBranch
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ListFilterUpdateRequestFilterBranch Class Doc Comment
 *
 * @category Class
 * @description Updated filtering criteria for the list
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ListFilterUpdateRequestFilterBranch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListFilterUpdateRequest_filterBranch';
