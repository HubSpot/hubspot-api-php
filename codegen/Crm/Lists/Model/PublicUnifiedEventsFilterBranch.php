...
class PublicUnifiedEventsFilterBranch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const OPERATOR_COMPLETED = 'HAS_COMPLETED';
    public const OPERATOR_NOT_COMPLETED = 'HAS_NOT_COMPLETED';
    ...
    {
        $this->container['filter_branch_type'] = $data['filter_branch_type'] ?? 'UNIFIED_EVENTS';
