...
/**
 * PublicUnifiedEventsFilterBranch Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicUnifiedEventsFilterBranch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicUnifiedEventsFilterBranch';
    ...
    public const FILTER_BRANCH_TYPE_UNIFIED_EVENTS = 'UNIFIED_EVENTS';
    public const OPERATOR_HAS_COMPLETED = 'HAS_COMPLETED';
    public const OPERATOR_HAS_NOT_COMPLETED = 'HAS_NOT_COMPLETED';
    ...
    {
        return [
            self::FILTER_BRANCH_TYPE_UNIFIED_EVENTS,
        ];
    }
    ...
    {
        return [
            self::OPERATOR_HAS_COMPLETED,
            self::OPERATOR_HAS_NOT_COMPLETED,
        ];
    }
    ...
    */
     ...
     *
     * @param string $filter_branch_operator The logical operator used to combine filters within the branch (AND).
     *
     * @return self
     */
     ...
     *
     * @param string $filter_branch_type The type of the filter branch (UNIFIED_EVENTS).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Defines the operation to be applied within the filter branch (HAS_COMPLETED, HAS_NOT_COMPLETED).
     *
     * @return self
     */
