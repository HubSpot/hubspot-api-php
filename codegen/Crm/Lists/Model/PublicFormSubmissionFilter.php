...
/**
 * PublicFormSubmissionFilter Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicFormSubmissionFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicFormSubmissionFilter';
    ...
    public const FILTER_TYPE_FORM_SUBMISSION = 'FORM_SUBMISSION';
    ...
    {
        return [
            self::FILTER_TYPE_FORM_SUBMISSION,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('filter_type', $data ?? [], 'FORM_SUBMISSION');
    ...
    */
     ...
     * Sets filter_type
     *
     * @param string $filter_type Indicates the type of filter (FORM_SUBMISSION).
     *
     * @return self
     */
     ...
     * Sets form_id
     *
     * @param string|null $form_id The ID of the form used in the filter.
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Specifies the operation to be performed (FILLED_OUT, NOT_FILLED_OUT).
     *
     * @return self
     */
