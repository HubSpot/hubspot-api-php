...
class PublicPrivacyAnalyticsFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('filter_type', $data ?? [], 'PRIVACY');
    ...
    */
     ...
     * Sets filter_type
     *
     * @param string $filter_type Specifies the type of filter (PRIVACY).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Defines the operation to be applied within the filter (PRIVACY_CONSENT_GRANTED, PRIVACY_CONSENT_NOT_GRANTED).
     *
     * @return self
     */
