...
/**
 * PublicPropertyFilter Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicPropertyFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicPropertyFilter';
    ...
    public const FILTER_TYPE_PROPERTY = 'PROPERTY';
    ...
    {
        $this->setIfExists('filter_type', $data ?? [], 'PROPERTY');
    ...
    */
     ...
     * Sets filter_type
     *
     * @param string $filter_type Indicates that the filter (PROPERTY).
     *
     * @return self
     */
