...
/**
 * PublicPageViewAnalyticsFilter Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicPageViewAnalyticsFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicPageViewAnalyticsFilter';
    ...
    public const FILTER_TYPE_PAGE_VIEW = 'PAGE_VIEW';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('filter_type', $data ?? [], 'PAGE_VIEW');
    ...
    */
     ...
     * Sets filter_type
     *
     * @param string $filter_type Indicates the type of filter being applied (PAGE_VIEW).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Defines the operation to be applied within the filter (HAS_PAGEVIEW_EQ, HAS_PAGEVIEW_CONTAINS, HAS_PAGEVIEW_MATCHES_REGEX, NOT_HAS_PAGEVIEW_EQ, NOT_HAS_PAGEVIEW_CONTAINS).
     *
     * @return self
     */
