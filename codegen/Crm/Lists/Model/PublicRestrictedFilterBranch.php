...
/**
 * PublicRestrictedFilterBranch Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicRestrictedFilterBranch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicRestrictedFilterBranch';
    ...
    public const FILTER_BRANCH_TYPE_RESTRICTED = 'RESTRICTED';
    ...
    {
        return [
            self::FILTER_BRANCH_TYPE_RESTRICTED,
        ];
    }
    ...
    */
     ...
     *
     * @param string $filter_branch_operator The logical operator used to combine filters within the restricted filter branch.
     *
     * @return self
     */
     ...
     *
     * @param string $filter_branch_type Specifies the type of the filter branch (RESTRICTED).
     *
     * @return self
     */
