...
/**
 * PublicSurveyMonkeyFilter Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicSurveyMonkeyFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicSurveyMonkeyFilter';
    ...
    public const FILTER_TYPE_SURVEY_MONKEY = 'SURVEY_MONKEY';
    ...
    {
        return [
            self::FILTER_TYPE_SURVEY_MONKEY,
        ];
    }
    ...
    */
     ...
     * Sets filter_type
     *
     * @param string $filter_type Indicates the type of filter being applied (SURVEY_MONKEY).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Specifies the operation to be performed by the filter (HAS_RESPONDED_TO_SURVEY, HAS_NOT_RESPONDED_TO_SURVEY).
     *
     * @return self
     */
     ...
     * Sets survey_id
     *
     * @param string $survey_id The ID of the survey associated with the filter.
     *
     * @return self
     */
