<?php
/**
 * PublicFormSubmissionOnPageFilterCoalescingRefineBy
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PublicFormSubmissionOnPageFilterCoalescingRefineBy Class Doc Comment
 *
 * @category Class
 ...
 */
class PublicFormSubmissionOnPageFilterCoalescingRefineBy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicFormSubmissionOnPageFilter_coalescingRefineBy';
    ...
    */
     ...
     *
     * @param int|null $max_occurrences The maximum number of occurrences allowed.
     *
     * @return self
     */
     ...
     *
     * @param int|null $min_occurrences The minimum number of occurrences required.
     *
     * @return self
     */
     ...
     * Sets set_type
     *
     * @param string $set_type Indicates the specific set type used in the refinement (ALL, ALL_INCLUDE_EMPTY, ANY, NONE, NONE_EXCLUDE_EMPTY, ANY_INCLUDE_EMPTY).
     *
     * @return self
     */
     ...
     * Sets comparison
     *
     * @param string $comparison Timestamp comparison options (BEFORE, AFTER)
     *
     * @return self
     */
     ...
     * Sets range_type
     *
     * @param string $range_type Type of range of refinement critaria (BETWEEN, NOT_BETWEEN)
     *
     * @return self
     */
     ...
     * Sets timestamp
     *
     * @param int $timestamp Timestamp to be used in refine by criteria
     *
     * @return self
     */
     ...
     *
     * @param int $lower_timestamp Lower range timestamp of refinement criteria
     *
     * @return self
     */
     ...
     *
     * @param int $upper_timestamp Upper range timestamp of refinement criteria
     *
     * @return self
     */
