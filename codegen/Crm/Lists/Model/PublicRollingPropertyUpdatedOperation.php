...
class PublicRollingPropertyUpdatedOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets operation_type
     *
     * @param string $operation_type Specifies the type of operation (ROLLING_PROPERTY_UPDATED).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Defines the operation to be applied within the rolling property updated operation (UPDATED_IN_LAST_X_DAYS, NOT_UPDATED_IN_LAST_X_DAYS).
     *
     * @return self
     */
