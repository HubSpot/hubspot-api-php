...
class PublicUnifiedEventsFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets event_type_id
     *
     * @param string|null $event_type_id The identifier for the type of event in the unified events filter.
     *
     * @return self
     */
     ...
     * Sets filter_type
     *
     * @param string $filter_type Indicates the type of filter being applied (UNIFIED_EVENTS).
     *
     * @return self
     */
