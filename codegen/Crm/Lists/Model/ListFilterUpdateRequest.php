...
/**
 * ListFilterUpdateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ListFilterUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListFilterUpdateRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['filter_branch'] === null) {
            $invalidProperties[] = "'filter_branch' can't be null";
        }
     ...
     * Sets filter_branch
     *
     * @param \HubSpot\Client\Crm\Lists\Model\PublicPropertyAssociationFilterBranchFilterBranchesInner $filter_branch filter_branch
     *
     * @return self
     */
