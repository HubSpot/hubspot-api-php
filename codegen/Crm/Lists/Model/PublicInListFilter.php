...
/**
 * PublicInListFilter Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicInListFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicInListFilter';
    ...
    public const FILTER_TYPE_IN_LIST = 'IN_LIST';
    ...
    {
        $this->setIfExists('filter_type', $data ?? [], 'IN_LIST');
    ...
    */
     ...
     * Sets filter_type
     *
     * @param string $filter_type Indicates the type of filter being applied (IN_LIST).
     *
     * @return self
     */
