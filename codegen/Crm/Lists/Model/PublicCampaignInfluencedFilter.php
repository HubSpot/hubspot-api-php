...
/**
 * PublicCampaignInfluencedFilter Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicCampaignInfluencedFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicCampaignInfluencedFilter';
    ...
    public const FILTER_TYPE_CAMPAIGN_INFLUENCED = 'CAMPAIGN_INFLUENCED';
    ...
    {
        return [
            self::FILTER_TYPE_CAMPAIGN_INFLUENCED,
        ];
    }
    ...
    */
     ...
     * Sets filter_type
     *
     * @param string $filter_type Indicates the type of filter (CAMPAIGN_INFLUENCED).
     *
     * @return self
     */
