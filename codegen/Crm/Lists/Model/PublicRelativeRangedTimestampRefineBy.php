...
class PublicRelativeRangedTimestampRefineBy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets range_type
     *
     * @param string $range_type Specifies the type of range for the refinement criteria (BETWEEN, NOT_BETWEEN).
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Indicates the type of refinement (RELATIVE_RANGED).
     *
     * @return self
     */
