...
class PublicDatePoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets time_type
     *
     * @param string $time_type Specifies the type of time (DATE).
     *
     * @return self
     */
     ...
     *
     * @param string|null $timezone_source The source of the time zone information.
     *
     * @return self
     */
     ...
     * Sets zone_id
     *
     * @param string $zone_id The identifier for the time zone.
     *
     * @return self
     */
