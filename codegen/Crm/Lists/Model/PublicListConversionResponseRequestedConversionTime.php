<?php
/**
 * PublicListConversionResponseRequestedConversionTime
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PublicListConversionResponseRequestedConversionTime Class Doc Comment
 *
 * @category Class
 * @description The scheduled time for the list conversion, which can be based on a specific date or inactivity period.
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PublicListConversionResponseRequestedConversionTime implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicListConversionResponse_requestedConversionTime';
