...
/**
 * PublicCtaAnalyticsFilter Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicCtaAnalyticsFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicCtaAnalyticsFilter';
    ...
    public const FILTER_TYPE_CTA = 'CTA';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('filter_type', $data ?? [], 'CTA');
    ...
    */
     ...
     * Sets filter_type
     *
     * @param string $filter_type Indicates the type of filter being applied, which is (CTA).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Defines the operation to be applied within the filter (HAS_CLICKED_CTA, HAS_NOT_CLICKED_CTA, HAS_OPENED_CTA, HAS_NOT_OPENED_CTA, HAS_CLICKED_CTA_PLACEMENT, HAS_NOT_CLICKED_CTA_PLACEMENT, HAS_OPENED_CTA_PLACEMENT, HAS_NOT_OPENED_CTA_PLACEMENT).
     *
     * @return self
     */
