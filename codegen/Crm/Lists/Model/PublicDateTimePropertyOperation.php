...
/**
 * PublicDateTimePropertyOperation Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicDateTimePropertyOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicDateTimePropertyOperation';
    ...
    public const OPERATION_TYPE_DATETIME = 'DATETIME';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('operation_type', $data ?? [], 'DATETIME');
    ...
    */
     ...
     * Sets operation_type
     *
     * @param string $operation_type The type of operation (DATETIME).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Defines the operation to be applied, such as comparison operators (IS_BEFORE, IS_AFTER).
     *
     * @return self
     */
     ...
     *
     * @param bool $requires_time_zone_conversion Indicates whether the timestamp requires conversion to a different time zone.
     *
     * @return self
     */
