...
class PublicSurveyMonkeyValueFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('filter_type', $data ?? [], 'SURVEY_MONKEY_VALUE');
    ...
    */
     ...
     * Sets filter_type
     *
     * @param string $filter_type Defines the type of filter (SURVEY_MONKEY_VALUE).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Defines the operation to be applied within the filter (HAS_ANSWERED_SURVEY_QUESTION_WITH_VALUE).
     *
     * @return self
     */
