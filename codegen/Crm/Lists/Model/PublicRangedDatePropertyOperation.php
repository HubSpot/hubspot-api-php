...
class PublicRangedDatePropertyOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param bool $include_objects_with_no_value_set Specifies whether objects without a set value should be included in the operation.
     *
     * @return self
     */
     ...
     * Sets lower_bound
     *
     * @param int $lower_bound The lower limit of the date range for the operation.
     *
     * @return self
     */
     ...
     * Sets operation_type
     *
     * @param string $operation_type Specifies the type of operation (RANGED_DATE).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Defines the operation to be applied in the ranged date property operation (IS_BETWEEN, IS_NOT_BETWEEN).
     *
     * @return self
     */
     ...
     *
     * @param bool $requires_time_zone_conversion Indicates whether the operation requires conversion to a different time zone.
     *
     * @return self
     */
     ...
     * Sets upper_bound
     *
     * @param int $upper_bound The upper limit of the date range for the operation.
     *
     * @return self
     */
