...
class PublicRelativeComparativeTimestampRefineBy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets comparison
     *
     * @param string $comparison Defines the comparison operation to be used in the refinement (BEFORE, AFTER).
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Specifies the type of refinement, (RELATIVE_COMPARATIVE).
     *
     * @return self
     */
