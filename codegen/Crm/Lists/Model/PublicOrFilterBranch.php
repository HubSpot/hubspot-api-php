...
/**
 * PublicOrFilterBranch Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicOrFilterBranch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicOrFilterBranch';
    ...
    public const FILTER_BRANCH_TYPE__OR = 'OR';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('filter_branch_type', $data ?? [], 'OR');
    ...
    */
     ...
     *
     * @param string $filter_branch_operator The logical operator used to combine the filters within the branch (OR).
     *
     * @return self
     */
     ...
     *
     * @param string $filter_branch_type The type of the filter branch (OR).
     *
     * @return self
     */
