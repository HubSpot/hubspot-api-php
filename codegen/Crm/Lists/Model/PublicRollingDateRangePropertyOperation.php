...
class PublicRollingDateRangePropertyOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets number_of_days
     *
     * @param int $number_of_days The number of days to be considered in the rolling date range operation.
     *
     * @return self
     */
     ...
     * Sets operation_type
     *
     * @param string $operation_type Specifies the type of operation (ROLLING_DATE_RANGE).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Defines the operation to be applied within the rolling date range property operation (IS_LESS_THAN_X_DAYS_AGO, IS_MORE_THAN_X_DAYS_AGO, IS_LESS_THAN_X_DAYS_FROM_NOW, IS_MORE_THAN_X_DAYS_FROM_NOW).
     *
     * @return self
     */
