...
class PublicTimePointOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets operation_type
     *
     * @param string $operation_type Specifies the type of operation (TIME_POINT).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Specifies the operation to be applied within the time point operation (IS_BEFORE, IS_AFTER).
     *
     * @return self
     */
     ...
     *
     * @param string|null $property_parser Specifies the parser used for interpreting the property in the operation.
     *
     * @return self
     */
