...
class PublicAssociationInListFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets filter_type
     *
     * @param string $filter_type Indicates the type of filter being applied, which is 'ASSOCIATION' by default.
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Specifies the operation to be performed by the filter, such as 'IN_LIST' or 'NOT_IN_LIST'.
     *
     * @return self
     */
