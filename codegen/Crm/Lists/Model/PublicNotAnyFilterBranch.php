...
/**
 * PublicNotAnyFilterBranch Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicNotAnyFilterBranch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicNotAnyFilterBranch';
    ...
    public const FILTER_BRANCH_TYPE_NOT_ANY = 'NOT_ANY';
    ...
    {
        return [
            self::FILTER_BRANCH_TYPE_NOT_ANY,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('filter_branch_type', $data ?? [], 'NOT_ANY');
    ...
    */
     ...
     *
     * @param string $filter_branch_operator Specifies the logical operator used to combine filters within the branch (NOT_ANY).
     *
     * @return self
     */
     ...
     *
     * @param string $filter_branch_type Indicates the type of filter branch (NOT_ANY).
     *
     * @return self
     */
