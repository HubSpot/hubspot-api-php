...
/**
 * PublicAllPropertyTypesOperation Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicAllPropertyTypesOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicAllPropertyTypesOperation';
    ...
    public const OPERATION_TYPE_ALL_PROPERTY = 'ALL_PROPERTY';
    ...
    {
        return [
            self::OPERATION_TYPE_ALL_PROPERTY,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('operation_type', $data ?? [], 'ALL_PROPERTY');
    ...
    */
     ...
     *
     * @param bool $include_objects_with_no_value_set Indication of whether objects with no value should be included
     *
     * @return self
     */
     ...
     * Sets operation_type
     *
     * @param string $operation_type Type of operation (ALL_PROPERTY)
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Operator to be applied (IS_KNOWN, IS_UNKNOWN)
     *
     * @return self
     */
