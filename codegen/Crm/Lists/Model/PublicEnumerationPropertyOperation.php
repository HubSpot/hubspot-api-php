...
/**
 * PublicEnumerationPropertyOperation Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicEnumerationPropertyOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicEnumerationPropertyOperation';
    ...
    public const OPERATION_TYPE_ENUMERATION = 'ENUMERATION';
    ...
    {
        return [
            self::OPERATION_TYPE_ENUMERATION,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('operation_type', $data ?? [], 'ENUMERATION');
    ...
    */
     ...
     * Sets operation_type
     *
     * @param string $operation_type Specifies the type of operation (ENUMERATION).
     *
     * @return self
     */
