...
class PublicFormSubmissionOnPageFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'coalescing_refine_by' => '\HubSpot\Client\Crm\Lists\Model\PublicFormSubmissionOnPageFilterCoalescingRefineBy',
        'filter_type' => 'string',
        'form_id' => 'string',
        'operator' => 'string',
        'page_id' => 'string',
    ...
    */
     ...
     *
     * @return \HubSpot\Client\Crm\Lists\Model\PublicFormSubmissionOnPageFilterCoalescingRefineBy|null
     */
     ...
     *
     * @param \HubSpot\Client\Crm\Lists\Model\PublicFormSubmissionOnPageFilterCoalescingRefineBy|null $coalescing_refine_by coalescing_refine_by
     *
     * @return self
     */
     ...
     * Sets filter_type
     *
     * @param string $filter_type Indicates the type of filter (FORM_SUBMISSION_ON_PAGE).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Specifies the operation to be applied (FILLED_OUT, NOT_FILLED_OUT).
     *
     * @return self
     */
