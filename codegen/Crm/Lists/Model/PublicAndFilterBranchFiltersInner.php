<?php
/**
 * PublicAndFilterBranchFiltersInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PublicAndFilterBranchFiltersInner Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicAndFilterBranchFiltersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicAndFilterBranch_filters_inner';
    ...
    */
     ...
     *
     * @param string $association_category Defines the category of the association, such as (HUBSPOT_DEFINED, USER_DEFINED, INTEGRATOR_DEFINED, WORK).
     *
     * @return self
     */
     ...
     *
     * @return \HubSpot\Client\Crm\Lists\Model\PublicCtaAnalyticsFilterCoalescingRefineBy
     */
     ...
     *
     * @param \HubSpot\Client\Crm\Lists\Model\PublicCtaAnalyticsFilterCoalescingRefineBy $coalescing_refine_by coalescing_refine_by
     *
     * @return self
     */
     ...
     * Sets list_id
     *
     * @param string $list_id The ID of the list used in the association filter.
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Specifies the operation to be performed by the filter (IN_LIST, NOT_IN_LIST).
     *
     * @return self
     */
     ...
     *
     * @param string|null $to_object_type_id The ID representing the type of object that the association filter is targeting.
     *
     * @return self
     */
     ...
     *
     * @return \HubSpot\Client\Crm\Lists\Model\PublicCtaAnalyticsFilterPruningRefineBy
     */
     ...
     *
     * @param \HubSpot\Client\Crm\Lists\Model\PublicCtaAnalyticsFilterPruningRefineBy $pruning_refine_by pruning_refine_by
     *
     * @return self
     */
