...
class PublicStringPropertyOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets operation_type
     *
     * @param string $operation_type Specifies the type of operation (STRING).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Defines the operation to be applied in the string property operation ()IS_EQUAL_TO, IS_NOT_EQUAL_TO, CONTAINS, DOES_NOT_CONTAIN, STARTS_WITH, ENDS_WITH, HAS_EVER_BEEN_EQUAL_TO, HAS_NEVER_BEEN_EQUAL_TO, HAS_EVER_CONTAINED, HAS_NEVER_CONTAINED).
     *
     * @return self
     */
