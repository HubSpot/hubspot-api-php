...
class PublicIndexedTimePoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('time_type', $data ?? [], 'INDEXED');
    ...
    */
     ...
     * Sets time_type
     *
     * @param string $time_type Defines the type of time (INDEXED).
     *
     * @return self
     */
     ...
     *
     * @param string|null $timezone_source Specifies the source of the time zone information for the indexed time point (CUSTOM, USER, PORTAL).
     *
     * @return self
     */
     ...
     * Sets zone_id
     *
     * @param string $zone_id Indicates the identifier for the time zone associated with the indexed time point.
     *
     * @return self
     */
