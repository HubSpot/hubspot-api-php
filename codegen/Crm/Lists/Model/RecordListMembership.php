 ...
 *
 * @category Class
 * @description Lists record is member of
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class RecordListMembership implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'is_public_list' => 'setIsPublicList',
    ...
    protected static $getters = [
        ...
        'is_public_list' => 'getIsPublicList',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_public_list', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \DateTime|null $first_added_timestamp The timestamp when the record was first added to the list.
     *
     * @return self
     */
    ...
    {
        return $this->container['is_public_list'];
    }

    /**
     * Sets is_public_list
     *
     * @param bool|null $is_public_list Indicates whether the list is public.
     *
     * @return self
     */
    public function setIsPublicList($is_public_list)
    {
        if (is_null($is_public_list)) {
            throw new \InvalidArgumentException('non-nullable is_public_list cannot be null');
        }
        $this->container['is_public_list'] = $is_public_list;
     ...
     *
     * @param \DateTime|null $last_added_timestamp The timestamp when the record was last added to the list.
     *
     * @return self
     */
     ...
     * Sets list_id
     *
     * @param string $list_id The unique identifier of the list.
     *
     * @return self
     */
     ...
     * Sets list_version
     *
     * @param int $list_version The version number of the list.
     *
     * @return self
     */
