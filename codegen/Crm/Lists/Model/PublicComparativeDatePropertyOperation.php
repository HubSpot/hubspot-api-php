...
class PublicComparativeDatePropertyOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('operation_type', $data ?? [], 'COMPARATIVE_DATE');
    ...
    */
     ...
     * Sets operation_type
     *
     * @param string $operation_type The type of operation (COMPARATIVE_DATE).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Defines the operation to be applied in the comparative date property operation (IS_BEFORE, IS_AFTER).
     *
     * @return self
     */
