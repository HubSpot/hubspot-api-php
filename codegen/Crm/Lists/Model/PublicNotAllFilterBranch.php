...
class PublicNotAllFilterBranch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $filter_branch_operator The operator used to combine filters within the branch (NOT_ALL).
     *
     * @return self
     */
     ...
     *
     * @param string $filter_branch_type The type of the filter branch (NOT_ALL).
     *
     * @return self
     */
