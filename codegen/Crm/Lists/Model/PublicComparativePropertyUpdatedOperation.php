...
/**
 * PublicComparativePropertyUpdatedOperation Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicComparativePropertyUpdatedOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicComparativePropertyUpdatedOperation';
    ...
    public const OPERATION_TYPE_COMPARATIVE_PROPERTY_UPDATED = 'COMPARATIVE_PROPERTY_UPDATED';
    ...
    {
        return [
            self::OPERATION_TYPE_COMPARATIVE_PROPERTY_UPDATED,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('operation_type', $data ?? [], 'COMPARATIVE_PROPERTY_UPDATED');
    ...
    */
     ...
     * Sets operation_type
     *
     * @param string $operation_type Specifies the type of operation (COMPARATIVE_PROPERTY_UPDATED).
     *
     * @return self
     */
