...
/**
 * PublicRangedNumberPropertyOperation Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Crm\Lists
 * @author   OpenAPI Generator team
 ...
 */
class PublicRangedNumberPropertyOperation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicRangedNumberPropertyOperation';
    ...
    public const OPERATION_TYPE_NUMBER_RANGED = 'NUMBER_RANGED';
    ...
    {
        return [
            self::OPERATION_TYPE_NUMBER_RANGED,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('operation_type', $data ?? [], 'NUMBER_RANGED');
    ...
    */
     ...
     * Sets operation_type
     *
     * @param string $operation_type Specifies the type of operation (NUMBER_RANGED).
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string $operator Defines the operation to be applied in the ranged number property operation (IS_BETWEEN, IS_NOT_BETWEEN).
     *
     * @return self
     */
