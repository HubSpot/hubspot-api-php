...
class FoldersApi
{
     ...
     */
    public function create($list_folder_create_request, string $contentType = self::contentTypes['create'][0])
    {
        list($response) = $this->createWithHttpInfo($list_folder_create_request, $contentType);
        return $response;
    }
     ...
     */
    public function createWithHttpInfo($list_folder_create_request, string $contentType = self::contentTypes['create'][0])
    {
        $request = $this->createRequest($list_folder_create_request, $contentType);
     ...
     */
    public function createAsync($list_folder_create_request, string $contentType = self::contentTypes['create'][0])
    {
        return $this->createAsyncWithHttpInfo($list_folder_create_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsyncWithHttpInfo($list_folder_create_request, string $contentType = self::contentTypes['create'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Lists\Model\ListFolderCreateResponse';
        $request = $this->createRequest($list_folder_create_request, $contentType);
     ...
     */
    public function createRequest($list_folder_create_request, string $contentType = self::contentTypes['create'][0])
    {
        ...
        if ($list_folder_create_request === null || (is_array($list_folder_create_request) && count($list_folder_create_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $list_folder_create_request when calling create'
            );
        }
     ...
     * Retrieves a folder.
     *
     * @param  string $folder_id The Id of the folder to retrieve. (optional, default to '0')
     ...
     */
    public function getAll($folder_id = '0', string $contentType = self::contentTypes['getAll'][0])
    {
        list($response) = $this->getAllWithHttpInfo($folder_id, $contentType);
        return $response;
    }
     ...
     */
    public function getAllWithHttpInfo($folder_id = '0', string $contentType = self::contentTypes['getAll'][0])
    {
        $request = $this->getAllRequest($folder_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllAsync($folder_id = '0', string $contentType = self::contentTypes['getAll'][0])
    {
        return $this->getAllAsyncWithHttpInfo($folder_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllAsyncWithHttpInfo($folder_id = '0', string $contentType = self::contentTypes['getAll'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Lists\Model\ListFolderFetchResponse';
        $request = $this->getAllRequest($folder_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllRequest($folder_id = '0', string $contentType = self::contentTypes['getAll'][0])
    {
     ...
     * @param  string $new_parent_folder_id  (required)
     ...
     * @return void
     */
    public function remove($folder_id, string $contentType = self::contentTypes['remove'][0])
    {
        $this->removeWithHttpInfo($folder_id, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function removeWithHttpInfo($folder_id, string $contentType = self::contentTypes['remove'][0])
    {
        $request = $this->removeRequest($folder_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeAsync($folder_id, string $contentType = self::contentTypes['remove'][0])
    {
        return $this->removeAsyncWithHttpInfo($folder_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeAsyncWithHttpInfo($folder_id, string $contentType = self::contentTypes['remove'][0])
    {
        $returnType = '';
        $request = $this->removeRequest($folder_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function removeRequest($folder_id, string $contentType = self::contentTypes['remove'][0])
    {

        // verify the required parameter 'folder_id' is set
        if ($folder_id === null || (is_array($folder_id) && count($folder_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $folder_id when calling remove'
            );
        }
     ...
     *
     * @param  string $folder_id  (required)
     * @param  string $new_folder_name  (optional)
