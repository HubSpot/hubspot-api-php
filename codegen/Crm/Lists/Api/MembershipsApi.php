...
class MembershipsApi
{
     ...
     * @param  string[] $request_body The IDs of the records to add to the list. (required)
     ...
     *
     * @param  string $list_id The **ILS ID** of the &#x60;MANUAL&#x60; or &#x60;SNAPSHOT&#x60; list. (required)
     * @param  string[] $request_body The IDs of the records to remove from the list. (required)
