...
class CoreApi
{
     ...
     */
    public function getPage($after = null, $before = null, $limit = null, string $contentType = self::contentTypes['getPage'][0])
    {
        list($response) = $this->getPageWithHttpInfo($after, $before, $limit, $contentType);
        return $response;
    }
     ...
     */
    public function getPageWithHttpInfo($after = null, $before = null, $limit = null, string $contentType = self::contentTypes['getPage'][0])
    {
        $request = $this->getPageRequest($after, $before, $limit, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPageAsync($after = null, $before = null, $limit = null, string $contentType = self::contentTypes['getPage'][0])
    {
        return $this->getPageAsyncWithHttpInfo($after, $before, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPageAsyncWithHttpInfo($after = null, $before = null, $limit = null, string $contentType = self::contentTypes['getPage'][0])
    {
        $returnType = '\HubSpot\Client\Crm\Imports\Model\CollectionResponsePublicImportResponse';
        $request = $this->getPageRequest($after, $before, $limit, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPageRequest($after = null, $before = null, $limit = null, string $contentType = self::contentTypes['getPage'][0])
    {
