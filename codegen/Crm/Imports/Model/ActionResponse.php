...
class ActionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets completed_at
     *
     * @param \DateTime $completed_at The timestamp when the action was completed, in ISO 8601 format.
     *
     * @return self
     */
     ...
     * Sets links
     *
     * @param array<string,string>|null $links An optional collection of related links associated with the import.
     *
     * @return self
     */
     ...
     * Sets started_at
     *
     * @param \DateTime $started_at The timestamp when the action was started, in ISO 8601 format.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status An enum representing the lifecycle state of the action.
     *
     * @return self
     */
