...
class PublicImportError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'string',
        'invalid_property_value' => '\HubSpot\Client\Crm\Imports\Model\PropertyValue',
    ...
    protected static $openAPIFormats = [
        ...
        'extra_context' => null,
        'id' => null,
        'invalid_property_value' => null,
        'invalid_value' => null,
        'invalid_value_to_display' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'invalid_value' => false,
        'invalid_value_to_display' => false,
    ...
    protected static $setters = [
        ...
        'id' => 'setId',
        'invalid_property_value' => 'setInvalidPropertyValue',
        'invalid_value' => 'setInvalidValue',
        'invalid_value_to_display' => 'setInvalidValueToDisplay',
    ...
    protected static $getters = [
        ...
        'id' => 'getId',
        'invalid_property_value' => 'getInvalidPropertyValue',
        'invalid_value' => 'getInvalidValue',
        'invalid_value_to_display' => 'getInvalidValueToDisplay',
    ...
    public const ERROR_TYPE_ASSOCIATION_LABEL_NOT_FOUND = 'ASSOCIATION_LABEL_NOT_FOUND';
    public const ERROR_TYPE_ASSOCIATION_LIMIT_EXCEEDED = 'ASSOCIATION_LIMIT_EXCEEDED';
    public const ERROR_TYPE_ASSOCIATION_RECORD_NOT_FOUND = 'ASSOCIATION_RECORD_NOT_FOUND';
    ...
    public const ERROR_TYPE_DUPLICATE_UNIQUE_CREATION_KEY = 'DUPLICATE_UNIQUE_CREATION_KEY';
    ...
    public const ERROR_TYPE_FAILED_TO_FIND_RECORD_FOR_ASSOCIATIONS = 'FAILED_TO_FIND_RECORD_FOR_ASSOCIATIONS';
    ...
    public const ERROR_TYPE_INVALID_ASSOCIATION_KEY = 'INVALID_ASSOCIATION_KEY';
    ...
    public const ERROR_TYPE_INVALID_ENUM_FILE_ID_OR_URL = 'INVALID_ENUM_FILE_ID_OR_URL';
    ...
    public const ERROR_TYPE_INVALID_PROPERTY_VALUE_FORMAT = 'INVALID_PROPERTY_VALUE_FORMAT';
    ...
    public const ERROR_TYPE_LINE_ITEM_MULTIPLE_PARENTS_IN_ROW = 'LINE_ITEM_MULTIPLE_PARENTS_IN_ROW';
    public const ERROR_TYPE_MANY_ERRORS_IN_ROW = 'MANY_ERRORS_IN_ROW';
    public const ERROR_TYPE_MISSING_EVENT_DEFINITION = 'MISSING_EVENT_DEFINITION';
    public const ERROR_TYPE_MISSING_EVENT_TIMESTAMP = 'MISSING_EVENT_TIMESTAMP';
    public const ERROR_TYPE_MISSING_OBJECT_DEFINITION = 'MISSING_OBJECT_DEFINITION';
    ...
    public const ERROR_TYPE_SECONDARY_EMAIL_WRITE_FAILURE = 'SECONDARY_EMAIL_WRITE_FAILURE';
    ...
    public const OBJECT_TYPE_AUDIENCE = 'AUDIENCE';
    public const OBJECT_TYPE_AUTOMATION_JOURNEY = 'AUTOMATION_JOURNEY';
    ...
    public const OBJECT_TYPE_CASE_STUDY = 'CASE_STUDY';
    public const OBJECT_TYPE_CHATFLOW = 'CHATFLOW';
    public const OBJECT_TYPE_CLIP = 'CLIP';
    public const OBJECT_TYPE_CMS_URL = 'CMS_URL';
    public const OBJECT_TYPE_COMBO_EVENT_CONFIGURATION = 'COMBO_EVENT_CONFIGURATION';
    ...
    public const OBJECT_TYPE_CRM_OBJECTS_DUMMY_TYPE = 'CRM_OBJECTS_DUMMY_TYPE';
    ...
    public const OBJECT_TYPE_DATA_PRIVACY_CONSENT = 'DATA_PRIVACY_CONSENT';
    ...
    public const OBJECT_TYPE_GOAL_TEMPLATE = 'GOAL_TEMPLATE';
    ...
    public const OBJECT_TYPE_KNOWLEDGE_ARTICLE = 'KNOWLEDGE_ARTICLE';
    ...
    public const OBJECT_TYPE_PARTNER_CLIENT_REVENUE = 'PARTNER_CLIENT_REVENUE';
    public const OBJECT_TYPE_PARTNER_SERVICE = 'PARTNER_SERVICE';
    ...
    public const OBJECT_TYPE_PODCAST_EPISODE = 'PODCAST_EPISODE';
    ...
    public const OBJECT_TYPE_PROPERTY_INFO = 'PROPERTY_INFO';
    public const OBJECT_TYPE_PROSPECTING_AGENT_CONTACT_ASSIGNMENT = 'PROSPECTING_AGENT_CONTACT_ASSIGNMENT';
    ...
    public const OBJECT_TYPE_SCORE_CONFIGURATION = 'SCORE_CONFIGURATION';
    ...
    public function getErrorTypeAllowableValues()
    {
        return [
            ...
            self::ERROR_TYPE_ASSOCIATION_LIMIT_EXCEEDED,
            self::ERROR_TYPE_ASSOCIATION_RECORD_NOT_FOUND,
            ...
            self::ERROR_TYPE_DUPLICATE_UNIQUE_CREATION_KEY,
            self::ERROR_TYPE_DUPLICATE_UNIQUE_PROPERTY_VALUE,
            self::ERROR_TYPE_FAILED_TO_CREATE_ASSOCIATION,
            self::ERROR_TYPE_FAILED_TO_FIND_RECORD_FOR_ASSOCIATIONS,
            ...
            self::ERROR_TYPE_INVALID_ASSOCIATION_KEY,
            ...
            self::ERROR_TYPE_INVALID_ENUM_FILE_ID_OR_URL,
            ...
            self::ERROR_TYPE_INVALID_PROPERTY_VALUE_FORMAT,
            ...
            self::ERROR_TYPE_LINE_ITEM_MULTIPLE_PARENTS_IN_ROW,
            self::ERROR_TYPE_MANY_ERRORS_IN_ROW,
            ...
            self::ERROR_TYPE_SECONDARY_EMAIL_WRITE_FAILURE,
    ...
    public function getObjectTypeAllowableValues()
    {
        return [
            ...
            self::OBJECT_TYPE_AUDIENCE,
            self::OBJECT_TYPE_AUTOMATION_JOURNEY,
            ...
            self::OBJECT_TYPE_PARTNER_CLIENT_REVENUE,
            self::OBJECT_TYPE_PARTNER_SERVICE,
            ...
            self::OBJECT_TYPE_PODCAST_EPISODE,
            ...
            self::OBJECT_TYPE_PROPERTY_INFO,
            self::OBJECT_TYPE_PROSPECTING_AGENT_CONTACT_ASSIGNMENT,
            ...
            self::OBJECT_TYPE_SCORE_CONFIGURATION,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('invalid_property_value', $data ?? [], null);
        $this->setIfExists('invalid_value', $data ?? [], null);
        $this->setIfExists('invalid_value_to_display', $data ?? [], null);
    ...
    */
     ...
     * Sets created_at
     *
     * @param int $created_at The epoch millisecond timestamp when this error was recorded.
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string|null $error_message A human-readable error message.
     *
     * @return self
     */
     ...
     * Sets error_type
     *
     * @param string $error_type The classification of what went wrong during import processing.
     *
     * @return self
     */
     ...
     * Sets extra_context
     *
     * @param string|null $extra_context Additional human-readable context about the error.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id A unique, stable identifier for this specific error.
     *
     * @return self
     */
    ...
    /**
     * Gets invalid_property_value
     *
     * @return \HubSpot\Client\Crm\Imports\Model\PropertyValue|null
     */
    public function getInvalidPropertyValue()
    {
        return $this->container['invalid_property_value'];
    }

    /**
     * Sets invalid_property_value
     *
     * @param \HubSpot\Client\Crm\Imports\Model\PropertyValue|null $invalid_property_value invalid_property_value
     *
     * @return self
     */
    public function setInvalidPropertyValue($invalid_property_value)
    {
        if (is_null($invalid_property_value)) {
            throw new \InvalidArgumentException('non-nullable invalid_property_value cannot be null');
        }
        $this->container['invalid_property_value'] = $invalid_property_value;
     ...
     * Sets invalid_value
     *
     * @param string|null $invalid_value The raw string value from the import file that caused the validation failure.
     *
     * @return self
     */
    ...
    /**
     * Gets invalid_value_to_display
     *
     * @return string|null
     */
    public function getInvalidValueToDisplay()
    {
        return $this->container['invalid_value_to_display'];
    }

    /**
     * Sets invalid_value_to_display
     *
     * @param string|null $invalid_value_to_display A convenience accessor that returns either the value from `invalidPropertyValue` or `invalidValue`, whichever is present (preferring the property value).
     *
     * @return self
     */
    public function setInvalidValueToDisplay($invalid_value_to_display)
    {
        if (is_null($invalid_value_to_display)) {
            throw new \InvalidArgumentException('non-nullable invalid_value_to_display cannot be null');
        }
        $this->container['invalid_value_to_display'] = $invalid_value_to_display;
     ...
     * Sets object_type
     *
     * @param string|null $object_type The CRM object type affected by this error.
     *
     * @return self
     */
     ...
     * Sets object_type_id
     *
     * @param string|null $object_type_id The modern object type identifier for the CRM object affected by this error.
     *
     * @return self
     */
