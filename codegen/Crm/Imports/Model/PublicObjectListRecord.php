 ...
 */
class PublicObjectListRecord implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicObjectListRecord';
     ...
     * Sets list_id
     *
     * @param string $list_id The ID of the list containing the imported objects.
     *
     * @return self
     */
     ...
     * Sets object_type
     *
     * @param string $object_type The type of object contained in the list.
     *
     * @return self
     */
