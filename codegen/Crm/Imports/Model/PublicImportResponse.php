...
class PublicImportResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['import_template'] = $data['import_template'] ?? null;
        $this->container['created_at'] = $data['created_at'] ?? null;
        $this->container['metadata'] = $data['metadata'] ?? null;
        $this->container['import_request_json'] = $data['import_request_json'] ?? null;
        $this->container['import_source'] = $data['import_source'] ?? null;
    ...
    {
        $allowedValues = $this->getImportSourceAllowableValues();
        if (!is_null($import_source) && !in_array($import_source, $allowedValues, true)) {
