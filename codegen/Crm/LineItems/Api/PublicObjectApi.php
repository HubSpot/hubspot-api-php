...
class PublicObjectApi
{
     ...
     *
     * @param  \HubSpot\Client\Crm\LineItems\Model\PublicMergeInput $public_merge_input public_merge_input (required)
     *
     ...
     * Merge two line items with same type
     *
     * @param  \HubSpot\Client\Crm\LineItems\Model\PublicMergeInput $public_merge_input (required)
     *
     * @throws \HubSpot\Client\Crm\LineItems\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    public function mergeRequest($public_merge_input)
    {
        ...
        $resourcePath = '/crm/v3/objects/line_items/merge';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
