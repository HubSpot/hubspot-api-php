...
class GDPRApi
{
     ...
     * GDPR DELETE
     *
     * @param  \HubSpot\Client\Crm\LineItems\Model\PublicGdprDeleteInput $public_gdpr_delete_input public_gdpr_delete_input (required)
     ...
     * GDPR DELETE
     *
     * @param  \HubSpot\Client\Crm\LineItems\Model\PublicGdprDeleteInput $public_gdpr_delete_input (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['purge'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Crm\LineItems\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    public function purgeRequest($public_gdpr_delete_input, string $contentType = self::contentTypes['purge'][0])
    {
        ...
        $resourcePath = '/crm/v3/objects/line_items/gdpr-delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
