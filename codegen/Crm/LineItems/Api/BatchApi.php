...
class BatchApi
{
     ...
     * @throws \HubSpot\Client\Crm\LineItems\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\LineItems\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\LineItems\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\LineItems\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\LineItems\Model\BatchResponseSimplePublicObject|\HubSpot\Client\Crm\LineItems\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \HubSpot\Client\Crm\LineItems\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \HubSpot\Client\Crm\LineItems\Model\BatchResponseSimplePublicUpsertObject|\HubSpot\Client\Crm\LineItems\Model\Error
     */
     ...
     * @throws \HubSpot\Client\Crm\LineItems\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \HubSpot\Client\Crm\LineItems\Model\BatchResponseSimplePublicUpsertObject|\HubSpot\Client\Crm\LineItems\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
