...
class BatchApi
{
     ...
     *
     * @param  \HubSpot\Client\Crm\LineItems\Model\BatchInputSimplePublicObjectInputForCreate $batch_input_simple_public_object_input_for_create batch_input_simple_public_object_input_for_create (required)
     ...
     * Create a batch of line items
     *
     * @param  \HubSpot\Client\Crm\LineItems\Model\BatchInputSimplePublicObjectInputForCreate $batch_input_simple_public_object_input_for_create (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['create'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Crm\LineItems\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
