...
class BatchResponseSimplePublicUpsertObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets results
     *
     * @param \HubSpot\Client\Crm\LineItems\Model\SimplePublicUpsertObject[] $results An array of SimplePublicUpsertObject items representing the results of the batch upsert operation.
     *
     * @return self
     */
