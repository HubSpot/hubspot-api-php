...
class PipelineStageAuditsApi
{
     ...
     */
    public function getAudit($object_type, $stage_id, $pipeline_id, string $contentType = self::contentTypes['getAudit'][0])
    {
        list($response) = $this->getAuditWithHttpInfo($object_type, $stage_id, $pipeline_id, $contentType);
        return $response;
    }
     ...
     */
    public function getAuditWithHttpInfo($object_type, $stage_id, $pipeline_id, string $contentType = self::contentTypes['getAudit'][0])
    {
        $request = $this->getAuditRequest($object_type, $stage_id, $pipeline_id, $contentType);
     ...
     */
    public function getAuditAsync($object_type, $stage_id, $pipeline_id, string $contentType = self::contentTypes['getAudit'][0])
    {
        return $this->getAuditAsyncWithHttpInfo($object_type, $stage_id, $pipeline_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAuditAsyncWithHttpInfo($object_type, $stage_id, $pipeline_id, string $contentType = self::contentTypes['getAudit'][0])
    {
     ...
     */
    public function getAuditRequest($object_type, $stage_id, $pipeline_id, string $contentType = self::contentTypes['getAudit'][0])
    {
        ...
        if (!preg_match("/.+/", $pipeline_id)) {
            throw new \InvalidArgumentException("invalid value for \"pipeline_id\" when calling PipelineStageAuditsApi.getAudit, must conform to the pattern /.+/.");
        }
