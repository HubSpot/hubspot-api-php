...
class PipelinesApi
{
     ...
     * @return \HubSpot\Client\Crm\Pipelines\Model\Pipeline|\HubSpot\Client\Crm\Pipelines\Model\Error
     */
    public function getById($object_type, $pipeline_id)
    {
        list($response) = $this->getByIdWithHttpInfo($object_type, $pipeline_id);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Pipelines\Model\Pipeline|\HubSpot\Client\Crm\Pipelines\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getByIdWithHttpInfo($object_type, $pipeline_id)
    {
        $request = $this->getByIdRequest($object_type, $pipeline_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsync($object_type, $pipeline_id)
    {
        return $this->getByIdAsyncWithHttpInfo($object_type, $pipeline_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($object_type, $pipeline_id)
    {
        $returnType = '\HubSpot\Client\Crm\Pipelines\Model\Pipeline';
        $request = $this->getByIdRequest($object_type, $pipeline_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getByIdRequest($object_type, $pipeline_id)
    {
        // verify the required parameter 'object_type' is set
        if ($object_type === null || (is_array($object_type) && count($object_type) === 0)) {
            throw new \InvalidArgumentException(
