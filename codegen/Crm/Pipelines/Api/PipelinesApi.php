...
class PipelinesApi
{
     ...
     */
    public function create($object_type, $pipeline_input)
    {
     ...
     */
    public function createWithHttpInfo($object_type, $pipeline_input)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsync($object_type, $pipeline_input)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createAsyncWithHttpInfo($object_type, $pipeline_input)
    {
        $returnType = '\HubSpot\Client\Crm\Pipelines\Model\Pipeline';
        $request = $this->createRequest($object_type, $pipeline_input);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createRequest($object_type, $pipeline_input)
    {
        // verify the required parameter 'object_type' is set
        if ($object_type === null || (is_array($object_type) && count($object_type) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \HubSpot\Client\Crm\Pipelines\Model\Pipeline|\HubSpot\Client\Crm\Pipelines\Model\Error
     */
    public function update($object_type, $pipeline_id, $pipeline_patch_input, $archived = false, $validate_references_before_delete = false)
    {
        list($response) = $this->updateWithHttpInfo($object_type, $pipeline_id, $pipeline_patch_input, $archived, $validate_references_before_delete);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Pipelines\Model\Pipeline|\HubSpot\Client\Crm\Pipelines\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($object_type, $pipeline_id, $pipeline_patch_input, $archived = false, $validate_references_before_delete = false)
    {
        $request = $this->updateRequest($object_type, $pipeline_id, $pipeline_patch_input, $archived, $validate_references_before_delete);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($object_type, $pipeline_id, $pipeline_patch_input, $archived = false, $validate_references_before_delete = false)
    {
        return $this->updateAsyncWithHttpInfo($object_type, $pipeline_id, $pipeline_patch_input, $archived, $validate_references_before_delete)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($object_type, $pipeline_id, $pipeline_patch_input, $archived = false, $validate_references_before_delete = false)
    {
        $returnType = '\HubSpot\Client\Crm\Pipelines\Model\Pipeline';
        $request = $this->updateRequest($object_type, $pipeline_id, $pipeline_patch_input, $archived, $validate_references_before_delete);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRequest($object_type, $pipeline_id, $pipeline_patch_input, $archived = false, $validate_references_before_delete = false)
    {
        // verify the required parameter 'object_type' is set
        if ($object_type === null || (is_array($object_type) && count($object_type) === 0)) {
            throw new \InvalidArgumentException(
