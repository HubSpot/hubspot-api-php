...
class PipelinesApi
{
     ...
     * Delete a pipeline
     *
     * @param  string $object_type The object type of the pipeline being deleted (ex. deals or tickets) (required)
     * @param  string $pipeline_id The unique identifier of the pipeline to be deleted. (required)
     * @param  bool|null $validate_references_before_delete Indicates whether to validate references before deleting the pipeline. (optional, default to false)
     * @param  bool|null $validate_deal_stage_usages_before_delete Indicates whether to validate deal stage usages before deleting the pipeline. (optional, default to false)
     ...
     * Create a pipeline
     *
     * @param  string $object_type The object type of the pipeline being created (ex. deals or tickets) (required)
     ...
     *
     * @param  string $object_type The object type of the pipelines being retrieved (ex. deals or tickets) (required)
     ...
     *
     * @param  string $object_type The object type of the pipeline being retrieved (ex. deals or tickets) (required)
     * @param  string $pipeline_id The unique identifier of the pipeline to be retrieved. (required)
     ...
     * Replace a pipeline
     *
     * @param  string $object_type The object type of the pipeline being replaced (ex. deals or tickets) (required)
     * @param  string $pipeline_id The unique identifier of the pipeline to be replaced. (required)
     * @param  \HubSpot\Client\Crm\Pipelines\Model\PipelineInput $pipeline_input pipeline_input (required)
     * @param  bool|null $validate_references_before_delete Indicates whether to validate references before deleting the pipeline. (optional, default to false)
     * @param  bool|null $validate_deal_stage_usages_before_delete Indicates whether to validate deal stage usages before deleting the pipeline. (optional, default to false)
     ...
     * @param  string $pipeline_id The unique identifier of the pipeline to be updated. (required)
