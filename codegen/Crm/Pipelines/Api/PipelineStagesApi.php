...
class PipelineStagesApi
{
     ...
     * @return \HubSpot\Client\Crm\Pipelines\Model\PipelineStage|\HubSpot\Client\Crm\Pipelines\Model\Error
     */
    public function update($object_type, $pipeline_id, $stage_id, $pipeline_stage_patch_input, $archived = false)
    {
        list($response) = $this->updateWithHttpInfo($object_type, $pipeline_id, $stage_id, $pipeline_stage_patch_input, $archived);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Crm\Pipelines\Model\PipelineStage|\HubSpot\Client\Crm\Pipelines\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWithHttpInfo($object_type, $pipeline_id, $stage_id, $pipeline_stage_patch_input, $archived = false)
    {
        $request = $this->updateRequest($object_type, $pipeline_id, $stage_id, $pipeline_stage_patch_input, $archived);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsync($object_type, $pipeline_id, $stage_id, $pipeline_stage_patch_input, $archived = false)
    {
        return $this->updateAsyncWithHttpInfo($object_type, $pipeline_id, $stage_id, $pipeline_stage_patch_input, $archived)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAsyncWithHttpInfo($object_type, $pipeline_id, $stage_id, $pipeline_stage_patch_input, $archived = false)
    {
        $returnType = '\HubSpot\Client\Crm\Pipelines\Model\PipelineStage';
        $request = $this->updateRequest($object_type, $pipeline_id, $stage_id, $pipeline_stage_patch_input, $archived);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRequest($object_type, $pipeline_id, $stage_id, $pipeline_stage_patch_input, $archived = false)
    {
        // verify the required parameter 'object_type' is set
        if ($object_type === null || (is_array($object_type) && count($object_type) === 0)) {
            throw new \InvalidArgumentException(
