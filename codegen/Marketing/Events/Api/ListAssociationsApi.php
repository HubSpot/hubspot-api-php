...
class ListAssociationsApi
{
     ...
     * @return void
     */
    public function associateByMarketingEventId($list_id, $marketing_event_id, string $contentType = self::contentTypes['associateByMarketingEventId'][0])
    {
        $this->associateByMarketingEventIdWithHttpInfo($list_id, $marketing_event_id, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function associateByMarketingEventIdWithHttpInfo($list_id, $marketing_event_id, string $contentType = self::contentTypes['associateByMarketingEventId'][0])
    {
        $request = $this->associateByMarketingEventIdRequest($list_id, $marketing_event_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function associateByMarketingEventIdAsync($list_id, $marketing_event_id, string $contentType = self::contentTypes['associateByMarketingEventId'][0])
    {
        return $this->associateByMarketingEventIdAsyncWithHttpInfo($list_id, $marketing_event_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function associateByMarketingEventIdAsyncWithHttpInfo($list_id, $marketing_event_id, string $contentType = self::contentTypes['associateByMarketingEventId'][0])
    {
        $returnType = '';
        $request = $this->associateByMarketingEventIdRequest($list_id, $marketing_event_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function associateByMarketingEventIdRequest($list_id, $marketing_event_id, string $contentType = self::contentTypes['associateByMarketingEventId'][0])
    {
     ...
     * @return void
     */
    public function disassociateByMarketingEventId($list_id, $marketing_event_id, string $contentType = self::contentTypes['disassociateByMarketingEventId'][0])
    {
        $this->disassociateByMarketingEventIdWithHttpInfo($list_id, $marketing_event_id, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function disassociateByMarketingEventIdWithHttpInfo($list_id, $marketing_event_id, string $contentType = self::contentTypes['disassociateByMarketingEventId'][0])
    {
        $request = $this->disassociateByMarketingEventIdRequest($list_id, $marketing_event_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function disassociateByMarketingEventIdAsync($list_id, $marketing_event_id, string $contentType = self::contentTypes['disassociateByMarketingEventId'][0])
    {
        return $this->disassociateByMarketingEventIdAsyncWithHttpInfo($list_id, $marketing_event_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function disassociateByMarketingEventIdAsyncWithHttpInfo($list_id, $marketing_event_id, string $contentType = self::contentTypes['disassociateByMarketingEventId'][0])
    {
        $returnType = '';
        $request = $this->disassociateByMarketingEventIdRequest($list_id, $marketing_event_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function disassociateByMarketingEventIdRequest($list_id, $marketing_event_id, string $contentType = self::contentTypes['disassociateByMarketingEventId'][0])
    {
