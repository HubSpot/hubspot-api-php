...
class BatchApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['doUpsert'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Marketing\Events\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function doUpsert($batch_input_marketing_event_create_request_params, string $contentType = self::contentTypes['doUpsert'][0])
    {
        list($response) = $this->doUpsertWithHttpInfo($batch_input_marketing_event_create_request_params, $contentType);
        return $response;
    }
     ...
     */
    public function doUpsertWithHttpInfo($batch_input_marketing_event_create_request_params, string $contentType = self::contentTypes['doUpsert'][0])
    {
        $request = $this->doUpsertRequest($batch_input_marketing_event_create_request_params, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doUpsertAsync($batch_input_marketing_event_create_request_params, string $contentType = self::contentTypes['doUpsert'][0])
    {
        return $this->doUpsertAsyncWithHttpInfo($batch_input_marketing_event_create_request_params, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doUpsertAsyncWithHttpInfo($batch_input_marketing_event_create_request_params, string $contentType = self::contentTypes['doUpsert'][0])
    {
        $returnType = '\HubSpot\Client\Marketing\Events\Model\BatchResponseMarketingEventPublicDefaultResponse';
        $request = $this->doUpsertRequest($batch_input_marketing_event_create_request_params, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function doUpsertRequest($batch_input_marketing_event_create_request_params, string $contentType = self::contentTypes['doUpsert'][0])
    {
