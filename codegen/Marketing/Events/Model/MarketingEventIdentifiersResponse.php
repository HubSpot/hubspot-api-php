...
class MarketingEventIdentifiersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $external_account_id The accountId that is associated with this marketing event in the external event application
     *
     * @return self
     */
     ...
     *
     * @param string $external_event_id The ID that is associated with this marketing event in the external event application
     *
     * @return self
     */
     ...
     *
     * @param string $marketing_event_name The name of the marketing event
     *
     * @return self
     */
     ...
     * Sets object_id
     *
     * @param string $object_id The internal ID of the marketing event in HubSpot CRM
     *
     * @return self
     */
