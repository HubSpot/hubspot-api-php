...
/**
 * MarketingEventDefaultResponse Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Marketing\Events
 * @author   OpenAPI Generator team
 ...
 */
class MarketingEventDefaultResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarketingEventDefaultResponse';
    ...
    */
     ...
     * Sets event_url
     *
     * @param string|null $event_url The URL in the external event application where the marketing event can be managed.
     *
     * @return self
     */
