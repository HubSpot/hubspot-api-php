...
/**
 * BatchResponseMarketingEventPublicDefaultResponse Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Marketing\Events
 * @author   OpenAPI Generator team
 ...
 */
class BatchResponseMarketingEventPublicDefaultResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchResponseMarketingEventPublicDefaultResponse';
    ...
    */
     ...
     * Sets completed_at
     *
     * @param \DateTime $completed_at Timestamp of when the request was completed.
     *
     * @return self
     */
     ...
     * Sets num_errors
     *
     * @param int|null $num_errors The number of errors that occurred during the request.
     *
     * @return self
     */
     ...
     * Sets requested_at
     *
     * @param \DateTime|null $requested_at Timestamp of when the request was sent.
     *
     * @return self
     */
     ...
     * Sets started_at
     *
     * @param \DateTime $started_at Timestamp of when the request started processing.
     *
     * @return self
     */
