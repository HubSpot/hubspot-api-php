...
/**
 * MarketingEventEmailSubscriber Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Marketing\Events
 * @author   OpenAPI Generator team
 ...
 */
class MarketingEventEmailSubscriber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarketingEventEmailSubscriber';
    ...
    */
     ...
     *
     * @param array<string,string> $contact_properties The key-value set that contains properties of the contact.
     *
     * @return self
     */
     ...
     * Sets properties
     *
     * @param array<string,string> $properties The key-value set that contains properties of the marketing event.
     *
     * @return self
     */
