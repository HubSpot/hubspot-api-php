...
class MarketingEventAssociation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $external_account_id The account ID that is associated with this marketing event in the external event application
     *
     * @return self
     */
     ...
     *
     * @param string|null $external_event_id The event ID that is associated with this marketing event in the external event application
     *
     * @return self
     */
     ...
     *
     * @param string $marketing_event_id The internal ID of the marketing event in HubSpot
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The name of the marketing event in HubSpot
     *
     * @return self
     */
