...
/**
 * SearchPublicResponseWrapper Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Marketing\Events
 * @author   OpenAPI Generator team
 ...
 */
class SearchPublicResponseWrapper implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SearchPublicResponseWrapper';
    ...
    */
     ...
     * Sets app_id
     *
     * @param int $app_id The ID of the source application of the marketing event
     *
     * @return self
     */
     ...
     *
     * @param string $external_account_id The account ID associated with this marketing event in the external application
     *
     * @return self
     */
