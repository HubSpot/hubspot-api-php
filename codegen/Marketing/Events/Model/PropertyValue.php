...
class PropertyValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const SOURCE_CONTACTS_WEB = 'CONTACTS_WEB';
    const SOURCE_WAL_INCREMENTAL = 'WAL_INCREMENTAL';
    const SOURCE_TASK = 'TASK';
    const SOURCE_EMAIL = 'EMAIL';
    const SOURCE_WORKFLOWS = 'WORKFLOWS';
    const SOURCE_CALCULATED = 'CALCULATED';
    const SOURCE_SOCIAL = 'SOCIAL';
    const SOURCE_BATCH_UPDATE = 'BATCH_UPDATE';
    const SOURCE_SIGNALS = 'SIGNALS';
    const SOURCE_BIDEN = 'BIDEN';
    const SOURCE__DEFAULT = 'DEFAULT';
    const SOURCE_COMPANIES = 'COMPANIES';
    const SOURCE_DEALS = 'DEALS';
    const SOURCE_ASSISTS = 'ASSISTS';
    const SOURCE_PRESENTATIONS = 'PRESENTATIONS';
    const SOURCE_TALLY = 'TALLY';
    const SOURCE_SIDEKICK = 'SIDEKICK';
    const SOURCE_CRM_UI = 'CRM_UI';
    const SOURCE_MERGE_CONTACTS = 'MERGE_CONTACTS';
    const SOURCE_PORTAL_USER_ASSOCIATOR = 'PORTAL_USER_ASSOCIATOR';
    const SOURCE_INTEGRATIONS_PLATFORM = 'INTEGRATIONS_PLATFORM';
    const SOURCE_BCC_TO_CRM = 'BCC_TO_CRM';
    const SOURCE_FORWARD_TO_CRM = 'FORWARD_TO_CRM';
    const SOURCE_ENGAGEMENTS = 'ENGAGEMENTS';
    const SOURCE_SALES = 'SALES';
    const SOURCE_HEISENBERG = 'HEISENBERG';
    const SOURCE_LEADIN = 'LEADIN';
    const SOURCE_GMAIL_INTEGRATION = 'GMAIL_INTEGRATION';
    const SOURCE_ACADEMY = 'ACADEMY';
    const SOURCE_SALES_MESSAGES = 'SALES_MESSAGES';
    const SOURCE_AVATARS_SERVICE = 'AVATARS_SERVICE';
    const SOURCE_MERGE_COMPANIES = 'MERGE_COMPANIES';
    const SOURCE_SEQUENCES = 'SEQUENCES';
    const SOURCE_COMPANY_FAMILIES = 'COMPANY_FAMILIES';
    const SOURCE_MOBILE_IOS = 'MOBILE_IOS';
    const SOURCE_MOBILE_ANDROID = 'MOBILE_ANDROID';
    const SOURCE_CONTACTS = 'CONTACTS';
    const SOURCE_ASSOCIATIONS = 'ASSOCIATIONS';
    const SOURCE_EXTENSION = 'EXTENSION';
    const SOURCE_SUCCESS = 'SUCCESS';
    const SOURCE_BOT = 'BOT';
    const SOURCE_INTEGRATIONS_SYNC = 'INTEGRATIONS_SYNC';
    const SOURCE_AUTOMATION_PLATFORM = 'AUTOMATION_PLATFORM';
    const SOURCE_CONVERSATIONS = 'CONVERSATIONS';
    const SOURCE_EMAIL_INTEGRATION = 'EMAIL_INTEGRATION';
    const SOURCE_CONTENT_MEMBERSHIP = 'CONTENT_MEMBERSHIP';
    const SOURCE_QUOTES = 'QUOTES';
    const SOURCE_BET_ASSIGNMENT = 'BET_ASSIGNMENT';
    const SOURCE_QUOTAS = 'QUOTAS';
    const SOURCE_BET_CRM_CONNECTOR = 'BET_CRM_CONNECTOR';
    const SOURCE_MEETINGS = 'MEETINGS';
    const SOURCE_MERGE_OBJECTS = 'MERGE_OBJECTS';
    const SOURCE_RECYCLING_BIN = 'RECYCLING_BIN';
    const SOURCE_ADS = 'ADS';
    const SOURCE_AI_GROUP = 'AI_GROUP';
    const SOURCE_COMMUNICATOR = 'COMMUNICATOR';
    const SOURCE_SETTINGS = 'SETTINGS';
    const SOURCE_PROPERTY_SETTINGS = 'PROPERTY_SETTINGS';
    const SOURCE_PIPELINE_SETTINGS = 'PIPELINE_SETTINGS';
    const SOURCE_COMPANY_INSIGHTS = 'COMPANY_INSIGHTS';
    const SOURCE_BEHAVIORAL_EVENTS = 'BEHAVIORAL_EVENTS';
    const SOURCE_PAYMENTS = 'PAYMENTS';
    const SOURCE_GOALS = 'GOALS';
    const SOURCE_PORTAL_OBJECT_SYNC = 'PORTAL_OBJECT_SYNC';
    const SOURCE_APPROVALS = 'APPROVALS';
