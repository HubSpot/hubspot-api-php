...
class PropertyValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $data_sensitivity Level of data sensitivity
     *
     * @return self
     */
     ...
     * Sets is_encrypted
     *
     * @param bool $is_encrypted Indicates whether the property is encrypted
     *
     * @return self
     */
     ...
     * Sets is_large_value
     *
     * @param bool $is_large_value Indicates whether the property value is stored as a large value in the storage
     *
     * @return self
     */
     ...
     *
     * @param int $persistence_timestamp The timestamp that indicates when the value being written is persisted in storage
     *
     * @return self
     */
     ...
     *
     * @param bool $selected_by_user Indicates whether the property is selected
     *
     * @return self
     */
     ...
     *
     * @param int $selected_by_user_timestamp Timestamp of when the property was selected by the user
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string $source Source of the property
     *
     * @return self
     */
     ...
     * Sets source_id
     *
     * @param string $source_id ID of the source of the property
     *
     * @return self
     */
     ...
     * Sets source_label
     *
     * @param string $source_label Label of the source of the property
     *
     * @return self
     */
     ...
     *
     * @param string $source_metadata Source metadata encoded as a base64 string
     *
     * @return self
     */
     ...
     *
     * @param string $source_upstream_deployable Indicates which upstream service made the property change
     *
     * @return self
     */
     ...
     *
     * @param int $updated_by_user_id The ID of the user who last updated the property
     *
     * @return self
     */
     ...
     *
     * @param bool $use_timestamp_as_persistence_timestamp Indicates if the persistence timestamp is the same as storage version timestamp
     *
     * @return self
     */
