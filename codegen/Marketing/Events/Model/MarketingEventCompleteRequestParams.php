...
/**
 * MarketingEventCompleteRequestParams Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Marketing\Events
 * @author   OpenAPI Generator team
 ...
 */
class MarketingEventCompleteRequestParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarketingEventCompleteRequestParams';
    ...
    */
     ...
     * Sets end_date_time
     *
     * @param \DateTime $end_date_time The end date and time of the marketing event in ISO 8601 format
     *
     * @return self
     */
     ...
     *
     * @param \DateTime $start_date_time The start date and time of the marketing event in ISO 8601 format
     *
     * @return self
     */
