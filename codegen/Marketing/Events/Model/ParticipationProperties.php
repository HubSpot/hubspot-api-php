...
class ParticipationProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param int|null $attendance_duration_seconds The number of seconds the participation lasted
     *
     * @return self
     */
     ...
     *
     * @param string|null $attendance_percentage Percentage of the participation duration relative to the event duration
     *
     * @return self
     */
     ...
     *
     * @param string $attendance_state The state of the participation
     *
     * @return self
     */
     ...
     * Sets occurred_at
     *
     * @param int $occurred_at Timestamp of when the participation occurred
     *
     * @return self
     */
