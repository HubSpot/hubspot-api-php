...
class MarketingEmailsApi
{
     ...
     * @param  bool $include_stats Include statistics with email (optional)
     * @param  bool $marketing_campaign_names marketing_campaign_names (optional)
     * @param  bool $workflow_names workflow_names (optional)
     * @param  string[] $included_properties included_properties (optional)
     * @param  bool $archived Whether to return only results that have been archived. (optional)
     ...
     * @param  string $email_id The marketing email ID. (required)
     * @param  bool $include_stats Include statistics with email (optional)
     * @param  bool $marketing_campaign_names (optional)
     * @param  bool $workflow_names (optional)
     * @param  string[] $included_properties (optional)
     * @param  bool $archived Whether to return only results that have been archived. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getById'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Marketing\Emails\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     *
     * @param  \DateTime $created_at Only return emails created at exactly the specified time. (optional)
     * @param  \DateTime $created_after Only return emails created after the specified time. (optional)
     * @param  \DateTime $created_before Only return emails created before the specified time. (optional)
     * @param  \DateTime $updated_at Only return emails last updated at exactly the specified time. (optional)
     * @param  \DateTime $updated_after Only return emails last updated after the specified time. (optional)
     * @param  \DateTime $updated_before Only return emails last updated before the specified time. (optional)
     ...
     * @param  bool $include_stats Include statistics with emails. (optional)
     * @param  bool $marketing_campaign_names marketing_campaign_names (optional)
     * @param  bool $workflow_names workflow_names (optional)
     * @param  string $type Email types to be filtered by. Multiple types can be included. All emails will be returned if not present. (optional)
     * @param  bool $is_published Filter by published/draft emails. All emails will be returned if not present. (optional)
     * @param  string[] $included_properties included_properties (optional)
     * @param  bool $archived Specifies whether to return archived emails. Defaults to &#x60;false&#x60;. (optional)
     ...
     * @param  string $email_id The marketing email ID. (required)
     * @param  string $after The cursor token value to get the next set of results. You can get this from the &#x60;paging.next.after&#x60; JSON property of a paged response containing more results. (optional)
     * @param  string $before The cursor token value to get the previous set of results. You can get this from the &#x60;paging.prev.before&#x60; JSON property of a paged response containing more results. (optional)
     * @param  int $limit The maximum number of results to return. Default is 100. (optional)
