...
class StatisticsApi
{
     ...
     *
     * @param  string $start_timestamp The start timestamp of the time span, in ISO8601 representation. (optional)
     * @param  string $end_timestamp The end timestamp of the time span, in ISO8601 representation. (optional)
     * @param  int[] $email_ids Filter by email IDs. Only include statistics of emails with these IDs. (optional)
     * @param  string $property Specifies which email properties should be returned. All properties will be returned by default. (optional)
     ...
     *
     * @param  string $interval The interval to aggregate statistics for. (optional)
     * @param  string $start_timestamp The start timestamp of the time span, in ISO8601 representation. (optional)
     * @param  string $end_timestamp The end timestamp of the time span, in ISO8601 representation. (optional)
     * @param  int[] $email_ids Filter by email IDs. Only include statistics of emails with these IDs. (optional)
