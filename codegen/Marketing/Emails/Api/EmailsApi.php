...
class EmailsApi
{
     ...
     *
     * @param  \HubSpot\Client\Marketing\Emails\Model\EmailCloneRequestVNext $email_clone_request_v_next email_clone_request_v_next (required)
     ...
     */
    public function callClone($email_clone_request_v_next, string $contentType = self::contentTypes['callClone'][0])
    {
        list($response) = $this->callCloneWithHttpInfo($email_clone_request_v_next, $contentType);
        return $response;
    }
     ...
     * Clone a marketing email
     *
     * @param  \HubSpot\Client\Marketing\Emails\Model\EmailCloneRequestVNext $email_clone_request_v_next (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['callClone'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Marketing\Emails\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function callCloneWithHttpInfo($email_clone_request_v_next, string $contentType = self::contentTypes['callClone'][0])
    {
        $request = $this->callCloneRequest($email_clone_request_v_next, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function callCloneAsync($email_clone_request_v_next, string $contentType = self::contentTypes['callClone'][0])
    {
        return $this->callCloneAsyncWithHttpInfo($email_clone_request_v_next, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function callCloneAsyncWithHttpInfo($email_clone_request_v_next, string $contentType = self::contentTypes['callClone'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function callCloneRequest($email_clone_request_v_next, string $contentType = self::contentTypes['callClone'][0])
    {

        // verify the required parameter 'email_clone_request_v_next' is set
        if ($email_clone_request_v_next === null || (is_array($email_clone_request_v_next) && count($email_clone_request_v_next) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_clone_request_v_next when calling callClone'
            );
        }
        ...
        if (isset($email_clone_request_v_next)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($email_clone_request_v_next), JSON_THROW_ON_ERROR);
            } else {
     ...
     * @return \HubSpot\Client\Marketing\Emails\Model\PublicEmail|\HubSpot\Client\Marketing\Emails\Model\Error
     */
    public function getAbTestVariation($email_id, $archived = null, $included_properties = null, $include_stats = null, $marketing_campaign_names = null, $variant_stats = null, $workflow_names = null, string $contentType = self::contentTypes['getAbTestVariation'][0])
    {
        list($response) = $this->getAbTestVariationWithHttpInfo($email_id, $archived, $included_properties, $include_stats, $marketing_campaign_names, $variant_stats, $workflow_names, $contentType);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Marketing\Emails\Model\PublicEmail|\HubSpot\Client\Marketing\Emails\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAbTestVariationWithHttpInfo($email_id, $archived = null, $included_properties = null, $include_stats = null, $marketing_campaign_names = null, $variant_stats = null, $workflow_names = null, string $contentType = self::contentTypes['getAbTestVariation'][0])
    {
        $request = $this->getAbTestVariationRequest($email_id, $archived, $included_properties, $include_stats, $marketing_campaign_names, $variant_stats, $workflow_names, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAbTestVariationAsync($email_id, $archived = null, $included_properties = null, $include_stats = null, $marketing_campaign_names = null, $variant_stats = null, $workflow_names = null, string $contentType = self::contentTypes['getAbTestVariation'][0])
    {
        return $this->getAbTestVariationAsyncWithHttpInfo($email_id, $archived, $included_properties, $include_stats, $marketing_campaign_names, $variant_stats, $workflow_names, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAbTestVariationAsyncWithHttpInfo($email_id, $archived = null, $included_properties = null, $include_stats = null, $marketing_campaign_names = null, $variant_stats = null, $workflow_names = null, string $contentType = self::contentTypes['getAbTestVariation'][0])
    {
        $returnType = '\HubSpot\Client\Marketing\Emails\Model\PublicEmail';
        $request = $this->getAbTestVariationRequest($email_id, $archived, $included_properties, $include_stats, $marketing_campaign_names, $variant_stats, $workflow_names, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAbTestVariationRequest($email_id, $archived = null, $included_properties = null, $include_stats = null, $marketing_campaign_names = null, $variant_stats = null, $workflow_names = null, string $contentType = self::contentTypes['getAbTestVariation'][0])
    {
    ...
    public function updateRequest($email_id, $email_update_request, $archived = null, string $contentType = self::contentTypes['update'][0])
    {
        ...
        if (isset($email_update_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($email_update_request), JSON_THROW_ON_ERROR);
            } else {
