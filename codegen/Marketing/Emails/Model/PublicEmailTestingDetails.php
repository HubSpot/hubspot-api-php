...
class PublicEmailTestingDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'is_ab_variation' => 'setIsAbVariation',
        'test_id' => 'setTestId'
    ];
    ...
    protected static $getters = [
        ...
        'is_ab_variation' => 'getIsAbVariation',
        'test_id' => 'getTestId'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_ab_variation', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets is_ab_variation
     *
     * @return bool|null
     */
    public function getIsAbVariation()
    {
        return $this->container['is_ab_variation'];
    }

    /**
     * Sets is_ab_variation
     *
     * @param bool|null $is_ab_variation is_ab_variation
     *
     * @return self
     */
    public function setIsAbVariation($is_ab_variation)
    {
        if (is_null($is_ab_variation)) {
            throw new \InvalidArgumentException('non-nullable is_ab_variation cannot be null');
        }
        $this->container['is_ab_variation'] = $is_ab_variation;
