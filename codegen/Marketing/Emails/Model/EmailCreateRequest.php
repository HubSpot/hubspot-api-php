...
/**
 * EmailCreateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class EmailCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailCreateRequest';
    ...
    public const SUBCATEGORY_AB_LOSER_VARIANT = 'ab_loser_variant';
    public const SUBCATEGORY_AB_LOSER_VARIANT_SITE_PAGE = 'ab_loser_variant_site_page';
    public const SUBCATEGORY_AB_MASTER = 'ab_master';
    public const SUBCATEGORY_AB_MASTER_SITE_PAGE = 'ab_master_site_page';
    public const SUBCATEGORY_AB_VARIANT = 'ab_variant';
    public const SUBCATEGORY_AB_VARIANT_SITE_PAGE = 'ab_variant_site_page';
    public const SUBCATEGORY_AUTOMATED = 'automated';
    public const SUBCATEGORY_AUTOMATED_AB_MASTER = 'automated_ab_master';
    public const SUBCATEGORY_AUTOMATED_AB_VARIANT = 'automated_ab_variant';
    public const SUBCATEGORY_AUTOMATED_FOR_CRM = 'automated_for_crm';
    public const SUBCATEGORY_AUTOMATED_FOR_CUSTOM_SURVEY = 'automated_for_custom_survey';
    public const SUBCATEGORY_AUTOMATED_FOR_DEAL = 'automated_for_deal';
    public const SUBCATEGORY_AUTOMATED_FOR_FEEDBACK_CES = 'automated_for_feedback_ces';
    public const SUBCATEGORY_AUTOMATED_FOR_FEEDBACK_CUSTOM = 'automated_for_feedback_custom';
    public const SUBCATEGORY_AUTOMATED_FOR_FEEDBACK_NPS = 'automated_for_feedback_nps';
    public const SUBCATEGORY_AUTOMATED_FOR_FORM = 'automated_for_form';
    public const SUBCATEGORY_AUTOMATED_FOR_FORM_BUFFER = 'automated_for_form_buffer';
    public const SUBCATEGORY_AUTOMATED_FOR_FORM_DRAFT = 'automated_for_form_draft';
    public const SUBCATEGORY_AUTOMATED_FOR_FORM_LEGACY = 'automated_for_form_legacy';
    public const SUBCATEGORY_AUTOMATED_FOR_LEADFLOW = 'automated_for_leadflow';
    public const SUBCATEGORY_AUTOMATED_FOR_TICKET = 'automated_for_ticket';
    public const SUBCATEGORY_BATCH = 'batch';
    public const SUBCATEGORY_BLOG_ARTICLE_INSTANCE_LAYOUT = 'blog_article_instance_layout';
    public const SUBCATEGORY_BLOG_ARTICLE_LISTING = 'blog_article_listing';
    public const SUBCATEGORY_BLOG_AUTHOR_DETAIL = 'blog_author_detail';
    public const SUBCATEGORY_BLOG_EMAIL = 'blog_email';
    public const SUBCATEGORY_BLOG_EMAIL_CHILD = 'blog_email_child';
    public const SUBCATEGORY_CASE_STUDY = 'case_study';
    public const SUBCATEGORY_CASE_STUDY_INSTANCE_LAYOUT = 'case_study_instance_layout';
    public const SUBCATEGORY_CASE_STUDY_LISTING = 'case_study_listing';
    public const SUBCATEGORY_DISCARDABLE_STUB = 'discardable_stub';
    public const SUBCATEGORY_IMPORTED_BLOG_POST = 'imported_blog_post';
    public const SUBCATEGORY_KB_404_PAGE = 'kb_404_page';
    public const SUBCATEGORY_KB_ARTICLE_INSTANCE_LAYOUT = 'kb_article_instance_layout';
    public const SUBCATEGORY_KB_LISTING = 'kb_listing';
    public const SUBCATEGORY_KB_SEARCH_RESULTS = 'kb_search_results';
    public const SUBCATEGORY_KB_SUPPORT_FORM = 'kb_support_form';
    public const SUBCATEGORY_LANDING_PAGE = 'landing_page';
    public const SUBCATEGORY_LEGACY_BLOG_POST = 'legacy_blog_post';
    public const SUBCATEGORY_LEGACY_PAGE = 'legacy_page';
    public const SUBCATEGORY_LOCALTIME = 'localtime';
    public const SUBCATEGORY_MANAGE_PREFERENCES_EMAIL = 'manage_preferences_email';
    public const SUBCATEGORY_MARKETING_SINGLE_SEND_API = 'marketing_single_send_api';
    public const SUBCATEGORY_MEMBERSHIP_EMAIL_VERIFICATION = 'membership_email_verification';
    public const SUBCATEGORY_MEMBERSHIP_FOLLOW_UP = 'membership_follow_up';
    public const SUBCATEGORY_MEMBERSHIP_OTP_LOGIN = 'membership_otp_login';
    public const SUBCATEGORY_MEMBERSHIP_PASSWORD_RESET = 'membership_password_reset';
    public const SUBCATEGORY_MEMBERSHIP_PASSWORD_SAVED = 'membership_password_saved';
    public const SUBCATEGORY_MEMBERSHIP_PASSWORDLESS_AUTH = 'membership_passwordless_auth';
    public const SUBCATEGORY_MEMBERSHIP_REGISTRATION = 'membership_registration';
    public const SUBCATEGORY_MEMBERSHIP_REGISTRATION_FOLLOW_UP = 'membership_registration_follow_up';
    public const SUBCATEGORY_MEMBERSHIP_VERIFICATION = 'membership_verification';
    public const SUBCATEGORY_NORMAL_BLOG_POST = 'normal_blog_post';
    public const SUBCATEGORY_OPTIN_EMAIL = 'optin_email';
    public const SUBCATEGORY_OPTIN_FOLLOWUP_EMAIL = 'optin_followup_email';
    public const SUBCATEGORY_PAGE_INSTANCE_LAYOUT = 'page_instance_layout';
    public const SUBCATEGORY_PAGE_STUB = 'page_stub';
    public const SUBCATEGORY_PERFORMABLE_LANDING_PAGE = 'performable_landing_page';
    public const SUBCATEGORY_PERFORMABLE_LANDING_PAGE_CUTOVER = 'performable_landing_page_cutover';
    public const SUBCATEGORY_PODCAST_INSTANCE_LAYOUT = 'podcast_instance_layout';
    public const SUBCATEGORY_PODCAST_LISTING = 'podcast_listing';
    public const SUBCATEGORY_PORTAL_CONTENT = 'portal_content';
    public const SUBCATEGORY_RESUBSCRIBE_CONFIRMATION_EMAIL = 'resubscribe_confirmation_email';
    public const SUBCATEGORY_RESUBSCRIBE_EMAIL = 'resubscribe_email';
    public const SUBCATEGORY_RSS_TO_EMAIL = 'rss_to_email';
    public const SUBCATEGORY_RSS_TO_EMAIL_CHILD = 'rss_to_email_child';
    public const SUBCATEGORY_SCP_INSTANCE_LAYOUT_PAGE = 'scp_instance_layout_page';
    public const SUBCATEGORY_SCP_STATIC_PAGE = 'scp_static_page';
    public const SUBCATEGORY_SINGLE_SEND_API = 'single_send_api';
    public const SUBCATEGORY_SITE_PAGE = 'site_page';
    public const SUBCATEGORY_SMTP_TOKEN = 'smtp_token';
    public const SUBCATEGORY_STAGED_PAGE = 'staged_page';
    public const SUBCATEGORY_TICKET_CLOSED_KICKBACK_EMAIL = 'ticket_closed_kickback_email';
    public const SUBCATEGORY_TICKET_OPENED_KICKBACK_EMAIL = 'ticket_opened_kickback_email';
    public const SUBCATEGORY_TICKET_PIPELINE_AUTOMATED = 'ticket_pipeline_automated';
    public const SUBCATEGORY_UNKNOWN = 'UNKNOWN';
    public const SUBCATEGORY_UNSUBSCRIBE_CONFIRMATION_EMAIL = 'unsubscribe_confirmation_email';
    public const SUBCATEGORY_WEB_INTERACTIVE = 'web_interactive';
    ...
    {
        return [
            self::SUBCATEGORY_AB_LOSER_VARIANT,
            self::SUBCATEGORY_AB_LOSER_VARIANT_SITE_PAGE,
            self::SUBCATEGORY_AB_MASTER,
            self::SUBCATEGORY_AB_MASTER_SITE_PAGE,
            self::SUBCATEGORY_AB_VARIANT,
            self::SUBCATEGORY_AB_VARIANT_SITE_PAGE,
            self::SUBCATEGORY_AUTOMATED,
            self::SUBCATEGORY_AUTOMATED_AB_MASTER,
            self::SUBCATEGORY_AUTOMATED_AB_VARIANT,
            self::SUBCATEGORY_AUTOMATED_FOR_CRM,
            self::SUBCATEGORY_AUTOMATED_FOR_CUSTOM_SURVEY,
            self::SUBCATEGORY_AUTOMATED_FOR_DEAL,
            self::SUBCATEGORY_AUTOMATED_FOR_FEEDBACK_CES,
            self::SUBCATEGORY_AUTOMATED_FOR_FEEDBACK_CUSTOM,
            self::SUBCATEGORY_AUTOMATED_FOR_FEEDBACK_NPS,
            self::SUBCATEGORY_AUTOMATED_FOR_FORM,
            self::SUBCATEGORY_AUTOMATED_FOR_FORM_BUFFER,
            self::SUBCATEGORY_AUTOMATED_FOR_FORM_DRAFT,
            self::SUBCATEGORY_AUTOMATED_FOR_FORM_LEGACY,
            self::SUBCATEGORY_AUTOMATED_FOR_LEADFLOW,
            self::SUBCATEGORY_AUTOMATED_FOR_TICKET,
            self::SUBCATEGORY_BATCH,
            self::SUBCATEGORY_BLOG_ARTICLE_INSTANCE_LAYOUT,
            self::SUBCATEGORY_BLOG_ARTICLE_LISTING,
            self::SUBCATEGORY_BLOG_AUTHOR_DETAIL,
            self::SUBCATEGORY_BLOG_EMAIL,
            self::SUBCATEGORY_BLOG_EMAIL_CHILD,
            self::SUBCATEGORY_CASE_STUDY,
            self::SUBCATEGORY_CASE_STUDY_INSTANCE_LAYOUT,
            self::SUBCATEGORY_CASE_STUDY_LISTING,
            self::SUBCATEGORY_DISCARDABLE_STUB,
            self::SUBCATEGORY_IMPORTED_BLOG_POST,
            self::SUBCATEGORY_KB_404_PAGE,
            self::SUBCATEGORY_KB_ARTICLE_INSTANCE_LAYOUT,
            self::SUBCATEGORY_KB_LISTING,
            self::SUBCATEGORY_KB_SEARCH_RESULTS,
            self::SUBCATEGORY_KB_SUPPORT_FORM,
            self::SUBCATEGORY_LANDING_PAGE,
            self::SUBCATEGORY_LEGACY_BLOG_POST,
            self::SUBCATEGORY_LEGACY_PAGE,
            self::SUBCATEGORY_LOCALTIME,
            self::SUBCATEGORY_MANAGE_PREFERENCES_EMAIL,
            self::SUBCATEGORY_MARKETING_SINGLE_SEND_API,
            self::SUBCATEGORY_MEMBERSHIP_EMAIL_VERIFICATION,
            self::SUBCATEGORY_MEMBERSHIP_FOLLOW_UP,
            self::SUBCATEGORY_MEMBERSHIP_OTP_LOGIN,
            self::SUBCATEGORY_MEMBERSHIP_PASSWORD_RESET,
            self::SUBCATEGORY_MEMBERSHIP_PASSWORD_SAVED,
            self::SUBCATEGORY_MEMBERSHIP_PASSWORDLESS_AUTH,
            self::SUBCATEGORY_MEMBERSHIP_REGISTRATION,
            self::SUBCATEGORY_MEMBERSHIP_REGISTRATION_FOLLOW_UP,
            self::SUBCATEGORY_MEMBERSHIP_VERIFICATION,
            self::SUBCATEGORY_NORMAL_BLOG_POST,
            self::SUBCATEGORY_OPTIN_EMAIL,
            self::SUBCATEGORY_OPTIN_FOLLOWUP_EMAIL,
            self::SUBCATEGORY_PAGE_INSTANCE_LAYOUT,
            self::SUBCATEGORY_PAGE_STUB,
            self::SUBCATEGORY_PERFORMABLE_LANDING_PAGE,
            self::SUBCATEGORY_PERFORMABLE_LANDING_PAGE_CUTOVER,
            self::SUBCATEGORY_PODCAST_INSTANCE_LAYOUT,
            self::SUBCATEGORY_PODCAST_LISTING,
            self::SUBCATEGORY_PORTAL_CONTENT,
            self::SUBCATEGORY_RESUBSCRIBE_CONFIRMATION_EMAIL,
            self::SUBCATEGORY_RESUBSCRIBE_EMAIL,
            self::SUBCATEGORY_RSS_TO_EMAIL,
            self::SUBCATEGORY_RSS_TO_EMAIL_CHILD,
            self::SUBCATEGORY_SCP_INSTANCE_LAYOUT_PAGE,
            self::SUBCATEGORY_SCP_STATIC_PAGE,
            self::SUBCATEGORY_SINGLE_SEND_API,
            self::SUBCATEGORY_SITE_PAGE,
            self::SUBCATEGORY_SMTP_TOKEN,
            self::SUBCATEGORY_STAGED_PAGE,
            self::SUBCATEGORY_TICKET_CLOSED_KICKBACK_EMAIL,
            self::SUBCATEGORY_TICKET_OPENED_KICKBACK_EMAIL,
            self::SUBCATEGORY_TICKET_PIPELINE_AUTOMATED,
            self::SUBCATEGORY_UNKNOWN,
            self::SUBCATEGORY_UNSUBSCRIBE_CONFIRMATION_EMAIL,
            self::SUBCATEGORY_WEB_INTERACTIVE,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['subcategory']) && !in_array($this->container['subcategory'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'subcategory', must be one of '%s'",
                $this->container['subcategory'],
                implode("', '", $allowedValues)
            );
        }
     ...
     *
     * @param int|null $business_unit_id The ID of the business unit associated with the email.
     *
     * @return self
     */
     ...
     * Sets folder_id_v2
     *
     * @param int|null $folder_id_v2 The ID of the folder where the email will be stored.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $jitter_send_time Determines whether the email send time should be randomized to avoid sending all emails at the exact same time.
     *
     * @return self
     */
     ...
     * Sets language
     *
     * @param string|null $language The language code for the email, such as 'en' for English.
     *
     * @return self
     */
