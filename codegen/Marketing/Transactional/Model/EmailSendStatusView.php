...
class EmailSendStatusView implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const SEND_RESULT_ATTACHMENT_DOWNLOAD_QUEUE_FULL = 'ATTACHMENT_DOWNLOAD_QUEUE_FULL';
    public const SEND_RESULT_BLOCKED_ADDRESS = 'BLOCKED_ADDRESS';
    public const SEND_RESULT_BLOCKED_DOMAIN = 'BLOCKED_DOMAIN';
    public const SEND_RESULT_BRAND_RECIPIENT_FATIGUE_SUPPRESSED = 'BRAND_RECIPIENT_FATIGUE_SUPPRESSED';
    public const SEND_RESULT_CAMPAIGN_CANCELLED = 'CAMPAIGN_CANCELLED';
    public const SEND_RESULT_CANCELLED_ABUSE = 'CANCELLED_ABUSE';
    public const SEND_RESULT_CONTACT_VIEW_PERMISSION = 'CONTACT_VIEW_PERMISSION';
    ...
    public const SEND_RESULT_GDPR_DOI_ENABLED = 'GDPR_DOI_ENABLED';
    public const SEND_RESULT_GRAYMAIL_SUPPRESSED = 'GRAYMAIL_SUPPRESSED';
    public const SEND_RESULT_HUBL_LIMIT_EXCEEDED = 'HUBL_LIMIT_EXCEEDED';
    public const SEND_RESULT_IDEMPOTENT_FAIL = 'IDEMPOTENT_FAIL';
    public const SEND_RESULT_IDEMPOTENT_IGNORE = 'IDEMPOTENT_IGNORE';
    public const SEND_RESULT_INVALID_APP_ID_ATTRIBUTION = 'INVALID_APP_ID_ATTRIBUTION';
    ...
    public const SEND_RESULT_LOW_CONTACT_QUALITY_SCORE = 'LOW_CONTACT_QUALITY_SCORE';
    public const SEND_RESULT_MARKETING_ACTIVATION_DISALLOWED = 'MARKETING_ACTIVATION_DISALLOWED';
    ...
    public const SEND_RESULT_UBB_GOVERNANCE_MISSING = 'UBB_GOVERNANCE_MISSING';
    ...
    public function getSendResultAllowableValues()
    {
        return [
            ...
            self::SEND_RESULT_UBB_GOVERNANCE_MISSING,
    ...
    */
     ...
     * Sets message
     *
     * @param string|null $message A human readable message describing the error along with remediation steps where appropriate
     *
     * @return self
     */
    ...
    public function setSendResult($send_result)
    {
        ...
        $allowedValues = $this->getSendResultAllowableValues();
        if (!in_array($send_result, $allowedValues, true)) {
