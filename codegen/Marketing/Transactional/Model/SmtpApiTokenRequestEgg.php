 ...
 * @link     https://openapi-generator.tech
 */
class SmtpApiTokenRequestEgg implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['create_contact'] = isset($data['create_contact']) ? $data['create_contact'] : null;
     ...
     * Sets create_contact
     *
     * @param bool $create_contact Indicates whether a contact should be created for recipients of emails.
     *
     * @return $this
     */
