...
class HubSpotFormConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const EMBED_TYPE_V3 = 'V3';
    public const EMBED_TYPE_V4 = 'V4';
     ...
     * @return string[]
     */
    public function getEmbedTypeAllowableValues()
    {
        return [
            self::EMBED_TYPE_V3,
            self::EMBED_TYPE_V4,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('embed_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getEmbedTypeAllowableValues();
        if (!is_null($this->container['embed_type']) && !in_array($this->container['embed_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'embed_type', must be one of '%s'",
                $this->container['embed_type'],
        ...
        if ($this->container['lifecycle_stages'] === null) {
            $invalidProperties[] = "'lifecycle_stages' can't be null";
        }
    ...
    {
        return $this->container['embed_type'];
    }

    /**
     * Sets embed_type
     *
     * @param string|null $embed_type embed_type
     *
     * @return self
     */
    public function setEmbedType($embed_type)
    {
        if (is_null($embed_type)) {
            throw new \InvalidArgumentException('non-nullable embed_type cannot be null');
        }
        $allowedValues = $this->getEmbedTypeAllowableValues();
        if (!in_array($embed_type, $allowedValues, true)) {
        ...
        $this->container['embed_type'] = $embed_type;
     ...
     *
     * @return \HubSpot\Client\Marketing\Forms\Model\LifecycleStage[]
     */
     ...
     *
     * @param \HubSpot\Client\Marketing\Forms\Model\LifecycleStage[] $lifecycle_stages lifecycle_stages
     *
     * @return self
     */
