...
class LegalConsentOptionsExplicitConsentToProcess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $communication_consent_text Text explaining communication consent preferences. Informs users about how their contact information will be used for communications.
     *
     * @return self
     */
     ...
     * Sets privacy_text
     *
     * @param string $privacy_text Text explaining the privacy policy and data handling practices. Required field that informs users about their privacy rights and how their data is protected.
     *
     * @return self
     */
