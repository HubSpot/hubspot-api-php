...
class DependentFieldFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets range_end
     *
     * @param string $range_end The end value for range-based operators (between, not_between). Must be provided together with rangeStart.
     *
     * @return self
     */
     ...
     * Sets range_start
     *
     * @param string $range_start The start value for range-based operators (between, not_between). Must be provided together with rangeEnd.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value The single value to compare against when using operators like eq, neq, contains, lt, gt, and other single-value comparison operators.
     *
     * @return self
     */
