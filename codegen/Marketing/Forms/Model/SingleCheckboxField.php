...
/**
 * SingleCheckboxField Class Doc Comment
 *
 * @category Class
 ...
 */
class SingleCheckboxField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SingleCheckboxField';
    ...
    public const FIELD_TYPE_SINGLE_CHECKBOX = 'single_checkbox';
    ...
    {
        return [
            self::FIELD_TYPE_SINGLE_CHECKBOX,
        ];
    }
    ...
    {
        $this->container['field_type'] = $data['field_type'] ?? 'single_checkbox';
