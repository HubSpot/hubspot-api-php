...
/**
 * MultiLineTextField Class Doc Comment
 *
 * @category Class
 ...
 */
class MultiLineTextField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MultiLineTextField';
    ...
    public const FIELD_TYPE_MULTI_LINE_TEXT = 'multi_line_text';
    ...
    {
        return [
            self::FIELD_TYPE_MULTI_LINE_TEXT,
        ];
    }
    ...
    {
        $this->container['field_type'] = $data['field_type'] ?? 'multi_line_text';
