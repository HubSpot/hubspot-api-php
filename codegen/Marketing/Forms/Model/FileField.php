 ...
 */
class FileField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FileField';
    ...
    {
        $this->container['field_type'] = $data['field_type'] ?? 'file';
