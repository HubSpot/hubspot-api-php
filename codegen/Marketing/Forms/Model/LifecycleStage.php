...
/**
 * LifecycleStage Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Marketing\Forms
 * @author   OpenAPI Generator team
 ...
 */
class LifecycleStage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LifecycleStage';
    ...
    */
     ...
     * Sets object_type_id
     *
     * @param string $object_type_id The objectTypeId for both contact and company
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value The internal name of the contact's lifecycle stage set when submitting a form
     *
     * @return self
     */
