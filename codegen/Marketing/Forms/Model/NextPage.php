...
class NextPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets after
     *
     * @param string $after The pagination cursor token used to fetch the next page of results. Pass this value in subsequent requests to continue pagination.
     *
     * @return self
     */
     ...
     * Sets link
     *
     * @param string|null $link The complete URL to retrieve the next page of results in paginated responses.
     *
     * @return self
     */
