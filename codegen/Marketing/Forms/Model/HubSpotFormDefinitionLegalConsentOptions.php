<?php
/**
 * HubSpotFormDefinitionLegalConsentOptions
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * HubSpotFormDefinitionLegalConsentOptions Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Marketing\Forms
 * @author   OpenAPI Generator team
 ...
 */
class HubSpotFormDefinitionLegalConsentOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HubSpotFormDefinition_legalConsentOptions';
    ...
    */
     ...
     * Sets lawful_basis
     *
     * @param string $lawful_basis The lawful basis for data processing under legitimate interest. Values: lead (processing for lead generation), client (processing for existing clients), other (other legitimate interests). Default: lead.
     *
     * @return self
     */
     ...
     * Sets privacy_text
     *
     * @param string $privacy_text Text explaining the privacy policy and data handling practices.
     *
     * @return self
     */
