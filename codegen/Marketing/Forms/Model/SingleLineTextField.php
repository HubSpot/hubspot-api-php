...
/**
 * SingleLineTextField Class Doc Comment
 *
 * @category Class
 ...
 */
class SingleLineTextField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SingleLineTextField';
    ...
    public const FIELD_TYPE_SINGLE_LINE_TEXT = 'single_line_text';
    ...
    {
        return [
            self::FIELD_TYPE_SINGLE_LINE_TEXT,
        ];
    }
    ...
    {
        $this->container['field_type'] = $data['field_type'] ?? 'single_line_text';
