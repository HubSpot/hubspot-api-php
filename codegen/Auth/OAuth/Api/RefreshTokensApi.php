...
class RefreshTokensApi
{
     ...
     * @return void
     */
    public function archive($token, string $contentType = self::contentTypes['archive'][0])
    {
        $this->archiveWithHttpInfo($token, $contentType);
    }
     ...
     */
    public function archiveWithHttpInfo($token, string $contentType = self::contentTypes['archive'][0])
    {
        $request = $this->archiveRequest($token, $contentType);
     ...
     */
    public function archiveAsync($token, string $contentType = self::contentTypes['archive'][0])
    {
        return $this->archiveAsyncWithHttpInfo($token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function archiveAsyncWithHttpInfo($token, string $contentType = self::contentTypes['archive'][0])
    {
        $returnType = '';
        $request = $this->archiveRequest($token, $contentType);
     ...
     */
    public function archiveRequest($token, string $contentType = self::contentTypes['archive'][0])
    {
