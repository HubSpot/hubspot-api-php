 ...
 */
class PublicTeam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicTeam';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('secondary_user_ids', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets secondary_user_ids
     *
     * @return string[]
     */
    public function getSecondaryUserIds()
    {
        return $this->container['secondary_user_ids'];
    }

    /**
     * Sets secondary_user_ids
     *
     * @param string[] $secondary_user_ids Secondary or additional members of this team
     *
     * @return self
     */
    public function setSecondaryUserIds($secondary_user_ids)
    {
        if (is_null($secondary_user_ids)) {
            throw new \InvalidArgumentException('non-nullable secondary_user_ids cannot be null');
        }
        $this->container['secondary_user_ids'] = $secondary_user_ids;
