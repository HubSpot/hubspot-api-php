...
class UsersApi
{
     ...
     * @param  string|null $id_property The name of a property with unique user values. Valid values are &#x60;USER_ID&#x60;(default) or &#x60;EMAIL&#x60; (optional)
     ...
     *
     * @param  int|null $limit The number of users to retrieve (optional)
     * @param  string|null $after Results will display maximum 100 users per page. Additional results will be on the next page. (optional)
