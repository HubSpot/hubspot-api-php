 ...
 */
class FileActionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets result
     *
     * @param \HubSpot\Client\Files\Model\File|null $result result
     *
     * @return self
     */
     ...
     * Sets links
     *
     * @param array<string,string>|null $links Link to check the status of the requested task.
     *
     * @return self
     */
