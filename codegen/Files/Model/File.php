...
class File implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const SOURCE_GROUP_CONTENT = 'CONTENT';
    public const SOURCE_GROUP_CONVERSATIONS = 'CONVERSATIONS';
    public const SOURCE_GROUP_FORMS = 'FORMS';
    public const SOURCE_GROUP_UI_EXTENSIONS = 'UI_EXTENSIONS';
    public const SOURCE_GROUP_UNKNOWN = 'UNKNOWN';
     ...
     * @return string[]
     */
    public function getSourceGroupAllowableValues()
    {
        return [
            self::SOURCE_GROUP_CONTENT,
            self::SOURCE_GROUP_CONVERSATIONS,
            self::SOURCE_GROUP_FORMS,
            self::SOURCE_GROUP_UI_EXTENSIONS,
            self::SOURCE_GROUP_UNKNOWN,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('file_md5', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getSourceGroupAllowableValues();
        if (!is_null($this->container['source_group']) && !in_array($this->container['source_group'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'source_group', must be one of '%s'",
                $this->container['source_group'],
                implode("', '", $allowedValues)
            );
        }
    ...
    {
        return $this->container['file_md5'];
    }

    /**
     * Sets file_md5
     *
     * @param string|null $file_md5 The MD5 hash of the file.
     *
     * @return self
     */
    public function setFileMd5($file_md5)
    {
        if (is_null($file_md5)) {
            throw new \InvalidArgumentException('non-nullable file_md5 cannot be null');
        }
        $this->container['file_md5'] = $file_md5;
    ...
    public function setSourceGroup($source_group)
    {
        ...
        $allowedValues = $this->getSourceGroupAllowableValues();
        if (!in_array($source_group, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'source_group', must be one of '%s'",
                    $source_group,
