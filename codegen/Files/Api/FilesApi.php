...
class FilesApi
{
    ...
    {
        list($response) = $this->doSearchWithHttpInfo($properties, $after, $before, $limit, $sort, $id, $created_at, $updated_at, $name, $path, $parent_folder_id, $size, $height, $width, $encoding, $type, $extension, $url, $is_usable_in_content, $allows_anonymous_access);
        return $response;
    }
    ...
    {
        return $this->doSearchAsyncWithHttpInfo($properties, $after, $before, $limit, $sort, $id, $created_at, $updated_at, $name, $path, $parent_folder_id, $size, $height, $width, $encoding, $type, $extension, $url, $is_usable_in_content, $allows_anonymous_access)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @param  string $file File data that will replace existing file in the file manager. (optional)
    ...
    {
        list($response) = $this->replaceWithHttpInfo($file_id, $user_agent, $file, $charset_hunch, $options);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replaceAsync($file_id, $user_agent = null, $file = null, $charset_hunch = null, $options = null)
    {
        return $this->replaceAsyncWithHttpInfo($file_id, $user_agent, $file, $charset_hunch, $options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function replaceRequest($file_id, $user_agent = null, $file = null, $charset_hunch = null, $options = null)
    {
        // verify the required parameter 'file_id' is set
        if ($file_id === null || (is_array($file_id) && count($file_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * @param  string $user_agent user_agent (optional)
     * @param  string $file File to be uploaded. (optional)
    ...
    {
        list($response) = $this->uploadWithHttpInfo($user_agent, $file, $folder_id, $folder_path, $file_name, $charset_hunch, $options);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadAsync($user_agent = null, $file = null, $folder_id = null, $folder_path = null, $file_name = null, $charset_hunch = null, $options = null)
    {
        return $this->uploadAsyncWithHttpInfo($user_agent, $file, $folder_id, $folder_path, $file_name, $charset_hunch, $options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function uploadRequest($user_agent = null, $file = null, $folder_id = null, $folder_path = null, $file_name = null, $charset_hunch = null, $options = null)
    {
