...
class FilesApi
{
    ...
    public function createRequest($folder_input, string $contentType = self::contentTypes['create'][0])
    {
        ...
        if (isset($folder_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($folder_input), JSON_THROW_ON_ERROR);
            } else {
    ...
    public function importFromUrlRequest($import_from_url_input, string $contentType = self::contentTypes['importFromUrl'][0])
    {
        ...
        if (isset($import_from_url_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($import_from_url_input), JSON_THROW_ON_ERROR);
            } else {
     ...
     * @return \HubSpot\Client\Files\Model\File|\HubSpot\Client\Files\Model\Error
     */
    public function replace($file_id, $charset_hunch = null, $file = null, $options = null, string $contentType = self::contentTypes['replace'][0])
    {
        list($response) = $this->replaceWithHttpInfo($file_id, $charset_hunch, $file, $options, $contentType);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Files\Model\File|\HubSpot\Client\Files\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function replaceWithHttpInfo($file_id, $charset_hunch = null, $file = null, $options = null, string $contentType = self::contentTypes['replace'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replaceAsync($file_id, $charset_hunch = null, $file = null, $options = null, string $contentType = self::contentTypes['replace'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replaceAsyncWithHttpInfo($file_id, $charset_hunch = null, $file = null, $options = null, string $contentType = self::contentTypes['replace'][0])
    {
        $returnType = '\HubSpot\Client\Files\Model\File';
        $request = $this->replaceRequest($file_id, $charset_hunch, $file, $options, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function replaceRequest($file_id, $charset_hunch = null, $file = null, $options = null, string $contentType = self::contentTypes['replace'][0])
    {
    ...
    public function updatePropertiesRequest($file_id, $file_update_input, string $contentType = self::contentTypes['updateProperties'][0])
    {
        ...
        if (isset($file_update_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($file_update_input), JSON_THROW_ON_ERROR);
            } else {
     ...
     * @return \HubSpot\Client\Files\Model\File|\HubSpot\Client\Files\Model\Error
     */
    public function upload($charset_hunch = null, $file = null, $file_name = null, $folder_id = null, $folder_path = null, $options = null, string $contentType = self::contentTypes['upload'][0])
    {
        list($response) = $this->uploadWithHttpInfo($charset_hunch, $file, $file_name, $folder_id, $folder_path, $options, $contentType);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Files\Model\File|\HubSpot\Client\Files\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadWithHttpInfo($charset_hunch = null, $file = null, $file_name = null, $folder_id = null, $folder_path = null, $options = null, string $contentType = self::contentTypes['upload'][0])
    {
        $request = $this->uploadRequest($charset_hunch, $file, $file_name, $folder_id, $folder_path, $options, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadAsync($charset_hunch = null, $file = null, $file_name = null, $folder_id = null, $folder_path = null, $options = null, string $contentType = self::contentTypes['upload'][0])
    {
        return $this->uploadAsyncWithHttpInfo($charset_hunch, $file, $file_name, $folder_id, $folder_path, $options, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadAsyncWithHttpInfo($charset_hunch = null, $file = null, $file_name = null, $folder_id = null, $folder_path = null, $options = null, string $contentType = self::contentTypes['upload'][0])
    {
        $returnType = '\HubSpot\Client\Files\Model\File';
        $request = $this->uploadRequest($charset_hunch, $file, $file_name, $folder_id, $folder_path, $options, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function uploadRequest($charset_hunch = null, $file = null, $file_name = null, $folder_id = null, $folder_path = null, $options = null, string $contentType = self::contentTypes['upload'][0])
    {
