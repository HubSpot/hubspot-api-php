...
class FoldersApi
{
     ...
     */
    public function doSearch($properties = null, $after = null, $before = null, $limit = null, $sort = null, $id = null, $created_at = null, $created_at_lte = null, $created_at_gte = null, $updated_at = null, $updated_at_lte = null, $updated_at_gte = null, $name = null, $path = null, $parent_folder_id = null, string $contentType = self::contentTypes['doSearch'][0])
    {
        list($response) = $this->doSearchWithHttpInfo($properties, $after, $before, $limit, $sort, $id, $created_at, $created_at_lte, $created_at_gte, $updated_at, $updated_at_lte, $updated_at_gte, $name, $path, $parent_folder_id, $contentType);
        return $response;
    }
     ...
     */
    public function doSearchWithHttpInfo($properties = null, $after = null, $before = null, $limit = null, $sort = null, $id = null, $created_at = null, $created_at_lte = null, $created_at_gte = null, $updated_at = null, $updated_at_lte = null, $updated_at_gte = null, $name = null, $path = null, $parent_folder_id = null, string $contentType = self::contentTypes['doSearch'][0])
    {
        $request = $this->doSearchRequest($properties, $after, $before, $limit, $sort, $id, $created_at, $created_at_lte, $created_at_gte, $updated_at, $updated_at_lte, $updated_at_gte, $name, $path, $parent_folder_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doSearchAsync($properties = null, $after = null, $before = null, $limit = null, $sort = null, $id = null, $created_at = null, $created_at_lte = null, $created_at_gte = null, $updated_at = null, $updated_at_lte = null, $updated_at_gte = null, $name = null, $path = null, $parent_folder_id = null, string $contentType = self::contentTypes['doSearch'][0])
    {
        return $this->doSearchAsyncWithHttpInfo($properties, $after, $before, $limit, $sort, $id, $created_at, $created_at_lte, $created_at_gte, $updated_at, $updated_at_lte, $updated_at_gte, $name, $path, $parent_folder_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function updateProperties($folder_update_input, string $contentType = self::contentTypes['updateProperties'][0])
    {
        list($response) = $this->updatePropertiesWithHttpInfo($folder_update_input, $contentType);
        return $response;
    }
     ...
     */
    public function updatePropertiesWithHttpInfo($folder_update_input, string $contentType = self::contentTypes['updateProperties'][0])
    {
        $request = $this->updatePropertiesRequest($folder_update_input, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePropertiesAsync($folder_update_input, string $contentType = self::contentTypes['updateProperties'][0])
    {
        return $this->updatePropertiesAsyncWithHttpInfo($folder_update_input, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updatePropertiesAsyncWithHttpInfo($folder_update_input, string $contentType = self::contentTypes['updateProperties'][0])
    {
        $returnType = '\HubSpot\Client\Files\Model\FolderUpdateTaskLocator';
        $request = $this->updatePropertiesRequest($folder_update_input, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updatePropertiesRequest($folder_update_input, string $contentType = self::contentTypes['updateProperties'][0])
    {
