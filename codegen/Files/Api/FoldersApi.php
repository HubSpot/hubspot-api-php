...
class FoldersApi
{
     ...
     */
    protected function archiveRequest($folder_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function archiveByPathRequest($folder_path)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function checkUpdateStatusRequest($task_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createRequest($folder_input)
    {
    ...
    {
        list($response) = $this->doSearchWithHttpInfo($properties, $after, $before, $limit, $sort, $id, $created_at, $updated_at, $name, $path, $parent_folder_id);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doSearchAsync($properties = null, $after = null, $before = null, $limit = null, $sort = null, $id = null, $created_at = null, $updated_at = null, $name = null, $path = null, $parent_folder_id = null)
    {
        return $this->doSearchAsyncWithHttpInfo($properties, $after, $before, $limit, $sort, $id, $created_at, $updated_at, $name, $path, $parent_folder_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function doSearchRequest($properties = null, $after = null, $before = null, $limit = null, $sort = null, $id = null, $created_at = null, $updated_at = null, $name = null, $path = null, $parent_folder_id = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getByIdRequest($folder_id, $properties = null)
    {
        // verify the required parameter 'folder_id' is set
        if ($folder_id === null || (is_array($folder_id) && count($folder_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getByPathRequest($folder_path, $properties = null)
    {
        // verify the required parameter 'folder_path' is set
        if ($folder_path === null || (is_array($folder_path) && count($folder_path) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updatePropertiesRequest($folder_update_input)
    {
