...
class FoldersApi
{
    ...
    public function updatePropertiesRequest($folder_id, $folder_update_input, string $contentType = self::contentTypes['updateProperties'][0])
    {
        ...
        if (isset($folder_update_input)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($folder_update_input), JSON_THROW_ON_ERROR);
            } else {
    ...
    public function updatePropertiesRecursivelyRequest($folder_update_input_with_id, string $contentType = self::contentTypes['updatePropertiesRecursively'][0])
    {
        ...
        if (isset($folder_update_input_with_id)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($folder_update_input_with_id), JSON_THROW_ON_ERROR);
            } else {
