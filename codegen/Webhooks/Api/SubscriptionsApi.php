...
class SubscriptionsApi
{
    ...
    public function createRequest($app_id, $subscription_create_request)
    {
        ...
        if (isset($subscription_create_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($subscription_create_request));
            } else {
    ...
    public function updateRequest($subscription_id, $app_id, $subscription_patch_request)
    {
        ...
        if (isset($subscription_patch_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($subscription_patch_request));
            } else {
    ...
    public function updateBatchRequest($app_id, $batch_input_subscription_batch_update_request)
    {
        ...
        if (isset($batch_input_subscription_batch_update_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($batch_input_subscription_batch_update_request));
            } else {
