...
/**
 * BatchResponseSubscriptionResponseWithErrors Class Doc Comment
 *
 * @category Class
 * @description Response for batch operations on webhook subscriptions, containing successful results and any errors that occurred.
 * @package  HubSpot\Client\Webhooks
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BatchResponseSubscriptionResponseWithErrors implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchResponseSubscriptionResponseWithErrors';
    ...
    protected static $openAPITypes = [
        ...
        'errors' => '\HubSpot\Client\Webhooks\Model\StandardError[]',
    ...
    */
     ...
     * Sets completed_at
     *
     * @param \DateTime $completed_at The timestamp when the batch operation completed, in ISO 8601 format (e.g., 2020-02-29T12:30:00Z).
     *
     * @return self
     */
     ...
     * Gets errors
     *
     * @return \HubSpot\Client\Webhooks\Model\StandardError[]|null
     */
     ...
     * Sets errors
     *
     * @param \HubSpot\Client\Webhooks\Model\StandardError[]|null $errors An array containing error details for any subscriptions that failed to process during the batch operation.
     *
     * @return self
     */
     ...
     * Sets num_errors
     *
     * @param int|null $num_errors The number of errors that occurred during the batch operation.
     *
     * @return self
     */
     ...
     * Sets requested_at
     *
     * @param \DateTime|null $requested_at The timestamp when the batch operation was requested, in ISO 8601 format (e.g., 2020-02-29T12:30:00Z).
     *
     * @return self
     */
     ...
     * Sets started_at
     *
     * @param \DateTime $started_at The timestamp when the batch operation started processing, in ISO 8601 format (e.g., 2020-02-29T12:30:00Z).
     *
     * @return self
     */
