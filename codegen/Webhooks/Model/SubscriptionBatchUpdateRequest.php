...
/**
 * SubscriptionBatchUpdateRequest Class Doc Comment
 *
 * @category Class
 * @description Updated settings for a webhook subscription in a batch update operation.
 * @package  HubSpot\Client\Webhooks
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SubscriptionBatchUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscriptionBatchUpdateRequest';
