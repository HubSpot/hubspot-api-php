 ...
 *
 * @category Class
 * @description Request to create a new webhook subscription for monitoring specific events. Each subscription defines which event type to listen for and whether to monitor all events of that type or specific property changes.
 * @package  HubSpot\Client\Webhooks
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class SubscriptionCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const EVENT_TYPE_EVENT_COMPLETED = 'event.completed';
    ...
    public function getEventTypeAllowableValues()
    {
        return [
            ...
            self::EVENT_TYPE_EVENT_COMPLETED,
    ...
    */
     ...
     *
     * @param string|null $event_type_name The name of the event to listen for. This is used with custom objects to specify custom event types beyond the standard eventType enum values.
     *
     * @return self
     */
     ...
     * Sets object_type_id
     *
     * @param string|null $object_type_id The ID of the object type for the subscription. This can be a standard CRM object (e.g., 'contact', 'company', 'deal') or a custom object ID for custom object subscriptions.
     *
     * @return self
     */
