...
class Page implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('page_redirected', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string $content_group_id The unique identifier for the content group associated with the page.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime $created The timestamp indicating when the page was created.
     *
     * @return self
     */
     ...
     *
     * @param bool $currently_published Indicates whether the page is currently published.
     *
     * @return self
     */
     ...
     *
     * @param array<string,\HubSpot\Client\Cms\Pages\Model\LayoutSection> $layout_sections A structure detailing the layout sections of the page.
     *
     * @return self
     */
    ...
    {
        if (is_null($page_redirected)) {
            throw new \InvalidArgumentException('non-nullable page_redirected cannot be null');
        }
     ...
     *
     * @param array<string,object> $theme_settings_values A collection of settings specific to the theme applied to the page.
     *
     * @return self
     */
     ...
     * Sets translations
     *
     * @param array<string,\HubSpot\Client\Cms\Pages\Model\ContentLanguageVariation> $translations A map of translations for the page, each associated with a specific language variation.
     *
     * @return self
     */
