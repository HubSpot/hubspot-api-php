...
class ContentLanguageVariation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param bool $archived_in_dashboard Indicates if the page is hidden from the dashboard, though it may still be live.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime $created The date and time when the content language variation was created.
     *
     * @return self
     */
     ...
     * Sets password
     *
     * @param string $password A password required to view the page, if set.
     *
     * @return self
     */
     ...
     *
     * @param bool $public_access_rules_enabled Determines if public access rules should be respected.
     *
     * @return self
     */
     ...
     * Sets publish_date
     *
     * @param \DateTime $publish_date The date and time when the page is scheduled to be published.
     *
     * @return self
     */
     ...
     * Sets slug
     *
     * @param string $slug The path of this page, appended to the domain to construct the URL.
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime $updated The date and time when the content language variation was last updated.
     *
     * @return self
     */
