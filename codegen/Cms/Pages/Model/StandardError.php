...
class StandardError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'category' => 'string',
        'message' => 'string',
        'errors' => '\HubSpot\Client\Cms\Pages\Model\ErrorDetail[]',
        'status' => 'string'
    ];
     ...
     * Gets errors
     *
     * @return \HubSpot\Client\Cms\Pages\Model\ErrorDetail[]
     */
     ...
     * Sets errors
     *
     * @param \HubSpot\Client\Cms\Pages\Model\ErrorDetail[] $errors List of error details.
     *
     * @return self
     */
