 ...
 */
class RowMetaData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RowMetaData';
    ...
    */
     ...
     * Sets css_class
     *
     * @param string $css_class The CSS class applied to the row metadata.
     *
     * @return self
     */
