...
/**
 * SitePagesApi Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Cms\Pages
 * @author   OpenAPI Generator team
...
class SitePagesApi
{
     ...
     * Delete a Site Page
     *
     * @param  string $object_id The Site Page id. (required)
    ...
    public function archiveRequest($object_id, $archived = null, string $contentType = self::contentTypes['archive'][0])
    {
        ...
        $resourcePath = '/cms/v3/pages/site-pages/{objectId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \HubSpot\Client\Cms\Pages\Model\BatchInputString $batch_input_string The JSON array of Site Page ids. (required)
    ...
    public function callCloneRequest($content_clone_request_v_next, string $contentType = self::contentTypes['callClone'][0])
    {
        ...
        $resourcePath = '/cms/v3/pages/site-pages/clone';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \HubSpot\Client\Cms\Pages\Model\Page $page The JSON representation of a new Site Page. (required)
    ...
    public function createRequest($page, string $contentType = self::contentTypes['create'][0])
    {
        ...
        $resourcePath = '/cms/v3/pages/site-pages';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \HubSpot\Client\Cms\Pages\Model\BatchInputPage $batch_input_page The JSON array of new Site Pages to create. (required)
    ...
    public function getDraftByIdRequest($object_id, string $contentType = self::contentTypes['getDraftById'][0])
    {
        ...
        $resourcePath = '/cms/v3/pages/site-pages/{objectId}/draft';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Get all Site Pages
     *
     * @param  \DateTime|null $created_at Only return Site Pages created at exactly the specified time. (optional)
     * @param  \DateTime|null $created_after Only return Site Pages created after the specified time. (optional)
     * @param  \DateTime|null $created_before Only return Site Pages created before the specified time. (optional)
     * @param  \DateTime|null $updated_at Only return Site Pages last updated at exactly the specified time. (optional)
     * @param  \DateTime|null $updated_after Only return Site Pages last updated after the specified time. (optional)
     * @param  \DateTime|null $updated_before Only return Site Pages last updated before the specified time. (optional)
     ...
     *
     * @param  string $object_id The Site Page id. (required)
     * @param  string $revision_id The Site Page version id. (required)
     ...
     *
     * @param  string $object_id The id of the Site Page for which it&#39;s draft will be pushed live. (required)
    ...
    public function pushLiveRequest($object_id, string $contentType = self::contentTypes['pushLive'][0])
    {
        ...
        $resourcePath = '/cms/v3/pages/site-pages/{objectId}/draft/push-live';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $object_id The id of the Site Page for which it&#39;s draft will be reset. (required)
     ...
     *
     * @param  string $object_id The Site Page id. (required)
     * @param  string $revision_id The Site Page version id to restore. (required)
    ...
    public function restorePreviousVersionRequest($object_id, $revision_id, string $contentType = self::contentTypes['restorePreviousVersion'][0])
    {
        ...
        $resourcePath = '/cms/v3/pages/site-pages/{objectId}/revisions/{revisionId}/restore';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $object_id The Site Page id. (required)
     * @param  int $revision_id The Site Page version id to restore. (required)
    ...
    public function scheduleRequest($content_schedule_request_v_next, string $contentType = self::contentTypes['schedule'][0])
    {
        ...
        $resourcePath = '/cms/v3/pages/site-pages/schedule';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $object_id The Site Page id. (required)
     * @param  \HubSpot\Client\Cms\Pages\Model\Page $page The JSON representation of the updated Site Page. (required)
     ...
     *
     * @param  \HubSpot\Client\Cms\Pages\Model\BatchInputJsonNode $batch_input_json_node The JSON representation of the updated Site Pages. (required)
     * @param  bool|null $archived Specifies whether to update deleted Site Pages. Defaults to &#x60;false&#x60;. (optional)
     ...
     *
     * @param  string $object_id The Site Page id. (required)
     * @param  \HubSpot\Client\Cms\Pages\Model\Page $page The JSON representation of the updated Site Page to be applied to the draft. (required)
