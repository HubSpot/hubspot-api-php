...
class PreviousPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets before
     *
     * @param string $before Pre-constructed URL that can be used to directly fetch the previous page of results without manually building the query.
     *
     * @return self
     */
     ...
     * Sets link
     *
     * @param string|null $link Cursor token representing the boundary timestamp before which to fetch the previous page of results. Pass this value as the before query parameter to retrieve earlier audit logs.
     *
     * @return self
     */
