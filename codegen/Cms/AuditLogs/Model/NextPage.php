...
class NextPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets after
     *
     * @param string $after Cursor token representing the boundary timestamp after which to fetch the next page of results. Pass this value as the after query parameter to retrieve later audit logs.
     *
     * @return self
     */
     ...
     * Sets link
     *
     * @param string|null $link Pre-constructed URL that can be used to directly fetch the next page of results without manually building the query.
     *
     * @return self
     */
