...
class DefaultApi
{
     ...
     */
    protected function getPageRequest($object_id = null, $user_id = null, $after = null, $before = null, $sort = null, $event_type = null, $limit = null, $object_type = null)
    {
        ...
        if (is_array($object_id)) {
            $object_id = ObjectSerializer::serializeCollection($object_id, 'multi', true);
        }
        if ($object_id !== null) {
        ...
        if (is_array($event_type)) {
            $event_type = ObjectSerializer::serializeCollection($event_type, 'multi', true);
        }
        if ($event_type !== null) {
        ...
        if (is_array($object_type)) {
            $object_type = ObjectSerializer::serializeCollection($object_type, 'multi', true);
        }
        if ($object_type !== null) {
