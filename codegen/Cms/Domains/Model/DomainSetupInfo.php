 ...
 * @link     https://openapi-generator.tech
 */
class DomainSetupInfo implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['supports_ssl_externally'] = isset($data['supports_ssl_externally']) ? $data['supports_ssl_externally'] : null;
        $this->container['who_is_email_addresses'] = isset($data['who_is_email_addresses']) ? $data['who_is_email_addresses'] : null;
    }
