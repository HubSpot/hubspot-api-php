...
class NextPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets after
     *
     * @param string $after The cursor value indicating where to begin fetching the next page of results in a paginated collection
     *
     * @return self
     */
     ...
     * Sets link
     *
     * @param string|null $link An optional URL for directly accessing the next page of results.
     *
     * @return self
     */
