...
class Domain implements ModelInterface, ArrayAccess
{
    ...
    const APEX_RESOLUTION_STATUS_INELIGIBLE = 'INELIGIBLE';
    const APEX_RESOLUTION_STATUS_SUGGEST_RESOLVING = 'SUGGEST_RESOLVING';
    const APEX_RESOLUTION_STATUS_ALREADY_RESOLVING = 'ALREADY_RESOLVING';
    const APEX_RESOLUTION_STATUS_ERROR = 'ERROR';
    const COS_OBJECT_TYPE_CONTENT = 'CONTENT';
    const COS_OBJECT_TYPE_EXTENSION_RESOURCE = 'EXTENSION_RESOURCE';
    const COS_OBJECT_TYPE_LAYOUT = 'LAYOUT';
    const COS_OBJECT_TYPE_CUSTOM_WIDGET = 'CUSTOM_WIDGET';
    const COS_OBJECT_TYPE_WIDGET = 'WIDGET';
    const COS_OBJECT_TYPE_FORM = 'FORM';
    const COS_OBJECT_TYPE_PLACEMENT = 'PLACEMENT';
    const COS_OBJECT_TYPE_IMAGE = 'IMAGE';
    const COS_OBJECT_TYPE_DOMAIN_SETTINGS = 'DOMAIN_SETTINGS';
    const COS_OBJECT_TYPE_SITE_SETTINGS = 'SITE_SETTINGS';
    const COS_OBJECT_TYPE_EMAIL_ADDRESS = 'EMAIL_ADDRESS';
    const COS_OBJECT_TYPE_WORKFLOW = 'WORKFLOW';
    const COS_OBJECT_TYPE_HUBDB_TABLE = 'HUBDB_TABLE';
    const COS_OBJECT_TYPE_REDIRECT_URL = 'REDIRECT_URL';
    const COS_OBJECT_TYPE_DESIGN_FOLDER = 'DESIGN_FOLDER';
    const COS_OBJECT_TYPE_SITE_MAP = 'SITE_MAP';
    const COS_OBJECT_TYPE_DOMAIN = 'DOMAIN';
    const COS_OBJECT_TYPE_BLOG = 'BLOG';
    const COS_OBJECT_TYPE_FILE = 'FILE';
    const COS_OBJECT_TYPE_FOLDER = 'FOLDER';
    const COS_OBJECT_TYPE_SITE_MENU = 'SITE_MENU';
    const COS_OBJECT_TYPE_THEME = 'THEME';
    const COS_OBJECT_TYPE_CONTENT_GROUP = 'CONTENT_GROUP';
    const COS_OBJECT_TYPE_FOLLOW_ME = 'FOLLOW_ME';
    const COS_OBJECT_TYPE_KNOWLEDGE_BASE = 'KNOWLEDGE_BASE';
    const COS_OBJECT_TYPE_LIST_MEMBERSHIP = 'LIST_MEMBERSHIP';
    const COS_OBJECT_TYPE_CONTACT_MEMBERSHIP = 'CONTACT_MEMBERSHIP';
    const COS_OBJECT_TYPE_PASSWORD_PROTECTED = 'PASSWORD_PROTECTED';
    const COS_OBJECT_TYPE_UNRESTRICTED_ACCESS = 'UNRESTRICTED_ACCESS';
    const COS_OBJECT_TYPE_MARKETPLACE_LISTING = 'MARKETPLACE_LISTING';
    const COS_OBJECT_TYPE_LAYOUT_SECTION = 'LAYOUT_SECTION';
    const COS_OBJECT_TYPE_THEME_SETTINGS = 'THEME_SETTINGS';
    const COS_OBJECT_TYPE_VIDEO_PLAYER = 'VIDEO_PLAYER';
    const COS_OBJECT_TYPE_URL_MAPPING = 'URL_MAPPING';
    const COS_OBJECT_TYPE_KNOWLEDGE_CATEGORY = 'KNOWLEDGE_CATEGORY';
    const COS_OBJECT_TYPE_KNOWLEDGE_HOMEPAGE_CATEGORY = 'KNOWLEDGE_HOMEPAGE_CATEGORY';
    const COS_OBJECT_TYPE_RAW_ASSET = 'RAW_ASSET';
    const COS_OBJECT_TYPE_GLOBAL_CONTENT = 'GLOBAL_CONTENT';
    const COS_OBJECT_TYPE_HUBDB_TABLE_ROW = 'HUBDB_TABLE_ROW';
    const COS_OBJECT_TYPE_BLOG_AUTHOR = 'BLOG_AUTHOR';
    const COS_OBJECT_TYPE_SERVERLESS_FUNCTION = 'SERVERLESS_FUNCTION';
    const COS_OBJECT_TYPE_KNOWLEDGE_CATEGORY_TRANSLATION = 'KNOWLEDGE_CATEGORY_TRANSLATION';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['primary_landing_page'] = isset($data['primary_landing_page']) ? $data['primary_landing_page'] : null;
        $this->container['primary_email'] = isset($data['primary_email']) ? $data['primary_email'] : null;
        $this->container['primary_blog'] = isset($data['primary_blog']) ? $data['primary_blog'] : null;
        $this->container['primary_blog_post'] = isset($data['primary_blog_post']) ? $data['primary_blog_post'] : null;
        $this->container['primary_site_page'] = isset($data['primary_site_page']) ? $data['primary_site_page'] : null;
        $this->container['primary_knowledge'] = isset($data['primary_knowledge']) ? $data['primary_knowledge'] : null;
        $this->container['primary_legacy_page'] = isset($data['primary_legacy_page']) ? $data['primary_legacy_page'] : null;
        $this->container['primary_click_tracking'] = isset($data['primary_click_tracking']) ? $data['primary_click_tracking'] : null;
        $this->container['full_category_key'] = isset($data['full_category_key']) ? $data['full_category_key'] : null;
        $this->container['secondary_to_domain'] = isset($data['secondary_to_domain']) ? $data['secondary_to_domain'] : null;
        $this->container['is_resolving'] = isset($data['is_resolving']) ? $data['is_resolving'] : null;
        $this->container['is_dns_correct'] = isset($data['is_dns_correct']) ? $data['is_dns_correct'] : null;
        $this->container['manually_marked_as_resolving'] = isset($data['manually_marked_as_resolving']) ? $data['manually_marked_as_resolving'] : null;
        $this->container['consecutive_non_resolving_count'] = isset($data['consecutive_non_resolving_count']) ? $data['consecutive_non_resolving_count'] : null;
        $this->container['ssl_cname'] = isset($data['ssl_cname']) ? $data['ssl_cname'] : null;
        $this->container['is_ssl_enabled'] = isset($data['is_ssl_enabled']) ? $data['is_ssl_enabled'] : null;
        $this->container['is_ssl_only'] = isset($data['is_ssl_only']) ? $data['is_ssl_only'] : null;
        $this->container['certificate_id'] = isset($data['certificate_id']) ? $data['certificate_id'] : null;
        $this->container['ssl_request_id'] = isset($data['ssl_request_id']) ? $data['ssl_request_id'] : null;
        $this->container['is_used_for_blog_post'] = isset($data['is_used_for_blog_post']) ? $data['is_used_for_blog_post'] : null;
        $this->container['is_used_for_site_page'] = isset($data['is_used_for_site_page']) ? $data['is_used_for_site_page'] : null;
        $this->container['is_used_for_landing_page'] = isset($data['is_used_for_landing_page']) ? $data['is_used_for_landing_page'] : null;
        $this->container['is_used_for_email'] = isset($data['is_used_for_email']) ? $data['is_used_for_email'] : null;
        $this->container['is_used_for_knowledge'] = isset($data['is_used_for_knowledge']) ? $data['is_used_for_knowledge'] : null;
        $this->container['setup_task_id'] = isset($data['setup_task_id']) ? $data['setup_task_id'] : null;
        $this->container['is_setup_complete'] = isset($data['is_setup_complete']) ? $data['is_setup_complete'] : null;
        $this->container['set_up_language'] = isset($data['set_up_language']) ? $data['set_up_language'] : null;
        $this->container['team_ids'] = isset($data['team_ids']) ? $data['team_ids'] : null;
        $this->container['actual_cname'] = isset($data['actual_cname']) ? $data['actual_cname'] : null;
        $this->container['correct_cname'] = isset($data['correct_cname']) ? $data['correct_cname'] : null;
        $this->container['actual_ip'] = isset($data['actual_ip']) ? $data['actual_ip'] : null;
        $this->container['apex_resolution_status'] = isset($data['apex_resolution_status']) ? $data['apex_resolution_status'] : null;
        $this->container['apex_domain'] = isset($data['apex_domain']) ? $data['apex_domain'] : null;
        $this->container['public_suffix'] = isset($data['public_suffix']) ? $data['public_suffix'] : null;
        $this->container['apex_ip_addresses'] = isset($data['apex_ip_addresses']) ? $data['apex_ip_addresses'] : null;
        ...
        $this->container['domain_cdn_config'] = isset($data['domain_cdn_config']) ? $data['domain_cdn_config'] : null;
        $this->container['setup_info'] = isset($data['setup_info']) ? $data['setup_info'] : null;
        $this->container['derived_brand_name'] = isset($data['derived_brand_name']) ? $data['derived_brand_name'] : null;
        ...
        $this->container['is_any_primary'] = isset($data['is_any_primary']) ? $data['is_any_primary'] : null;
        $this->container['is_legacy_domain'] = isset($data['is_legacy_domain']) ? $data['is_legacy_domain'] : null;
        $this->container['is_internal_domain'] = isset($data['is_internal_domain']) ? $data['is_internal_domain'] : null;
        $this->container['is_resolving_internal_property'] = isset($data['is_resolving_internal_property']) ? $data['is_resolving_internal_property'] : null;
        $this->container['is_resolving_ignoring_manually_marked_as_resolving'] = isset($data['is_resolving_ignoring_manually_marked_as_resolving']) ? $data['is_resolving_ignoring_manually_marked_as_resolving'] : null;
        $this->container['is_used_for_any_content_type'] = isset($data['is_used_for_any_content_type']) ? $data['is_used_for_any_content_type'] : null;
        $this->container['is_legacy'] = isset($data['is_legacy']) ? $data['is_legacy'] : null;
        $this->container['author_at'] = isset($data['author_at']) ? $data['author_at'] : null;
        $this->container['cos_object_type'] = isset($data['cos_object_type']) ? $data['cos_object_type'] : null;
        $this->container['cdn_purge_embargo_time'] = isset($data['cdn_purge_embargo_time']) ? $data['cdn_purge_embargo_time'] : null;
        $this->container['is_staging_domain'] = isset($data['is_staging_domain']) ? $data['is_staging_domain'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['apex_resolution_status']) && !in_array($this->container['apex_resolution_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'apex_resolution_status', must be one of '%s'",
        ...
        if (!is_null($this->container['cos_object_type']) && !in_array($this->container['cos_object_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'cos_object_type', must be one of '%s'",
                implode("', '", $allowedValues)
            );
        }
