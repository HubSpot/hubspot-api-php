...
class DomainsApi
{
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Cms\Domains\Model\Domain' === '\SplFileObject') {
                        ...
                        if ('\HubSpot\Client\Cms\Domains\Model\Domain' !== 'string') {
                            try {
                ...
                default:
                    if ('\HubSpot\Client\Cms\Domains\Model\Error' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Cms\Domains\Model\Error' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
    ...
    public function getPageWithHttpInfo($created_at = null, $created_after = null, $created_before = null, $updated_at = null, $updated_after = null, $updated_before = null, $sort = null, $after = null, $limit = null, $archived = null, string $contentType = self::contentTypes['getPage'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\HubSpot\Client\Cms\Domains\Model\CollectionResponseWithTotalDomainForwardPaging' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\HubSpot\Client\Cms\Domains\Model\CollectionResponseWithTotalDomainForwardPaging' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\HubSpot\Client\Cms\Domains\Model\CollectionResponseWithTotalDomainForwardPaging', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
