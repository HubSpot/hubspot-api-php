...
class DomainsApi
{
    ...
    {
        list($response) = $this->getByIdWithHttpInfo($domain_id);
        return $response;
    }
     ...
     */
    public function getByIdWithHttpInfo($domain_id)
    {
        $request = $this->getByIdRequest($domain_id);
     ...
     */
    public function getByIdAsync($domain_id)
    {
        return $this->getByIdAsyncWithHttpInfo($domain_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($domain_id)
    {
        $returnType = '\HubSpot\Client\Cms\Domains\Model\Domain';
        $request = $this->getByIdRequest($domain_id);
     ...
     */
    public function getByIdRequest($domain_id)
    {
