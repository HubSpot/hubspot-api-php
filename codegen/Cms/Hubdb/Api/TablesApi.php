...
use HubSpot\Client\Cms\Hubdb\FormDataProcessor;
...
class TablesApi
{
    ...
    public function cloneDraftTableRequest($table_id_or_name, $hub_db_table_clone_request, string $contentType = self::contentTypes['cloneDraftTable'][0])
    {
        ...
        if (isset($hub_db_table_clone_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($hub_db_table_clone_request), JSON_THROW_ON_ERROR);
            } else {
    ...
    public function createTableRequest($hub_db_table_v3_request, string $contentType = self::contentTypes['createTable'][0])
    {
        ...
        if (isset($hub_db_table_v3_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($hub_db_table_v3_request), JSON_THROW_ON_ERROR);
            } else {
     ...
     * @return void
     */
    public function removeTableVersion($table_id_or_name, $version_id, string $contentType = self::contentTypes['removeTableVersion'][0])
    {
        $this->removeTableVersionWithHttpInfo($table_id_or_name, $version_id, $contentType);
    }

    /**
     * Operation removeTableVersionWithHttpInfo
     *
     * Delete a table version
     *
     * @param  string $table_id_or_name  (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function removeTableVersionWithHttpInfo($table_id_or_name, $version_id, string $contentType = self::contentTypes['removeTableVersion'][0])
    {
        $request = $this->removeTableVersionRequest($table_id_or_name, $version_id, $contentType);
    ...
    /**
     * Operation removeTableVersionAsync
     *
     * Delete a table version
     *
     * @param  string $table_id_or_name  (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeTableVersionAsync($table_id_or_name, $version_id, string $contentType = self::contentTypes['removeTableVersion'][0])
    {
        return $this->removeTableVersionAsyncWithHttpInfo($table_id_or_name, $version_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation removeTableVersionAsyncWithHttpInfo
     *
     * Delete a table version
     *
     * @param  string $table_id_or_name  (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeTableVersionAsyncWithHttpInfo($table_id_or_name, $version_id, string $contentType = self::contentTypes['removeTableVersion'][0])
    {
        $returnType = '';
        $request = $this->removeTableVersionRequest($table_id_or_name, $version_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function removeTableVersionRequest($table_id_or_name, $version_id, string $contentType = self::contentTypes['removeTableVersion'][0])
    {

        // verify the required parameter 'table_id_or_name' is set
        if ($table_id_or_name === null || (is_array($table_id_or_name) && count($table_id_or_name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $table_id_or_name when calling removeTableVersion'
            );
        }
        ...
        if ($version_id === null || (is_array($version_id) && count($version_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $version_id when calling removeTableVersion'
            );
        }
        if (!preg_match("/\\d+/", $version_id)) {
            throw new \InvalidArgumentException("invalid value for \"version_id\" when calling TablesApi.removeTableVersion, must conform to the pattern /\\d+/.");
        }
        

        $resourcePath = '/cms/v3/hubdb/tables/{tableIdOrName}/versions/{versionId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
