...
class HubDbTableV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['allow_child_tables'] === null) {
            $invalidProperties[] = "'allow_child_tables' can't be null";
        }
        if ($this->container['allow_public_api_access'] === null) {
            $invalidProperties[] = "'allow_public_api_access' can't be null";
        }
        ...
        if ($this->container['dynamic_meta_tags'] === null) {
            $invalidProperties[] = "'dynamic_meta_tags' can't be null";
        }
        if ($this->container['enable_child_table_pages'] === null) {
            $invalidProperties[] = "'enable_child_table_pages' can't be null";
        }
        ...
        if ($this->container['use_for_pages'] === null) {
            $invalidProperties[] = "'use_for_pages' can't be null";
        }
     ...
     *
     * @param bool $allow_child_tables Specifies whether child tables can be created
     *
     * @return self
     */
     ...
     *
     * @param bool $allow_public_api_access Specifies whether the table can be read by public without authorization
     *
     * @return self
     */
     ...
     * Sets column_count
     *
     * @param int $column_count Number of columns including deleted
     *
     * @return self
     */
     ...
     * Gets columns
     *
     * @return \HubSpot\Client\Cms\Hubdb\Model\Column[]
     */
     ...
     * Sets columns
     *
     * @param \HubSpot\Client\Cms\Hubdb\Model\Column[] $columns List of columns in the table
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at Timestamp at which the table is created
     *
     * @return self
     */
     ...
     * Sets deleted
     *
     * @param bool $deleted Specifies whether the table is marked as deleted.
     *
     * @return self
     */
     ...
     * Sets deleted_at
     *
     * @param \DateTime $deleted_at The timestamp indicating when the table was deleted.
     *
     * @return self
     */
     ...
     *
     * @param array<string,int> $dynamic_meta_tags Specifies the key value pairs of the [metadata fields](https://developers.hubspot.com/docs/cms/guides/dynamic-pages/hubdb#dynamic-pages) with the associated column IDs.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $is_ordered_manually Indicates whether the table rows are ordered manually.
     *
     * @return self
     */
     ...
     * Sets published
     *
     * @param bool $published Indicates whether the table is currently published.
     *
     * @return self
     */
     ...
     * Sets published_at
     *
     * @param \DateTime $published_at Timestamp at which the table is published recently
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at Timestamp at which the table is updated recently
     *
     * @return self
     */
     ...
     * Sets use_for_pages
     *
     * @param bool $use_for_pages Specifies whether the table can be used for creation of dynamic pages
     *
     * @return self
     */
