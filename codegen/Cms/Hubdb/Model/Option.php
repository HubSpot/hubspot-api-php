...
class Option implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets created_at
     *
     * @param \DateTime $created_at The timestamp when the option was created, in ISO 8601 format.
     *
     * @return self
     */
     ...
     *
     * @param int|null $created_by_user_id The ID of the user who created the option.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string $label A user-friendly label that identifies the option.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name An internal name assigned to the option, distinct from the label.
     *
     * @return self
     */
     ...
     * Sets order
     *
     * @param int $order The order in which the option appears, represented as an integer.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Indicates the category or data type of the option (e.g., string, number).
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at The timestamp when the option was last updated, in ISO 8601 format.
     *
     * @return self
     */
     ...
     *
     * @param int|null $updated_by_user_id The ID of the user who last updated the option.
     *
     * @return self
     */
