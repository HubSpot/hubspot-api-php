...
/**
 * BatchResponseHubDbTableRowV3 Class Doc Comment
 *
 * @category Class
 * @package  HubSpot\Client\Cms\Hubdb
 * @author   OpenAPI Generator team
 ...
 */
class BatchResponseHubDbTableRowV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchResponseHubDbTableRowV3';
    ...
    */
     ...
     * Sets completed_at
     *
     * @param \DateTime $completed_at The timestamp indicating when the batch processing was completed.
     *
     * @return self
     */
     ...
     * Sets links
     *
     * @param array<string,string>|null $links A collection of related links associated with the batch response.
     *
     * @return self
     */
     ...
     * Sets requested_at
     *
     * @param \DateTime|null $requested_at The timestamp indicating when the batch request was made.
     *
     * @return self
     */
     ...
     * Sets started_at
     *
     * @param \DateTime $started_at The timestamp indicating when the batch processing began.
     *
     * @return self
     */
