 ...
 */
class CollectionResponseWithTotalHubDbTableV3ForwardPaging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets total
     *
     * @param int $total The total number of tables available in the collection.
     *
     * @return self
     */
