...
class StandardError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets category
     *
     * @param string $category Specifies the main category of the error, determining the broad area of issue.
     *
     * @return self
     */
     ...
     * Sets context
     *
     * @param array<string,string[]> $context An object containing context-specific information pertinent to the error.
     *
     * @return self
     */
     ...
     * Sets errors
     *
     * @param \HubSpot\Client\Cms\Hubdb\Model\ErrorDetail[] $errors The detailed error objects.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id The unique ID of the error instance.
     *
     * @return self
     */
     ...
     * Sets links
     *
     * @param array<string,string> $links An object containing links related to the error, such as documentation URLs or support contact pages.
     *
     * @return self
     */
     ...
     * Sets sub_category
     *
     * @param object|null $sub_category Identifies the subcategory of the error, providing more specific context within the main category.
     *
     * @return self
     */
