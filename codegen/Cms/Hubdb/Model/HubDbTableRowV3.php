...
class HubDbTableRowV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets published_at
     *
     * @param \DateTime $published_at The timestamp indicating when the row was last published, in date-time format.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at Timestamp at which the row is updated last time
     *
     * @return self
     */
