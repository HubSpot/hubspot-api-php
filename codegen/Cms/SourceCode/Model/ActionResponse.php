...
class ActionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets completed_at
     *
     * @param \DateTime $completed_at The timestamp indicating when the action was completed.
     *
     * @return self
     */
     ...
     * Sets requested_at
     *
     * @param \DateTime|null $requested_at The timestamp indicating when the action was requested.
     *
     * @return self
     */
     ...
     * Sets started_at
     *
     * @param \DateTime $started_at The timestamp indicating when the action was started.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status The current status of the action, with possible values: CANCELED, COMPLETE, PENDING, PROCESSING.
     *
     * @return self
     */
