...
class ContentApi
{
     ...
     * @return void
     */
    public function archive($environment, $path)
    {
        $this->archiveWithHttpInfo($environment, $path);
    }
     ...
     */
    public function archiveWithHttpInfo($environment, $path)
    {
        $request = $this->archiveRequest($environment, $path);
     ...
     */
    public function archiveAsync($environment, $path)
    {
        return $this->archiveAsyncWithHttpInfo($environment, $path)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function archiveAsyncWithHttpInfo($environment, $path)
    {
        $returnType = '';
        $request = $this->archiveRequest($environment, $path);
     ...
     */
    public function archiveRequest($environment, $path)
    {
    ...
    {
        list($response) = $this->createWithHttpInfo($environment, $path, $file);
        return $response;
    }
     ...
     * @deprecated
     */
    public function createAsync($environment, $path, $file = null)
    {
        return $this->createAsyncWithHttpInfo($environment, $path, $file)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function createRequest($environment, $path, $file = null)
    {
        // verify the required parameter 'environment' is set
        if ($environment === null || (is_array($environment) && count($environment) === 0)) {
            throw new \InvalidArgumentException(
