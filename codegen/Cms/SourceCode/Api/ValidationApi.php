...
class ValidationApi
{
     ...
     */
    public function doValidate($path, $file = null, string $contentType = self::contentTypes['doValidate'][0])
    {
        list($response) = $this->doValidateWithHttpInfo($path, $file, $contentType);
        return $response;
    }
     ...
     */
    public function doValidateWithHttpInfo($path, $file = null, string $contentType = self::contentTypes['doValidate'][0])
    {
        $request = $this->doValidateRequest($path, $file, $contentType);
     ...
     */
    public function doValidateAsync($path, $file = null, string $contentType = self::contentTypes['doValidate'][0])
    {
        return $this->doValidateAsyncWithHttpInfo($path, $file, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doValidateAsyncWithHttpInfo($path, $file = null, string $contentType = self::contentTypes['doValidate'][0])
    {
        $returnType = '\HubSpot\Client\Cms\SourceCode\Model\Error';
        $request = $this->doValidateRequest($path, $file, $contentType);
     ...
     */
    public function doValidateRequest($path, $file = null, string $contentType = self::contentTypes['doValidate'][0])
    {
