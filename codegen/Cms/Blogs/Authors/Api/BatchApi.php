...
class BatchApi
{
     ...
     *
     * @param  \HubSpot\Client\Cms\Blogs\Authors\Model\BatchInputString $batch_input_string batch_input_string (required)
     ...
     * Delete a batch of Blog Authors
     *
     * @param  \HubSpot\Client\Cms\Blogs\Authors\Model\BatchInputString $batch_input_string (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['archiveBatch'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Cms\Blogs\Authors\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \HubSpot\Client\Cms\Blogs\Authors\Model\BatchInputBlogAuthor $batch_input_blog_author batch_input_blog_author (required)
     ...
     * Create a batch of Blog Authors
     *
     * @param  \HubSpot\Client\Cms\Blogs\Authors\Model\BatchInputBlogAuthor $batch_input_blog_author (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createBatch'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Cms\Blogs\Authors\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \HubSpot\Client\Cms\Blogs\Authors\Model\BatchInputJsonNode $batch_input_json_node batch_input_json_node (required)
     ...
     * Update a batch of Blog Authors
     *
     * @param  \HubSpot\Client\Cms\Blogs\Authors\Model\BatchInputJsonNode $batch_input_json_node (required)
     * @param  bool|null $archived Specifies whether to update deleted Blog Authors. Defaults to &#x60;false&#x60;. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateBatch'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Cms\Blogs\Authors\ApiException on non-2xx response or if the response body is not in the expected format
