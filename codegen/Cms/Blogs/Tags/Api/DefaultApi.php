...
class DefaultApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createRequest($tag)
    {
     ...
     */
    public function create_0($batch_input_tag)
    {
        list($response) = $this->create_0WithHttpInfo($batch_input_tag);
        return $response;
    }
     ...
     */
    public function create_0WithHttpInfo($batch_input_tag)
    {
        $request = $this->create_0Request($batch_input_tag);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function create_0Async($batch_input_tag)
    {
        return $this->create_0AsyncWithHttpInfo($batch_input_tag)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function create_0AsyncWithHttpInfo($batch_input_tag)
    {
        $returnType = 'object';
        $request = $this->create_0Request($batch_input_tag);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function create_0Request($batch_input_tag)
    {
        ...
        if ($batch_input_tag === null || (is_array($batch_input_tag) && count($batch_input_tag) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $batch_input_tag when calling create_0'
            );
        }
     ...
     * @return \HubSpot\Client\Cms\Blogs\Tags\Model\Tag|\HubSpot\Client\Cms\Blogs\Tags\Model\Error
     */
    public function update_0($object_id, $tag, $archived = null)
    {
        list($response) = $this->update_0WithHttpInfo($object_id, $tag, $archived);
        return $response;
    }
     ...
     * @return array of \HubSpot\Client\Cms\Blogs\Tags\Model\Tag|\HubSpot\Client\Cms\Blogs\Tags\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function update_0WithHttpInfo($object_id, $tag, $archived = null)
    {
        $request = $this->update_0Request($object_id, $tag, $archived);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function update_0Async($object_id, $tag, $archived = null)
    {
        return $this->update_0AsyncWithHttpInfo($object_id, $tag, $archived)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function update_0AsyncWithHttpInfo($object_id, $tag, $archived = null)
    {
        $returnType = '\HubSpot\Client\Cms\Blogs\Tags\Model\Tag';
        $request = $this->update_0Request($object_id, $tag, $archived);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function update_0Request($object_id, $tag, $archived = null)
    {
        // verify the required parameter 'object_id' is set
        if ($object_id === null || (is_array($object_id) && count($object_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($tag === null || (is_array($tag) && count($tag) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tag when calling update_0'
            );
        }
