...
class MultiLanguageApi
{
     ...
     *
     * @param  \HubSpot\Client\Cms\Blogs\Tags\Model\AttachToLangPrimaryRequestVNext $attach_to_lang_primary_request_v_next attach_to_lang_primary_request_v_next (required)
     ...
     * Attach a Blog Tag to a multi-language group
     *
     * @param  \HubSpot\Client\Cms\Blogs\Tags\Model\AttachToLangPrimaryRequestVNext $attach_to_lang_primary_request_v_next (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['attachToLangGroup'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Cms\Blogs\Tags\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \HubSpot\Client\Cms\Blogs\Tags\Model\TagCloneRequestVNext $tag_clone_request_v_next tag_clone_request_v_next (required)
     ...
     * Create a new language variation
     *
     * @param  \HubSpot\Client\Cms\Blogs\Tags\Model\TagCloneRequestVNext $tag_clone_request_v_next (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createLangVariation'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Cms\Blogs\Tags\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    public function createLangVariationRequest($tag_clone_request_v_next, string $contentType = self::contentTypes['createLangVariation'][0])
    {
        ...
        if (isset($tag_clone_request_v_next)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = json_encode(ObjectSerializer::sanitizeForSerialization($tag_clone_request_v_next), JSON_THROW_ON_ERROR);
            } else {
     ...
     *
     * @param  \HubSpot\Client\Cms\Blogs\Tags\Model\DetachFromLangGroupRequestVNext $detach_from_lang_group_request_v_next detach_from_lang_group_request_v_next (required)
     ...
     * Detach a Blog Tag from a multi-language group
     *
     * @param  \HubSpot\Client\Cms\Blogs\Tags\Model\DetachFromLangGroupRequestVNext $detach_from_lang_group_request_v_next (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['detachFromLangGroup'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Cms\Blogs\Tags\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \HubSpot\Client\Cms\Blogs\Tags\Model\SetNewLanguagePrimaryRequestVNext $set_new_language_primary_request_v_next set_new_language_primary_request_v_next (required)
     ...
     * Set a new primary language
     *
     * @param  \HubSpot\Client\Cms\Blogs\Tags\Model\SetNewLanguagePrimaryRequestVNext $set_new_language_primary_request_v_next (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['setLangPrimary'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Cms\Blogs\Tags\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \HubSpot\Client\Cms\Blogs\Tags\Model\UpdateLanguagesRequestVNext $update_languages_request_v_next update_languages_request_v_next (required)
     ...
     * Update languages of multi-language group
     *
     * @param  \HubSpot\Client\Cms\Blogs\Tags\Model\UpdateLanguagesRequestVNext $update_languages_request_v_next (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateLangs'] to see the possible values for this operation
     *
     * @throws \HubSpot\Client\Cms\Blogs\Tags\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
