...
class BlogPost implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param array<string,\HubSpot\Client\Cms\Blogs\BlogPosts\Model\LayoutSection> $layout_sections A structure detailing the layout sections of the blog post.
     *
     * @return self
     */
     ...
     *
     * @param array<string,object> $theme_settings_values A collection of settings specific to the theme applied to the blog post.
     *
     * @return self
     */
     ...
     * Sets translations
     *
     * @param array<string,\HubSpot\Client\Cms\Blogs\BlogPosts\Model\ContentLanguageVariation> $translations A map of translations for the blog post, each associated with a specific language variation.
     *
     * @return self
     */
