...
class RedirectsApi
{
     ...
     *
     * @param  \DateTime|null $created_at Only return redirects created on exactly this date. (optional)
     * @param  \DateTime|null $created_after Only return redirects created after this date. (optional)
     * @param  \DateTime|null $created_before Only return redirects created before this date. (optional)
     * @param  \DateTime|null $updated_at Only return redirects last updated on exactly this date. (optional)
     * @param  \DateTime|null $updated_after Only return redirects last updated after this date. (optional)
     * @param  \DateTime|null $updated_before Only return redirects last updated before this date. (optional)
     ...
     * @param  int|null $limit Maximum number of result per page (optional)
