...
class RedirectsApi
{
     ...
     * @param  string[]|null $sort A query parameter to specify the order in which the URL redirects are returned. (optional)
     ...
     * Update a redirect
     *
     * @param  string $url_redirect_id The ID of the target url redirect to update. (required)
