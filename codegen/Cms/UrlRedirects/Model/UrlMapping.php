...
class UrlMapping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets created
     *
     * @param \DateTime|null $created The date and time when the URL mapping was initially created.
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated The date and time when the URL mapping was last modified.
     *
     * @return self
     */
