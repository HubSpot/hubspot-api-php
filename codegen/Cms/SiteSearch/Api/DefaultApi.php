...
class DefaultApi
{
     ...
     */
    protected function getByIdRequest($content_id, $type = null)
    {
        ...
        if (!preg_match("/.*/", $content_id)) {
            throw new \InvalidArgumentException("invalid value for \"content_id\" when calling DefaultApi.getById, must conform to the pattern /.*/.");
        }
    ...
    protected function searchRequest($q = null, $limit = null, $offset = null, $language = null, $match_prefix = null, $autocomplete = null, $popularity_boost = null, $boost_limit = null, $min_score = null, $boost_recent = null, $table_id = null, $hubdb_query = null, $key_string = null, $domain = null, $type = null, $path_prefix = null, $property = null, $length = null, $group_id = null)
    {
        ...
        // query params
        if ($key_string !== null) {
            $queryParams['keyString'] = ObjectSerializer::toQueryValue($key_string);
        }
        // query params
        if (is_array($domain)) {
            $domain = ObjectSerializer::serializeCollection($domain, 'multi', true);
        }
        if ($domain !== null) {
        ...
        // query params
        if (is_array($path_prefix)) {
            $path_prefix = ObjectSerializer::serializeCollection($path_prefix, 'multi', true);
        }
        if ($path_prefix !== null) {
