...
class IndexedField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('metadata_field', $data ?? [], null);
    ...
    */
     ...
     * Sets metadata_field
     *
     * @param bool $metadata_field Indicates whether the field is a metadata field.
     *
     * @return self
     */
    public function setMetadataField($metadata_field)
    {
        if (is_null($metadata_field)) {
            throw new \InvalidArgumentException('non-nullable metadata_field cannot be null');
        }
     ...
     * Sets name
     *
     * @param string $name The name of the indexed field.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param object $value The primary value of the indexed field.
     *
     * @return self
     */
