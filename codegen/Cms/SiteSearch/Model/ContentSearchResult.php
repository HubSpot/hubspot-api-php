...
class ContentSearchResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TYPE_STRUCTURED_CONTENT = 'STRUCTURED_CONTENT';
    ...
    {
        $this->setIfExists('author_full_name', $data ?? [], null);
        ...
        $this->setIfExists('in_beta', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($author_full_name)) {
            throw new \InvalidArgumentException('non-nullable author_full_name cannot be null');
        }
    ...
    {
        if (is_null($combined_id)) {
            throw new \InvalidArgumentException('non-nullable combined_id cannot be null');
        }
    ...
    public function setFeaturedImageUrl($featured_image_url)
    {
        if (is_null($featured_image_url)) {
            throw new \InvalidArgumentException('non-nullable featured_image_url cannot be null');
        }
    ...
    {
        return $this->container['in_beta'];
    }

    /**
     * Sets in_beta
     *
     * @param bool|null $in_beta in_beta
     *
     * @return self
     */
    public function setInBeta($in_beta)
    {
        if (is_null($in_beta)) {
            throw new \InvalidArgumentException('non-nullable in_beta cannot be null');
        }
        $this->container['in_beta'] = $in_beta;
