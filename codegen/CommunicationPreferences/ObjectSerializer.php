...
namespace HubSpot\Client\CommunicationPreferences;

use HubSpot\Client\CommunicationPreferences\Model\ModelInterface;
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\HubSpot\Client\CommunicationPreferences\Model\\' . $data->{$discriminator};
