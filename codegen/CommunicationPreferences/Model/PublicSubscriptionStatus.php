...
class PublicSubscriptionStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets legal_basis
     *
     * @param string|null $legal_basis legal_basis
     *
     * @return self
     */
     ...
     *
     * @param string|null $legal_basis_explanation legal_basis_explanation
     *
     * @return self
     */
     ...
     *
     * @param string|null $preference_group_name preference_group_name
     *
     * @return self
     */
     ...
     *
     * @param string $source_of_status source_of_status
     *
     * @return self
     */
