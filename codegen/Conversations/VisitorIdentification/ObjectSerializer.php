...
namespace HubSpot\Client\Conversations\VisitorIdentification;

use HubSpot\Client\Conversations\VisitorIdentification\Model\ModelInterface;
...
class ObjectSerializer
{
     ...
     * later.
     *
     * @param string[]|string $object an object to be serialized to a string
     *
     * @return string the serialized object
     */
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\HubSpot\Client\Conversations\VisitorIdentification\Model\\' . $data->{$discriminator};
