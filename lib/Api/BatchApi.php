...
class BatchApi
{
     ...
     * @param  \Swagger\Client\Model\BatchInputSimplePublicObjectId $body body (optional)
     *
     ...
     * @param  \Swagger\Client\Model\BatchInputSimplePublicObjectId $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $object_type object_type (required)
     * @param  \Swagger\Client\Model\BatchInputSimplePublicObjectInput $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\BatchResponseSimplePublicObject
     */
     ...
     *
     * @param  string $object_type (required)
     * @param  \Swagger\Client\Model\BatchInputSimplePublicObjectInput $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\BatchResponseSimplePublicObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function createBatchWithHttpInfo($object_type, $body = null)
    {
        $returnType = '\Swagger\Client\Model\BatchResponseSimplePublicObject';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\BatchResponseSimplePublicObject',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Swagger\Client\Model\BatchReadInputSimplePublicObjectId $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\BatchResponseSimplePublicObject
     ...
     * @param  string $object_type (required)
     * @param  bool $archived Whether to return only results that have been archived. (optional, default to false)
     * @param  \Swagger\Client\Model\BatchReadInputSimplePublicObjectId $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\BatchResponseSimplePublicObject, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  string $object_type object_type (required)
     * @param  \Swagger\Client\Model\BatchInputSimplePublicObjectBatchInput $body body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\BatchResponseSimplePublicObject
     ...
     *
     * @param  string $object_type (required)
     * @param  \Swagger\Client\Model\BatchInputSimplePublicObjectBatchInput $body (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\BatchResponseSimplePublicObject, HTTP status code, HTTP response headers (array of strings)
