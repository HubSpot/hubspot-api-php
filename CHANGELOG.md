...
## [Unreleased](https://github.com/HubSpot/hubspot-api-php/compare/4.1.0...HEAD)

## [4.1.0](https://github.com/HubSpot/hubspot-api-php/releases/tag/4.1.0) - 2021-09-22

### Updated

- Updated [README.md](./README.md)
- Sample apps were moved [outside of the repo](https://github.com/HubSpot/sample-apps-list)
